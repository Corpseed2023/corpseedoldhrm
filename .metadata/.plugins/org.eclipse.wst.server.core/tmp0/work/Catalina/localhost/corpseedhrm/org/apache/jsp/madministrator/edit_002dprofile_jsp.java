...
String[][] user=Usermaster_ACT.getUserProfile(loginID);
      ...
      out.write("                            <h2><span class=\"title\">Edit Profile</span></h2>\r\n");
      out.write("                         </div>\r\n");
      out.write("                         <div class=\"post-slider clearfix\">\r\n");
      out.write("                         <form action=\"update-profile.html\" method=\"post\" name=\"updateform\" id=\"updateform\">\r\n");
      out.write("                                  <div class=\"row\">\r\n");
      ...
      out.write("                                   <input type=\"text\" name=\"userName\" onchange=\"isUserColumnExist(this.value,'uaname','userNameErrorMSGdiv','User_Name')\"  id=\"User_Name\" value=\"");
      out.print(user[0][1] );
      out.write("\" placeholder=\"Enter Name*\" onblur=\"requiredFieldValidation('User_Name','userNameErrorMSGdiv');\" class=\"form-control\">\r\n");
      out.write("                                    </div>\r\n");
      out.write("                                    <div id=\"userNameErrorMSGdiv\" class=\"errormsg\"></div>\r\n");
      out.write("                                   </div>\r\n");
      out.write("                                   </div>\r\n");
      out.write("                                  <div class=\"col-md-4 col-sm-4 col-xs-12\">\r\n");
      out.write("                                   <div class=\"form-group\">\r\n");
      ...
      out.write("                                  <input type=\"text\" name=\"userMobile\" onchange=\"isUserColumnExist(this.value,'uamobileno','userMobileErrorMSGdiv','User_Mobile')\" id=\"User_Mobile\" value=\"");
      out.print(user[0][2] );
      out.write("\" placeholder=\"Enter Mobile*\" onblur=\"requiredFieldValidation('User_Mobile','userMobileErrorMSGdiv');\" class=\"form-control\" onkeypress=\"return isNumber(event)\">\r\n");
      out.write("                                    </div>\r\n");
      out.write("                                    <div id=\"userMobileErrorMSGdiv\" class=\"errormsg\"></div>\r\n");
      out.write("                                   </div>\r\n");
      out.write("                                  </div>\r\n");
      out.write("                                  <div class=\"col-md-4 col-sm-4 col-xs-12\">\r\n");
      out.write("                                   <div class=\"form-group\">\r\n");
      ...
      out.write("                                    <input type=\"email\" name=\"userEmail\" onchange=\"isUserColumnExist(this.value,'uaemailid','userEmailErrorMSGdiv','User_Email_ID')\" id=\"User_Email_ID\" value=\"");
      out.print(user[0][3] );
      out.write("\"  placeholder=\"Enter Email ID*\" onblur=\"requiredFieldValidation('User_Email_ID','userEmailErrorMSGdiv');\" class=\"form-control\">\r\n");
      out.write("                                   </div>\r\n");
      out.write("                                   <div id=\"userEmailErrorMSGdiv\" class=\"errormsg\"></div>\r\n");
      out.write("                                   </div>\r\n");
      out.write("                                  </div>\r\n");
      out.write("                                  </div>\r\n");
      out.write("                                  <div class=\"row\">\r\n");
      out.write("                                  <div class=\"col-xs-12 item-product-info\">\r\n");
      out.write("                                  <button class=\"bt-link bt-radius bt-loadmore\" type=\"submit\" onclick=\"return editprofile();\">Update<i class=\"fa fa-paper-plane\" aria-hidden=\"true\"></i></button>\r\n");
      out.write("                                  </div>\r\n");
      out.write("                                </div>\r\n");
      out.write("                              </form> \r\n");
      out.write("                         </div>\r\n");
      ...
      out.write("	if(document.getElementById('User_Name').value==\"\"){\r\n");
      out.write("		userNameErrorMSGdiv.innerHTML=\"User ID is required.\";\r\n");
      out.write("		userNameErrorMSGdiv.style.color=\"#800606\";\r\n");
      out.write("		return false;\r\n");
      out.write("	}\r\n");
      out.write("	if (document.getElementById('User_Mobile').value==\"\"){\r\n");
      out.write("		userMobileErrorMSGdiv.innerHTML=\"User Mobile is required.\";\r\n");
      out.write("		userMobileErrorMSGdiv.style.color=\"#800606\";\r\n");
      out.write("		return false;\r\n");
      out.write("	}\r\n");
      out.write("	if (document.getElementById('User_Email_ID').value==\"\") {\r\n");
      out.write("		userEmailErrorMSGdiv.innerHTML=\"User Email is required.\";\r\n");
      out.write("		userEmailErrorMSGdiv.style.color=\"#800606\";\r\n");
      out.write("		return false;\r\n");
      out.write("	}\r\n");
      out.write("// document.updateform.submit();	\r\n");
      out.write("}\r\n");
      out.write("function isUserColumnExist(data,column,errorId,dataId){\r\n");
      out.write("	if(data!=\"\")\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			type : \"POST\",\r\n");
      out.write("			url : \"ExistUserValue111\",\r\n");
      out.write("			dataType : \"HTML\",\r\n");
      out.write("			data : {data:data,column:column},\r\n");
      out.write("			success : function(response){\r\n");
      out.write("				if(response==\"pass\"){\r\n");
      out.write("					document.getElementById(errorId).innerHTML=data +\" is already existed !!\";		\r\n");
      out.write("					document.getElementById(dataId).value=\"\";\r\n");
      out.write("					document.getElementById(errorId).style.color=\"red\";\r\n");
      out.write("				}		\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("}\r\n");
