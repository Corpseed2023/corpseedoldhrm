...
if(!AMU02){
      ...
      out.write("<h2><i class=\"fa fa-users\"></i>&nbsp;&nbsp; Manage Users</h2>\r\n");
      out.write("</div>\r\n");
if(ACU01){
      out.write("<a class=\"add_btn sub-btn1\" href=\"");
      out.print(request.getContextPath() );
      out.write("/newwebuser.html\">Register HRM Login</a>");
} 
      out.write("\r\n");
      ...
      out.write("                            </div>\r\n");
      out.write("<div class=\"item-bestsell box-width14_28 col-md-2 col-sm-11 col-xs-12\">\r\n");
      out.write("<select class=\"filtermenu\" style=\"height:41px\" onchange=\"doAction(this.value,'mutype');location.reload();\">\r\n");
      out.write("<option value=\"\">All</option>\r\n");
      out.write("<option value=\"Client\" ");
if(type.equals("Client")){ 
      out.write("selected");
} 
      out.write(">Client</option>\r\n");
...
if(!name.equals("NA")){ 
      out.write(" value=\"");
      out.print(name );
      out.write("\" onsearch=\"clearSession('muname')\"");
} 
      out.write(" title=\"Search by name !\" placeholder=\"Search by Name\" class=\"form-control\"/>\r\n");
      out.write("</p>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"item-bestsell box-width14_28 col-md-2 col-sm-11 col-xs-12\">\r\n");
      out.write("<p><input type=\"search\" name=\"PhoneNo\" id=\"SearchByPhoneNo\" maxlength=\"10\" ");
if(!mobile.equals("NA")){ 
      out.write(" value=\"");
      out.print(mobile );
      out.write("\" onsearch=\"clearSession('mumobile')\"");
} 
...
if(sort.equals("ip")){ 
 ...
 if(user!=null&&user.length>0){
	 ...
	 for(int i=0;i<user.length;i++){
      ...
      out.write("	 \r\n");
      out.write("     <tr ");
 if(user[i][9].equalsIgnoreCase("0")){
      ...
      out.write("</td>\r\n");
      out.write("\r\n");
      out.write("         <td><input type=\"text\" class=\"ip_allow\" value=\"");
      out.print(user[i][17] );
      out.write("\" onchange=\"updateIp(this.value,'");
      out.print(user[i][0] );
      out.write("')\" ");
if(user[i][14].equalsIgnoreCase("Client")){ 
      out.write("readonly=\"readonly\"");
} 
      out.write(">\r\n");
      out.write("         <i class=\"fas fa-check-circle text-primary pointers ip-active");
      out.print(i );
      out.write(' ');
if(user[i][18].equals("2")){
      out.write("toggle_box");
}
      out.write("\" title=\"Disable\" onclick=\"activeBan('2','");
      out.print(user[i][0] );
      out.write('\'');
      out.write(',');
      out.print(i );
      out.write(")\"></i>\r\n");
      out.write("         <i class=\"fas fa-ban text-danger pointers ip-enactive");
      out.print(i );
      out.write(' ');
if(user[i][18].equals("1")){
      out.write("toggle_box");
}
      out.write("\" title=\"Enable\" onclick=\"activeBan('1','");
      out.print(user[i][0] );
      out.write('\'');
      out.write(',');
      out.print(i );
...
if(ACU03){ 
      ...
      out.print(request.getContextPath() );
      out.write("/changepasswordByAdmin-");
      out.print(user[i][2] );
      out.write(".html\"><i class=\"fa fa-lock\" title=\"Change Password\"></i> </a>");
} 
      out.write("\r\n");
      out.write("		 ");
if(ACU04||ACU05){ 
      out.write("<a class=\"quick-view\" href=\"#manageuser\" onclick=\"document.getElementById('userid').innerHTML='");
      out.print(user[i][0] );
      out.write("'\"><i class=\"fa fa-trash\" title=\"Activate/Deactivate/Delete this user.\"></i> </a>");
} 
      out.write("\r\n");
      out.write("         </td>\r\n");
      out.write("     </tr>\r\n");
...
if(pageNo>1){ 
      ...
      out.print(request.getContextPath());
      out.write("/managewebuser.html?page=1&rows=");
      out.print(rows);
      out.write("\">First</a>\r\n");
      out.write("   </li>");
} 
...
if(pageNo>1){ 
      out.write("href=\"");
      out.print(request.getContextPath());
      out.write("/managewebuser.html?page=");
      out.print((pageNo-1) );
      out.write("&rows=");
      out.print(rows);
      out.write('"');
...
if(pageNo<=(totalPages-1)){ 
      ...
      out.write("	</ul>\r\n");
      out.write("	</div>\r\n");
      out.write("	<select class=\"select2\" onchange=\"changeRows(this.value,'managewebuser.html?page=1','");
      out.print(domain);
      out.write("')\">\r\n");
...
if(ACU05){ 
      ...
      out.write("    }\r\n");
      out.write("});\r\n");
      out.write("function activeBan(status,uaid,sn){\r\n");
      out.write("	showLoader();\r\n");
      out.write(" $.ajax({\r\n");
      out.write("		type : \"POST\",\r\n");
      out.write("		url : \"UpdateIpStatus111\",\r\n");
      ...
      out.write("					$(\".ip-active\"+sn).show();\r\n");
      out.write("					$(\".ip-enactive\"+sn).hide();					\r\n");
      out.write("				}else if(status==\"2\"){\r\n");
      out.write("					$(\".ip-active\"+sn).hide();\r\n");
      out.write("					$(\".ip-enactive\"+sn).show();\r\n");
      out.write("				}\r\n");
      out.write("			}else{\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function approve(id,status) {\r\n");
      out.write("\r\n");
      out.write("var xhttp;\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/DeleteUser111?info=\"+id+\"&status=\"+status, true);\r\n");
      ...
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("            	doAction(ui.item.value,\"mumobile\");\r\n");
      out.write("            	location.reload();\r\n");
      out.write("            	\r\n");
      out.write("            }\r\n");
      out.write("        },\r\n");
      ...
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("            	doAction(ui.item.value,\"muname\");\r\n");
      out.write("            	location.reload();            	\r\n");
      out.write("            }\r\n");
      out.write("        },\r\n");
      out.write("        error : function(error){\r\n");
      ...
      out.write("		});\r\n");
      out.write("}\r\n");
      out.write("function updateIp(ip,uaid){\r\n");
      out.write("	showLoader();\r\n");
      out.write("	$.ajax({\r\n");
      out.write("		type: \"POST\",\r\n");
      out.write("		url : \"");
      out.print(request.getContextPath());
      out.write("/updateIp111\",		\r\n");
      out.write("		data : {ip : ip,uaid : uaid},\r\n");
      out.write("		success : function(data){\r\n");
      out.write("			if(data==\"pass\"){\r\n");
      out.write("				document.getElementById('errorMsg1').innerHTML = ip+' Updated.';\r\n");
