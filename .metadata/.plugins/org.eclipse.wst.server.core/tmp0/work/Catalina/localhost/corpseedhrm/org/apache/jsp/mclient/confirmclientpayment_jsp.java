...
public final class confirmclientpayment_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(uaIsValid1== null || uaIsValid1.equals("") || uavalidtokenno1111== null || uavalidtokenno1111.equals("")||euaValidForAccess==null){	
 ...
 String token = (String) session.getAttribute("uavalidtokenno");
   ...
   if(bill.length>=0&&bill!=null){
      ...
      out.write("                      <h2><span class=\"title\">Confirm Client's Payment</span></h2>\r\n");
      out.write("                    </div>\r\n");
...
if(billpayment[4]!=null&&billpayment[4]!=""){ 
      ...
      out.write("                            <div class=\"clearfix form-group mtop10\">\r\n");
      out.write("                            <div class=\"clearfix relative_box\">\r\n");
      out.write("                            <input type=\"text\" id=\"PmtDate\" autocomplete=\"off\" ");
if(billpayment[2]!=null&&billpayment[2]!=""){ 
      out.write("value=\"");
      out.print(billpayment[2] );
      out.write('"');
} 
      out.write(" name=\"pmdate\"  class=\"form-control readonlyAllow datepicker\" placeholder=\"Select Payment Date !\" readonly/>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                         </div>\r\n");
      ...
      out.write("                            <div class=\"clearfix form-group mtop10\">\r\n");
      out.write("                            <div class=\"clearfix relative_box\">\r\n");
      out.write("                            <input type=\"text\" id=\"TransId\" autocomplete=\"off\"");
if(billpayment[5]!=null&&billpayment[5]!=""){ 
      out.write("value=\"");
      out.print(billpayment[5] );
      out.write('"');
} 
      out.write(" name=\"transid\"  class=\"form-control\" placeholder=\"Enter Transaction Id here !\"/>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"pad05 col-md-6 col-sm-6 col-xs-6\">\r\n");
      out.write("                            <div class=\"clearfix form-group mtop10\">\r\n");
      out.write("                            <div class=\"clearfix relative_box\">\r\n");
      out.write("                            <input type=\"text\" id=\"TransAmount\" onblur=\"validAmount(this.value)\" autocomplete=\"off\"");
if(billpayment[3]!=null&&billpayment[3]!=""){ 
      out.write("value=\"");
      out.print(billpayment[3] );
      out.write('"');
} 
      out.write(" name=\"transamount\" class=\"form-control\" placeholder=\"Enter Transaction Amount here !\"/>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                         </div> \r\n");
      out.write("                         <div class=\"row\">\r\n");
      out.write("                           <div class=\"clearfix item-product-info form-group col-md-4\">\r\n");
      out.write("                                  <button class=\"form-control\" type=\"submit\" onclick=\"return frauidPayment('");
      out.print(billpayment[0] );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(billtype );
      out.write("');\" style=\"background: red;color: #ffff;font-size: 17px;\">Fraud Payment</button>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"clearfix item-product-info form-group col-md-4\">\r\n");
      out.write("                                  <button class=\"form-control\" type=\"submit\" onclick=\"parent.$.fancybox.close();\" style=\"background: limegreen;color: #ffff;font-size: 17px;\">Cancel</button>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"clearfix item-product-info form-group col-md-4\">\r\n");
      out.write("                                  <button class=\"form-control\" type=\"submit\" onclick=\"return payAmount('");
      out.print(billpayment[0] );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(billtype );
      out.write("');\" style=\"background: limegreen;color: #ffff;font-size: 17px;\">Confirm Payment</button>\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </div>\r\n");
      out.write("                     </form>\r\n");
      out.write("                     ");
      ...
      out.write("\r\n");
      out.write("                     <div class=\"text-center\" style=\"color: red;margin-top: 60px;\"><h3>Not Received Any Payment !</h3></div>\r\n");
      out.write("                     ");
} 
      out.write("\r\n");
      out.write("                     </div>\r\n");
      ...
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"alert-show\"><div class=\"alert-bg alert-striped\" id=\"errorMsg\" style=\"width: 30%;\"></div></div>\r\n");
      ...
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("function validAmount(amt){\r\n");
      out.write("var dueamt=\"");
      out.print(dueamt );
      out.write("\";\r\n");
      out.write("	if(Number(amt)>Number(dueamt)){\r\n");
      out.write("		document.getElementById('errorMsg').innerHTML = 'Max Amount Will Be Equal To Due Amount.';\r\n");
      out.write("		document.getElementById(\"TransAmount\").value=\"\";\r\n");
      ...
      out.write("		if(document.getElementById(\"PayOption\").value==\"Cash\"){\r\n");
      out.write("			$('#TransId').attr('readonly',true);\r\n");
      out.write("		}\r\n");
      out.write("	},100);	\r\n");
      out.write("});\r\n");
      out.write("function frauidPayment(val,type){\r\n");
      ...
      out.write("		alert(\"error in frauidPayment() \" + error.responseText);\r\n");
      out.write("		}\r\n");
      out.write("		});\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function payAmount(pymtrefid,tablefrom){\r\n");
      ...
      out.write("		url: \"");
      out.print(request.getContextPath());
      out.write("/ConfirmBillingPayment111\",\r\n");
      out.write("		data:  {\r\n");
      ...
      out.write("			brefid : brefid,\r\n");
      out.write("			pymtrefid : pymtrefid,\r\n");
      out.write("			tablefrom : tablefrom\r\n");
      out.write("		},\r\n");
      out.write("		success: function (data) {\r\n");
      out.write("		location.reload();\r\n");
      out.write("		},\r\n");
