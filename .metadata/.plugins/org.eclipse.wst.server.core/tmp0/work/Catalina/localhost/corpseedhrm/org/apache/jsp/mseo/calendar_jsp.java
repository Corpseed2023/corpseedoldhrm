...
public final class calendar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.itextpdf.io.util.DateTimeUtil");
...
if(!MCC0){
      ...
      out.write("		<div class=\"main-content calendar_page\"> \r\n");
      out.write("			<div class=\"container\">	\r\n");
      out.write("				<div class=\"row\">\r\n");
      out.write("                	<div class=\"col-md-12 col-sm-12 col-xs-12\"> \r\n");
      out.write("                	<div class=\"clearfix mbt20 text-center\">\r\n");
      out.write("                	<a onclick=\"getNextPrevDate('prev')\"><span>Previous week</span></a><span class=\"fa fa-angle-left mlft14 mrht14\"></span>\r\n");
      out.write("					<span class=\"date_range\"><input type=\"text\" class=\"pointers date_range\" placeholder=\"FROM - TO DATE\" name=\"date_range\" id=\"date_range\" readonly/></span> \r\n");
      out.write("					<span class=\"fa fa-angle-right mlft14 mrht14\"></span> \r\n");
      out.write("					<a onclick=\"getNextPrevDate('next')\"><span>Next week</span></a>\r\n");
      out.write("                	</div> \r\n");
      out.write("                        <div class=\"menuDv pad_box1 pad_box2\">\r\n");
      out.write("                         <div class=\"clearfix mbt20\">\r\n");
      out.write("                         <div class=\"col-md-2 col-sm-2 col-xs-12 box-width5\">\r\n");
      out.write("                         <img alt=\"\" src=\"");
      out.print(request.getContextPath());
      out.write("/staticresources/images/notification1.png\">\r\n");
      out.write("                         </div>\r\n");
      out.write("                         <div class=\"col-md-10 col-sm-10 col-xs-12\">\r\n");
      out.write("                         <div style=\"font-size: 15px;\"><span>Hi ");
      out.print(userName );
      out.write("</span></div>\r\n");
      out.write("                         <div style=\"font-size: 18px;font-weight: 400;margin-top: 5px;\"><span>You have ");
      out.print(assignments );
      out.write(" assignments</span></div>\r\n");
      out.write("                         </div>\r\n");
      out.write("                         </div>   \r\n");
      out.write("						<div class=\"clearfix mb30\"> \r\n");
      out.write("                         <div class=\"col-md-2 col-sm-3 col-xs-6\">\r\n");
      out.write("						 <div class=\"clearfix dropdown inline_block\">\r\n");
      out.write("                         <button type=\"button\" class=\"calmenu dropbtn\">All<span>5</span><i class=\"fa fa-angle-down\"></i></button> \r\n");
      out.write("						 <div class=\"dropdown-content\" style=\"border-radius: 3px;min-width: 102px;margin-left: 0;\">\r\n");
      out.write("						     <a class=\"clickeble\" onclick=\"\">All</a>\r\n");
      out.write("						     <a class=\"clickeble\" onclick=\"\">New</a>\r\n");
      out.write("						     <a class=\"clickeble\" onclick=\"\">Open</a>	\r\n");
      out.write("						     <a class=\"clickeble\" onclick=\"\">Hold</a>	\r\n");
      out.write("						     <a class=\"clickeble\" onclick=\"\">Pending</a>				    \r\n");
      out.write("						 </div>\r\n");
      out.write("                         </div> \r\n");
      out.write("						 </div>\r\n");
      out.write("                        </div> \r\n");
      out.write("						\r\n");
      out.write("						<div class=\"clearfix calendar_ovrflow_hide\">\r\n");
      out.write("						<div class=\"calendar_box_fix\">\r\n");
      out.write("						");
...
// 								String deliveryData[]=TaskMaster_ACT.getDeliveryDate(milestones[i][5],milestones[i][2],token);
      ...
      out.write("						\r\n");
      out.write("						\r\n");
      out.write("						<div class=\"clearfix\" onmouseover=\"displayContents('ProgressBarId");
      out.print(i );
      out.write("','BarProgressReport");
      out.print(i );
      out.write("','CalActionBtn");
      out.print(i );
      out.write("')\" onmouseout=\"hideContents('ProgressBarId");
      out.print(i );
      out.write("','BarProgressReport");
      out.print(i );
      out.write("','CalActionBtn");
      ...
      out.write("						 <span class=\"text-center relative_box \">\r\n");
      out.write("                       \r\n");
      out.write("						 <span class=\"calmonth\">");
      out.print(deliveryData[0] );
      out.write("</span> \r\n");
      out.write("						 <span class=\"caldate\">");
      out.print(milestones[i][7].substring(0, 2) );
      out.write("</span>\r\n");
      out.write("						 <span class=\"calday\">");
      out.print(deliveryData[1] );
      out.write("</span> \r\n");
      out.write("						 </span>\r\n");
      out.write("                         </div>\r\n");
      out.write("                         </div>\r\n");
      out.write("						 <div class=\"col-md-10 col-sm-10 col-xs-12\">\r\n");
      out.write("						 <div class=\"row\">\r\n");
      out.write("                         <div class=\"pad0 mtop10 col-md-4 col-sm-4 col-xs-12\">\r\n");
      out.write("						 <div class=\"clearfix\"> \r\n");
      out.write("						 <div class=\"clearfix mbt5\"><span>");
      out.print(milestones[i][3] );
      out.write("</span></div>\r\n");
      out.write("						 <div class=\"dimcolor\"><span>");
      out.print(serviceType );
      out.write("</span></div>\r\n");
      out.write("						 </div>\r\n");
      out.write("						 </div>\r\n");
      out.write("						 <div class=\"pad-rt0 footer-bottom2 col-md-4 col-sm-4 col-xs-12\" id=\"ProgressBarId");
      out.print(i );
      out.write("\" style=\"opacity: 0;\">  \r\n");
      out.write("                         <div class=\"progress\" style=\"background-color:#E7E7E7;\">\r\n");
      out.write("					     <div class=\"progress-bar pointers taskhis\" data-related=\"task_history\" role=\"progressbar\" aria-valuenow=\"");
      ...
      out.write("					     </div>\r\n");
      out.write("                         </div>\r\n");
      out.write("						 <div class=\"footer-bottom2 pad05 col-md-2 col-sm-2 col-xs-12\" style=\"opacity: 0;\" id=\"BarProgressReport");
      out.print(i );
      out.write("\">\r\n");
      out.write("                         <span class=\"dimcolor\">");
      out.print(milestones[i][4] );
      out.write("% Complete</span>\r\n");
      out.write("                         </div>\r\n");
      out.write("                         <div class=\"mtop10 col-md-2 col-sm-2 col-xs-12 text-right\"><span class=\"dimcolor\">");
      out.print(milestones[i][5] );
      out.write("</span></div>\r\n");
      out.write("                         </div>\r\n");
      out.write("						 <div class=\"dimcolor row\" id=\"CalActionBtn");
      out.print(i );
      out.write("\" style=\"opacity: 0;margin-top: 65px;\">  \r\n");
      out.write("                         <a href=\"");
      out.print(request.getContextPath());
      out.write("/edittask-");
      out.print(milestones[i][0]);
      out.write(".html\"><span class=\"dimcolor pointers\">Edit</span></a>\r\n");
      out.write("                         <a href=\"");
      out.print(request.getContextPath());
      out.write("/edittask-");
      out.print(milestones[i][0]);
      out.write(".html?typ=chat\" class=\"dimcolor mlft22 pointers\">Follow-Up</a>\r\n");
      out.write("                         <a href=\"");
      out.print(request.getContextPath());
      out.write("/edittask-");
      out.print(milestones[i][0]);
      out.write(".html?typ=doc\" class=\"dimcolor mlft22 pointers\">Documents</a>\r\n");
      out.write("                         </div>\r\n");
      out.write("						 </div>\r\n");
      out.write("						 </div>						 \r\n");
      out.write("                         <hr class=\"mb30 mrt14 mlft14 mtp38\">\r\n");
      out.write("						 \r\n");
      out.write("						 ");
}}else{ 
      out.write("						 \r\n");
      out.write("						 	<div class=\"clearfix text-center text-danger footer-bottom2 noDataFound\">No Data Found !!</div>\r\n");
      out.write("						 ");
} 
      out.write("\r\n");
      out.write("						 </div>\r\n");
      ...
      out.write("\r\n");
      out.write("	<script type=\"text/javascript\">	\r\n");
      out.write("	function displayContents(ProgressBarId,BarProgressReport,CalActionBtn){\r\n");
      out.write("		$(\"#TodayId\").css('margin-left','');\r\n");
      out.write("		$(\"#\"+ProgressBarId).css('opacity','1');\r\n");
      out.write("		$(\"#\"+BarProgressReport).css('opacity','1');\r\n");
      out.write("		$(\"#\"+CalActionBtn).css('opacity','1');\r\n");
      out.write("	}\r\n");
      out.write("	function hideContents(ProgressBarId,BarProgressReport,CalActionBtn){\r\n");
      out.write("		$(\"#TodayId\").css('margin-left','');\r\n");
      out.write("		$(\"#\"+ProgressBarId).css('opacity','0');\r\n");
      out.write("		$(\"#\"+BarProgressReport).css('opacity','0');\r\n");
      out.write("		$(\"#\"+CalActionBtn).css('opacity','0');\r\n");
      out.write("	}\r\n");
      ...
      out.write("//     $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));\r\n");
      out.write("	var data=$(this).val();\r\n");
      out.write("	doAction(data,\"date_range_value\");\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function getNextPrevDate(data){\r\n");
      out.write("	var currentDate=$(\"#date_range\").val();\r\n");
      out.write("	if(currentDate!=null&&currentDate!=\"\"&&currentDate!=\"NA\"){\r\n");
      out.write("		showLoader();\r\n");
      out.write("	$.ajax({\r\n");
      out.write("	    type: \"POST\",\r\n");
      out.write("	    url: \"");
      out.print(request.getContextPath());
      out.write("/GetPrevNextDateRange111\",\r\n");
      out.write("	    data:  { \r\n");
      out.write("	    	data : data,\r\n");
      out.write("	    	currentDate : currentDate,\r\n");
      out.write("	    },\r\n");
      out.write("	    success: function (response) {        	  \r\n");
      out.write("         location.reload(true)     	  ;\r\n");
      out.write("        },\r\n");
      ...
      out.write("	});\r\n");
      out.write("	}else{\r\n");
      out.write("		document.getElementById(\"errorMsg\").innerHTML=\"Please Select a valid Date range !!.\";				\r\n");
      out.write("		$('.alert-show').show().delay(4000).fadeOut();\r\n");
      out.write("	}\r\n");
      out.write("}\r\n");
      out.write("$( document ).ready(function() {\r\n");
      out.write("	   var dateRangeDoAction=\"");
      out.print(date_range_value);
      out.write("\";\r\n");
