 ...
 * Generated at: 2023-09-22 14:08:30 UTC
...
public final class my_002ddocument_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int totalDocument=SeoOnPage_ACT.countAllFolder(token,emproleid,loginuaid,searchClientId,doDocumentAction,docDateRangeAction);
      ...
      out.write("	<li ");
if(doDocumentAction.equalsIgnoreCase("Project")){ 
      out.write("class=\"active\"");
} 
      out.write("><a onclick=\"doAction('Project','doDocumentAction');location.reload();\">Project's</a></li>\r\n");
      out.write("	<li ");
if(doDocumentAction.equalsIgnoreCase("Personal")){ 
      out.write("class=\"active\"");
} 
      out.write("><a onclick=\"doAction('Personal','doDocumentAction');location.reload();\">Personal</a></li> \r\n");
      out.write("\r\n");
      out.write(" </ul>\r\n");
      out.write("\r\n");
      out.write("</div>\r\n");
      ...
      out.write("<p><input type=\"search\" name=\"searchbyclientname\" ");
if(!clientname.equalsIgnoreCase("NA")){ 
      out.write("onsearch=\"clearSession('SearchByClientName');clearSession('SearchByClientId');location.reload()\" value=\"");
      out.print(clientname);
      out.write('"');
} 
      out.write(" id=\"SearchByClientName\" title=\"Search by client name !\" placeholder=\"Search by client name !\" class=\"form-control\" autocomplete=\"off\">\r\n");
      out.write("<input type=\"hidden\" id=\"ClientId\" ");
if(!searchClientId.equalsIgnoreCase("NA")){
      out.write("value=\"");
      out.print(searchClientId );
      out.write('"');
} 
      out.write(">\r\n");
      out.write("</p>\r\n");
      ...
      out.write("<p><input type=\"text\" name=\"date_range\" id=\"date_range\" autocomplete=\"off\" placeholder=\"DD-MM-YYYY - DD-MM-YYYY\" class=\"form-control text-center date_range pointers ");
if(!docDateRangeAction.equalsIgnoreCase("NA")){ 
      out.write("selected");
} 
      out.write("\" readonly=\"readonly\">\r\n");
      out.write("<span class=\"form-control-clear form-control-feedback hidden\" onclick=\"clearSession('docDateRangeAction');location.reload();\"></span>\r\n");
      out.write("</p>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
...
if(doDocumentAction.equalsIgnoreCase("Personal")){
	files=SeoOnPage_ACT.countAllFiles(folder[i][5],token);
      ...
      out.print(request.getContextPath());
      out.write("/personalfiles-");
      out.print(folder[i][5]);
      ...
      out.print(folder[i][0]);
      out.write("')\"><i class=\"fas fa-lock\" aria-hidden=\"true\"></i></a>\r\n");
} 
      out.write("\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"file_name\" title=\"");
      out.print(folder[i][1] );
      out.write('"');
      out.write('>');
      out.print(folder[i][1] );
...
if(pageNo>1){ 
      ...
      out.print(request.getContextPath());
      out.write("/mydocument.html?page=1&rows=");
      out.print(rows);
      out.write("\">First</a>\r\n");
      out.write("   </li>");
} 
...
if(pageNo>1){ 
      out.write("href=\"");
      out.print(request.getContextPath());
      out.write("/mydocument.html?page=");
      out.print((pageNo-1) );
      out.write("&rows=");
      out.print(rows);
      out.write('"');
...
if(pageNo<=(totalPages-1)){ 
      ...
      out.write("	</ul>\r\n");
      out.write("	</div>\r\n");
      out.write("	<select class=\"select2\" onchange=\"changeRows(this.value,'mydocument.html?page=1','");
      out.print(domain);
      out.write("')\">\r\n");
...
if(rows==192){ 
      ...
      out.write("\r\n");
      out.write("<div class=\"text-center text-danger noDataFound\">No Data Found !!</div>\r\n");
} 
      out.write("\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("</div>\r\n");
      out.write(" <div class=\"myModal modal fade\" id=\"newFolderModal\">\r\n");
      out.write("   <div class=\"modal-dialog\">\r\n");
      out.write("     <div class=\"modal-content\">\r\n");
      out.write("       <div class=\"modal-header\">\r\n");
      out.write("         <h4 class=\"modal-title\"><i class=\"fas fa-folder-plus txt_blue\" aria-hidden=\"true\"></i>New folder</h4>  \r\n");
      ...
      out.write("         <button type=\"submit\" class=\"bt-link bt-radius bt-loadmore\" onclick=\"return validateFolder()\">Submit</button> \r\n");
      out.write("       </div>\r\n");
      out.write("       </form>\r\n");
      out.write("     </div>\r\n");
      out.write("   </div>\r\n");
      ...
      out.write("	var fcategory=\"folder\";\r\n");
      out.write("	showLoader();\r\n");
      out.write("	$.ajax({\r\n");
      out.write("		type: \"POST\",\r\n");
      out.write("		dataType: \"html\",\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("$(function() {\r\n");
      out.write("	$(\"#SearchByClientName\").autocomplete({\r\n");
      out.write("		source : function(request, response) {\r\n");
      out.write("			if(document.getElementById('SearchByClientName').value.trim().length>=1)\r\n");
      out.write("			$.ajax({\r\n");
      ...
      out.write("            if(!ui.item){     \r\n");
      out.write("            	document.getElementById('errorMsg').innerHTML = 'Select from client list.';\r\n");
      out.write("        		$('.alert-show').show().delay(3000).fadeOut();\r\n");
      out.write("        		\r\n");
      out.write("            	$(\"#SearchByClientName\").val(\"\");    \r\n");
      out.write("            	\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("            	doAction(ui.item.value,'SearchByClientName');\r\n");
      out.write("            	doAction(ui.item.cid,'SearchByClientId');\r\n");
      ...
      out.write("	doAction(data,\"docDateRangeAction\");\r\n");
      out.write("	location.reload();\r\n");
      out.write("});\r\n");
      out.write("\r\n");
