...
public final class certificate_002drenewal_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<title>Certificate renewal</title>\r\n");
      out.write("	");
...
if(!certRenewalTaskDateRange.equalsIgnoreCase("NA")){ 
      out.write("selected");
} 
      out.write("\" readonly=\"readonly\"/>\r\n");
      out.write("				<span class=\"form-control-clear form-control-feedback\" onclick=\"clearSession('certRenewalTaskDateRange');location.reload();\"></span>\r\n");
      out.write("				</p>\r\n");
      out.write("				</div>\r\n");
      out.write("				</div>\r\n");
      out.write("				</div>\r\n");
...
if(sort.equals("project")){ 
      ...
      out.write("','project','");
      out.print(order);
      out.write("')\">Project</th>\r\n");
      out.write("						            <th>Document</th>\r\n");
      out.write("						            <th class=\"sorting ");
if(sort.equals("approval_date")){ 
      out.print(sorting_order);
} 
      out.write("\" onclick=\"sortBy('");
      out.print(sort_url);
      out.write("','approval_date','");
      out.print(order);
      out.write("')\">Approval Date</th>\r\n");
      out.write("						            <th class=\"sorting ");
if(sort.equals("renewal_date")){ 
      out.print(sorting_order);
} 
      out.write("\" onclick=\"sortBy('");
      out.print(sort_url);
      out.write("','renewal_date','");
      out.print(order);
      out.write("')\">Renewal Date</th>\r\n");
      out.write("						            <th class=\"sorting ");
...
if(sort.equals("employee")){ 
      ...
      out.write("</td>\r\n");
      out.write("						            <td>");
      out.print(renewals[i][0] );
      out.write("</td>\r\n");
      out.write("						            <td>");
      out.print(renewals[i][1] );
      out.write(' ');
      out.write(':');
      out.write(' ');
      out.print(renewals[i][2] );
      out.write("</td>\r\n");
      out.write("						            <td>\r\n");
      out.write("						            ");
if(certificates>0){ 
...
if(certificates==1){ 
      ...
      out.write("href=\"#\" onclick=\"showAllCertificates('");
      out.print(renewals[i][8]);
      out.write('\'');
      out.write(')');
      out.write('"');
} 
      ...
      out.write("									");
if(certificates>1){ 
      out.write("<span class=\"plusNo\">+");
      out.print(certificates );
      out.write("</span>");
} 
      out.write("</a>");
}else{ 
      out.write("\r\n");
      out.write("									<span class=\"text-danger\">No Document</span>\r\n");
      out.write("									");
} 
      out.write("\r\n");
      out.write("						            </td>\r\n");
      out.write("						            <td>");
      out.print(renewals[i][3] );
      out.write("</td>\r\n");
      out.write("						            <td>");
      out.print(renewals[i][4] );
      out.write("</td>\r\n");
      out.write("						            <td id=\"RStatus");
      out.print(i );
      out.write("\" onclick=\"openRenewalBox('");
      out.print(renewals[i][3] );
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.write("')\">\r\n");
      out.write("						            ");
if(renewals[i][5].equals("1")){ 
      out.write("<span class=\"text-success clickeble\">Approved</span>");
}else{ 
      out.write("<span class=\"text-warning clickeble\">Pending</span>");
} 
      out.write("\r\n");
      out.write("						            </td>\r\n");
      out.write("						            <td>");
      out.print(renewals[i][6] );
      out.write("</td>\r\n");
      out.write("						        </tr>\r\n");
      out.write("						     ");
}}
      ...
      out.print(showing );
      out.write(" to ");
      out.print(ssn+renewals.length );
      out.write(" of ");
      out.print(totalRenewal );
...
if(pageNo>1){ 
      ...
      out.print(request.getContextPath());
      out.write("/certificates-renewal.html?page=1&rows=");
      out.print(rows);
      out.write("\">First</a>\r\n");
      out.write("						   </li>");
} 
...
if(pageNo>1){ 
      out.write("href=\"");
      out.print(request.getContextPath());
      out.write("/certificates-renewal.html?page=");
      out.print((pageNo-1) );
      out.write("&rows=");
      out.print(rows);
      out.write('"');
...
if(pageNo<=(totalPages-1)){ 
      ...
      out.write("							</ul>\r\n");
      out.write("							</div>\r\n");
      out.write("							<select class=\"select2\" onchange=\"changeRows(this.value,'certificates-renewal.html?page=1','");
      out.print(domain);
      out.write("')\">\r\n");
...
if(rows==200){ 
      ...
      out.write("		 <input type=\"hidden\" name=\"UpdateRenewalKey\" id=\"UpdateRenewalKey\">\r\n");
      out.write("		 <input type=\"hidden\" name=\"UpdateRenewalIndex\" id=\"UpdateRenewalIndex\">\r\n");
      out.write("        <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\r\n");
      out.write("        <button type=\"button\" class=\"btn btn-warning\" onclick=\"preverifyRenewal('2')\">Delete</button>\r\n");
      out.write("        <button type=\"button\" class=\"btn btn-primary\" onclick=\"preverifyRenewal('1')\">Verify</button>\r\n");
      out.write("      </div> \r\n");
      out.write("      </div>\r\n");
      out.write("	</form>  \r\n");
      out.write("  </div>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"modal fade\" id=\"certificatesModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalCenterTitle\" aria-hidden=\"true\">\r\n");
      out.write("  <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\r\n");
      out.write("    <div class=\"modal-content\">\r\n");
      out.write("      <div class=\"modal-header\">\r\n");
      out.write("        <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Renewal Documents</h5>\r\n");
      out.write("        <button type=\"button\" class=\"closeBox\" data-dismiss=\"modal\" aria-label=\"Close\">\r\n");
      out.write("          <span aria-hidden=\"true\">×</span>\r\n");
      out.write("        </button>\r\n");
      out.write("      </div>\r\n");
      out.write("      <div class=\"modal-body\">\r\n");
      out.write("       <div id=\"rDocAppendId\"></div>\r\n");
      out.write("      </div>\r\n");
      out.write("      <div class=\"modal-footer\">\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\r\n");
      out.write("function openRenewalBox(approvalDate,renewalDate,uuid,i){\r\n");
      out.write("	$(\"#ApprovalDate\").val(approvalDate);\r\n");
      out.write("	$(\"#RenewalDate\").val(renewalDate);\r\n");
      out.write("	$(\"#UpdateRenewalKey\").val(uuid);\r\n");
      out.write("	$(\"#UpdateRenewalIndex\").val(i);\r\n");
      out.write("	$(\"#UpdateRenewal\").modal(\"show\");\r\n");
      out.write("}\r\n");
      out.write("function preverifyRenewal(action){\r\n");
      out.write("	if(action==\"2\"){\r\n");
      out.write("		if (confirm('Are you sure you want to delete this licence renewal date ?')) {\r\n");
      out.write("			verifyRenewal(action);\r\n");
      out.write("		}\r\n");
      out.write("	}else if(action==\"1\"){\r\n");
      out.write("		verifyRenewal(action);\r\n");
      out.write("	}\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function verifyRenewal(action){\r\n");
      out.write("	var approvalDate=$(\"#ApprovalDate\").val();\r\n");
      out.write("	var renewalDate=$(\"#RenewalDate\").val();\r\n");
      out.write("	var uuid=$(\"#UpdateRenewalKey\").val();\r\n");
      out.write("	var i=$(\"#UpdateRenewalIndex\").val();\r\n");
      out.write("	showLoader();	\r\n");
      out.write("	$.ajax({\r\n");
      out.write("		type : \"POST\",\r\n");
      out.write("		url : \"VerifyRenewalDate111\",\r\n");
      ...
      out.write("					$(\"#RStatus\"+i).html(\"<span class='text-success clickeble'>Approved</span>\");\r\n");
      out.write("				}else if(action==\"2\"){\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function showAllCertificates(milestoneuuid){\r\n");
      out.write("	var path=\"");
      out.print(azure_path);
      out.write("\";\r\n");
      out.write("	$(\".pad0\").remove();\r\n");
      out.write("	showLoader();\r\n");
      out.write("	$.ajax({\r\n");
      out.write("		type : \"GET\",\r\n");
      out.write("		url : \"GetRenewalDocuments111\",\r\n");
      out.write("		dataType : \"HTML\",\r\n");
      out.write("		data : {				\r\n");
      out.write("			milestoneuuid : milestoneuuid\r\n");
      out.write("		},\r\n");
      out.write("		success : function(response){\r\n");
      out.write("			if(Object.keys(response).length!=0){\r\n");
      out.write("				response = JSON.parse(response);			\r\n");
      out.write("				 var len = response.length;\r\n");
      out.write("				 console.log(\"renewal document length=\"+len);\r\n");
      out.write("				 if(len>0){\r\n");
      out.write("					 for(var i=0;i<len;i++){\r\n");
      out.write("						 var name=response[0][\"name\"];\r\n");
      out.write("						 $(''+\r\n");
      out.write("							'<div class=\"col-md-2 pad0\">'+\r\n");
      out.write("						 	'<a href=\"'+path+''+name+'\" target=\"_blank\">'+\r\n");
      out.write("						 	'<img alt=\"document\" src=\"'+path+''+name+'\">'+\r\n");
      out.write("						 	'</a></div>').insertBefore(\"#rDocAppendId\");      \r\n");
      out.write("					     \r\n");
      out.write("					 }\r\n");
      out.write("				 }\r\n");
      out.write("			}	\r\n");
      ...
      out.write("		}\r\n");
      out.write("	});\r\n");
      out.write("// 	rDocAppendId\r\n");
      out.write("	$(\"#certificatesModal\").modal(\"show\");\r\n");
      out.write("}\r\n");
      out.write("$('input[name=\"date_range\"]').on('apply.daterangepicker', function(ev, picker) {\r\n");
      out.write("	var data=$(this).val();\r\n");
      out.write("	doAction(data,\"certRenewalTaskDateRange\");\r\n");
      ...
      out.print(certRenewalTaskDateRange);
      out.write("\";\r\n");
