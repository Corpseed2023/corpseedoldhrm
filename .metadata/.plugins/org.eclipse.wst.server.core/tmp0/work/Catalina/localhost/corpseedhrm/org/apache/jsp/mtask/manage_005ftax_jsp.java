...
public final class manage_005ftax_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<title>Manage Tax</title>\r\n");
      out.write("	");
...
if(!MTX0){
	...
	//pagination end
      ...
      out.write("<button class=\"btn-link-default bt-radius\" data-toggle=\"modal\" data-target=\"#TaxModal\" style=\"text-transform: none;\" type=\"button\" name=\"button\" onclick=\"$('#RegisterNewTaxForm').trigger('reset')\">Create a Tax</button>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
...
if(sort.equals("igst")){ 
      ...
      out.write("						            <td>");
      out.print(saleTax[i][1] );
      out.write("</td>\r\n");
      out.write("						            <td>");
      out.print(saleTax[i][3] );
      out.write("</td>\r\n");
      out.write("						            <td>");
      out.print(saleTax[i][2] );
      out.write("</td>\r\n");
      out.write("						            <td>");
      out.print(saleTax[i][4] );
      out.write("</td>\r\n");
      out.write("						            <td>\r\n");
      out.write("						            <i class=\"fas fa-edit pointers\" style=\"margin-right: 10px;\" data-toggle=\"modal\" data-target=\"#EditTaxModal\" onclick=\"setDivId('");
      out.print(saleTax[i][0] );
      out.write("','Row");
      out.print(i+1);
      out.write('\'');
      out.write(',');
      ...
      out.write(',');
      out.write('\'');
      out.print(saleTax[i][5] );
      out.write("')\">&nbsp;Edit</i>\r\n");
      out.write("									<i class=\"fas fa-trash pointers\" data-toggle=\"modal\" data-target=\"#warningDelete\" onclick=\"$('#DeleteRefid').val('");
      out.print(saleTax[i][0] );
      out.write("');$('#DeleteRowid').val('Row");
      out.print(i+1);
      out.write("');\">&nbsp;Delete</i>\r\n");
      out.write("						            </td>									\r\n");
      out.write("						        </tr>\r\n");
      ...
      out.print(showing );
      out.write(" to ");
      out.print(ssn+saleTax.length );
      out.write(" of ");
      out.print(totalTaxes );
...
if(pageNo>1){ 
      ...
      out.print(request.getContextPath());
      out.write("/managetax.html?page=1&rows=");
      out.print(rows);
      out.write("\">First</a>\r\n");
      out.write("						   </li>");
} 
...
if(pageNo<=(totalPages-1)){ 
      ...
      out.write("							</ul>\r\n");
      out.write("							</div>\r\n");
      out.write("							<select class=\"select2\" onchange=\"changeRows(this.value,'managetax.html?page=1','");
      out.print(domain);
      out.write("')\">\r\n");
...
if(rows==200){ 
      ...
      out.write("  <input type=\"hidden\" id=\"KeyIdForm\"/>\r\n");
      out.write("  <input type=\"hidden\" id=\"RowIdDiv\"/>\r\n");
      ...
      out.write("		<div class=\"input-group\">\r\n");
      out.write("		 <textarea class=\"form-control\" autocomplete=\"off\" rows=\"3\" name=\"expensenote\" id=\"EditTaxNote\" placeholder=\"Additional description\" onblur=\"validateLocationPopup('TaxNote');validateValuePopup('TaxNote');\"></textarea>\r\n");
      out.write("		</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		</div>\r\n");
      out.write("      </div>\r\n");
      ...
      out.write("        <button type=\"button\" class=\"btn btn-primary\" onclick=\"return validateEditTax('KeyIdForm','RowIdDiv')\">Update</button>\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>\r\n");
      out.write("    </form>\r\n");
      out.write("  </div>\r\n");
      ...
      out.write("		<label>HSN</label>\r\n");
      out.write("		<div class=\"input-group\">\r\n");
      out.write("		<input type=\"text\" name=\"\" onchange=\"isExistValue('HSNCode')\" autocomplete=\"off\" id=\"HSNCode\" placeholder=\"HSN Code\" class=\"form-control\">\r\n");
      out.write("		</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		</div>\r\n");
      out.write("        <div class=\"col-md-12 col-sm-12 col-xs-12\">\r\n");
      ...
      out.write("    <div class=\"modal-content\">\r\n");
      out.write("      <div class=\"modal-header\">\r\n");
      out.write("        <h5 class=\"modal-title\" id=\"exampleModalLabel\" style=\"padding-bottom: 6px;\">Do you really want to delete this sale tax ?</h5>\r\n");
      out.write("        <button type=\"button\" class=\"closeBox\" data-dismiss=\"modal\" aria-label=\"Close\">\r\n");
      out.write("          <span aria-hidden=\"true\">&times;</span>\r\n");
      out.write("        </button>\r\n");
      out.write("      </div>     \r\n");
      out.write("      <div class=\"modal-footer\">\r\n");
      out.write("      <input type=\"hidden\" id=\"DeleteRefid\"/>\r\n");
      out.write("      <input type=\"hidden\" id=\"DeleteRowid\"/>\r\n");
      out.write("        <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">No</button>\r\n");
      out.write("        <button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\" onclick=\"deleteTax('DeleteRefid','DeleteRowid')\">Yes</button>\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>\r\n");
      out.write("  </div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("            	<option value=\"mthsncode\">HSN</option>\r\n");
      out.write("            	<option value=\"mtcgstpercent\">CGST %</option>\r\n");
      out.write("            	<option value=\"mtsgstpercent\">SGST %</option>\r\n");
      out.write("            	<option value=\"mtigstpercent\">IGST %</option>\r\n");
      out.write("            </select>            \r\n");
      out.write("          </div>\r\n");
      out.write("         <div class=\"form-group\">\r\n");
      ...
      out.write("	});\r\n");
      out.write("}\r\n");
      out.write("function deleteTax(TaxId,DeleteRowid){\r\n");
      out.write("	var mtrefid=$('#'+TaxId).val();\r\n");
      out.write("	var rowid=$('#'+DeleteRowid).val();\r\n");
      out.write("	showLoader();\r\n");
      out.write("	$.ajax({\r\n");
      out.write("		type : \"GET\",\r\n");
      out.write("		url : \"DeleteRegisterdTax111\",\r\n");
      out.write("		dataType : \"HTML\",\r\n");
      out.write("		data : {				\r\n");
      out.write("			mtrefid : mtrefid\r\n");
      out.write("		},\r\n");
      out.write("		success : function(data){\r\n");
      out.write("			if(data==\"pass\"){	\r\n");
      ...
      out.write("	});\r\n");
      out.write("}\r\n");
      out.write("function setDivId(key,rowid,hsn,cgst,sgst,igst,notes){\r\n");
      out.write("	$('#KeyIdForm').val(key);\r\n");
      out.write("	$('#RowIdDiv').val(rowid);\r\n");
      ...
      out.write("}\r\n");
      out.write("function validateEditTax(keyid,rowiddiv){  	\r\n");
      out.write("	var key=$(\"#\"+keyid).val().trim();\r\n");
      out.write("	var rowid=$(\"#\"+rowiddiv).val().trim();\r\n");
      ...
      out.write("	var hsn=$(\"#HSNCode\").val().trim();\r\n");
      ...
      out.write("                    '<p class=\"news-border\"><input type=\"checkbox\" name=\"\"></p> '+\r\n");
      out.write("                    '</div></div>'+\r\n");
      out.write("                '<div class=\"box-width26 col-md-1 col-xs-12 box-intro-background\">'+\r\n");
      out.write("                	'<div class=\"link-style12\">'+\r\n");
      out.write("                    '<p class=\"news-border\">'+hsn+'</p>'+\r\n");
      out.write("                    '</div></div> '+\r\n");
      out.write("				'<div class=\"box-width13 col-xs-1 box-intro-background\">'+\r\n");
      out.write("                	'<div class=\"link-style12\">'+\r\n");
      out.write("                    '<p class=\"news-border\">'+cgst+'</p>'+\r\n");
      out.write("                    '</div></div>'+\r\n");
      out.write("				'<div class=\"box-width13 col-xs-12 box-intro-background\">'+\r\n");
      out.write("                	'<div class=\"link-style12\">'+\r\n");
      out.write("                    '<p class=\"news-border\">'+sgst+'</p>'+\r\n");
      out.write("                    '</div></div>'+\r\n");
      out.write("                '<div class=\"box-width13 col-xs-12 box-intro-background\">'+\r\n");
      out.write("                	'<div class=\"link-style12\">'+\r\n");
      out.write("                    '<p class=\"news-border\">'+igst+'</p>'+\r\n");
      out.write("                    '</div></div>'+\r\n");
      out.write("                '<div class=\"box-width22 col-xs-12 box-intro-background\">'+\r\n");
      out.write("                	'<div class=\"link-style12\">  '+\r\n");
      out.write("					'<p>'+\r\n");
      out.write("					'<span class=\"fa fa-pencil pointers\" style=\"font-size: 20px;margin-right: 10px;\"></span>'+\r\n");
      out.write("					'<span class=\"fa fa-trash pointers\" style=\"font-size: 20px;\"></span>'+\r\n");
      out.write("					'</p></div></div></div>').insertBefore(\"#MainContainerDiv\"); */\r\n");
      out.write("			}else{\r\n");
      out.write("				document.getElementById('errorMsg').innerHTML = 'Something went wrong , Try Sometime later !!';\r\n");
      out.write("				$('.alert-show').show().delay(4000).fadeOut();\r\n");
      out.write("			}\r\n");
