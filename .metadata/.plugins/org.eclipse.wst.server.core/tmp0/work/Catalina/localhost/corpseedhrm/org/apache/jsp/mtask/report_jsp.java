...
//pagination end
      ...
      out.write("<p><input type=\"search\" autocomplete=\"off\" name=\"projectNo\" id=\"projectNo\" ");
if(!reportprojectNo.equalsIgnoreCase("NA")){ 
      out.write("value=\"");
      out.print(reportprojectNo );
      out.write("\" onsearch=\"clearSession('reportprojectNo');location.reload();\"");
} 
      out.write(" title=\"Search by project no. !\" placeholder=\"Search by project no.\" class=\"form-control\"/>\r\n");
      out.write("</p>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"item-bestsell col-md-3 col-sm-3 col-xs-12\">\r\n");
      out.write("<p><input type=\"search\" autocomplete=\"off\" name=\"assigneeName\" id=\"assigneeName\" ");
if(!reportAssigneeUid.equalsIgnoreCase("NA")){ 
      out.write("value=\"");
      out.print(reportAssigneeName );
      out.write("\" onsearch=\"clearSession('reportAssigneeUid');clearSession('reportAssigneeName');location.reload()\"");
} 
      out.write(" title=\"Search by assignee name !\" placeholder=\"Search by assignee name !\" class=\"form-control\"/>\r\n");
      out.write("<input type=\"hidden\" id=\"assigneUid\" ");
if(!reportAssigneeUid.equalsIgnoreCase("NA")){ 
      out.write("value=\"");
      out.print(reportAssigneeUid );
      out.write('"');
} 
      out.write(">\r\n");
      out.write("</p>\r\n");
...
if(sort.equals("project")){ 
      ...
      out.write("','project','");
      out.print(order);
      out.write("','rsorting_order','rsortby_ord')\">Project</th>\r\n");
      out.write("           <th class=\"sorting ");
if(sort.equals("milestone")){ 
      ...
      out.write("','milestone','");
      out.print(order);
      out.write("','rsorting_order','rsortby_ord')\">Milestone</th>\r\n");
      out.write("           <th class=\"sorting ");
if(sort.equals("assignee")){ 
      out.print(sorting_order);
} 
      out.write("\" onclick=\"sortBy('");
      out.print(sort_url);
      out.write("','assignee','");
      out.print(order);
      out.write("','rsorting_order','rsortby_ord')\">Assignee</th>\r\n");
      out.write("           <th>New</th>\r\n");
      out.write("           <th>Open</th>\r\n");
      out.write("           <th>Hold</th>\r\n");
      out.write("           <th>Pending</th>\r\n");
      out.write("           <th>Expired</th>\r\n");
      out.write("           <th>Milestone TAT</th>\r\n");
      out.write("           <th>Delivery TAT</th>\r\n");
   ...
   for(int i=0;i<getAllTask.length;i++){
      ...
      out.write("  </tr>\r\n");
      out.write("       <tr id=\"row");
      out.print(getAllTask.length-i);
      out.write("\">       \r\n");
      out.write("           <td><input type=\"checkbox\" id=\"checkbox\" class=\"checked\"></td>\r\n");
      out.write("           <td>");
      out.print(getAllTask[i][1] );
      out.write('/');
      out.print(getAllTask[i][0] );
      out.write(' ');
      out.write(':');
      out.write(' ');
      out.print(getAllTask[i][2] );
      out.write("</td>\r\n");
      out.write("           <td>");
      out.print(getAllTask[i][7] );
      out.write("</td>\r\n");
      out.write("           <td>");
      out.print(getAllTask[i][9] );
      out.write("</td>\r\n");
      out.write("           <td>");
if(!getAllTask[i][10].equalsIgnoreCase("0")){
      out.print(getAllTask[i][10] );
      out.write('h');
      out.write(' ');
}
      out.print(getAllTask[i][11] );
      out.write("m</td>\r\n");
      out.write("           <td>");
if(!getAllTask[i][12].equalsIgnoreCase("0")){
      out.print(getAllTask[i][12] );
      out.write('h');
      out.write(' ');
}
      out.print(getAllTask[i][13] );
      out.write("m</td>\r\n");
      out.write("           <td>");
if(!getAllTask[i][14].equalsIgnoreCase("0")){
      out.print(getAllTask[i][14] );
      out.write('h');
      out.write(' ');
}
      out.print(getAllTask[i][15] );
      out.write("m</td>\r\n");
      out.write("           <td>");
if(!getAllTask[i][16].equalsIgnoreCase("0")){
      out.print(getAllTask[i][16] );
      out.write('h');
      out.write(' ');
}
      out.print(getAllTask[i][17] );
      out.write("m</td>\r\n");
      out.write("           <td>");
if(!getAllTask[i][18].equalsIgnoreCase("0")){
      out.print(getAllTask[i][18] );
      out.write('h');
      out.write(' ');
}
      out.print(getAllTask[i][19] );
      out.write("m</td>\r\n");
      out.write("           <td>");
      out.print(duration );
      out.write("</td>           \r\n");
...
if(isPassed){
      ...
      out.write('>');
      out.print(deliveredTime );
      out.write("</td>\r\n");
      out.write("           <td>");
      out.print(milestoneData[7] );
      out.write(" %</td>\r\n");
      out.write("       </tr>\r\n");
      out.write("    ");
}}
      ...
      out.print(showing );
      out.write(" to ");
      out.print(ssn+getAllTask.length );
      out.write(" of ");
      out.print(totalTask );
...
if(pageNo>1){ 
      ...
      out.print(request.getContextPath());
      out.write("/report.html?page=1&rows=");
      out.print(rows);
      out.write("\">First</a>\r\n");
      out.write("   </li>");
} 
...
if(pageNo<=(totalPages-1)){ 
      ...
      out.write("	</ul>\r\n");
      out.write("	</div>\r\n");
      out.write("	<select class=\"select2\" onchange=\"changeRows(this.value,'report.html?page=1','");
      out.print(domain);
      out.write("')\">\r\n");
...
if(rows==200){ 
      ...
      out.write("            	<option value=\"concat(concat(m.msprojectnumber,'/'),concat(m.msinvoiceno,'/'),m.msproductname) as Project\" selected>Project</option>\r\n");
      out.write("            	<option value=\"concat(t.task_name,'') as Milestone\" selected>Milestone</option>\r\n");
      out.write("            	<option value=\"concat(t.assignee_name,'') as Assignee\" selected>Assignee</option>\r\n");
      out.write("            	<option value=\"concat(concat(t.task_new_hh,'h '),concat(t.task_new_mm,'m')) as New\" selected>New</option>\r\n");
      out.write("            	<option value=\"concat(concat(t.task_open_hh,'h '),concat(t.task_open_mm,'m')) as Open\" selected>Open</option>\r\n");
      out.write("            	<option value=\"concat(concat(t.task_hold_hh,'h '),concat(t.task_hold_mm,'m')) as Hold\" selected>Hold</option>\r\n");
      out.write("            	<option value=\"concat(concat(t.task_pending_hh,'h '),concat(t.task_pending_mm,'m')) as Pending\" selected>Pending</option>            	\r\n");
      out.write("            	<option value=\"concat(concat(t.task_expired_hh,'h '),concat(t.task_expired_mm,'m')) as Expired\" selected>Expired</option>\r\n");
      out.write("            	<option value=\"concat(ma.maid,'') as Milestone_TAT\" selected>Milestone TAT</option>\r\n");
      out.write("            	<option value=\"concat(ma.marefid,'') as Delivery_TAT,concat(ma.marefid,'') as Delivery_Extended_Reason\" selected>Delivery TAT</option>\r\n");
      out.write("            	<option value=\"concat(ma.maworkpercentage,'%') as Progress\" selected>Progress</option>\r\n");
      out.write("            </select>            \r\n");
      out.write("          </div>\r\n");
      out.write("         <div class=\"form-group\">\r\n");
      ...
      out.write("\r\n");
      out.write("$(function() {\r\n");
      out.write("	$(\"#projectNo\").autocomplete({\r\n");
      out.write("		source : function(request, response) {\r\n");
      out.write("			if(document.getElementById('projectNo').value.trim().length>=1)\r\n");
      out.write("			$.ajax({\r\n");
      ...
      out.write("        		\r\n");
      out.write("            	$(\"#projectNo\").val(\"\");\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("            	doAction(ui.item.value,\"reportprojectNo\");\r\n");
      ...
      out.write("});\r\n");
      out.write("$(function() {\r\n");
      out.write("	$(\"#assigneeName\").autocomplete({\r\n");
      out.write("		source : function(request, response) {\r\n");
      out.write("			if(document.getElementById('assigneeName').value.trim().length>=1)\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url : \"getprojectname.html\",\r\n");
      out.write("				type : \"POST\",\r\n");
      out.write("				dataType : \"JSON\",\r\n");
      ...
      out.write("        		$('.alert-show').show().delay(1000).fadeOut();\r\n");
      out.write("        		\r\n");
      out.write("            	$(\"#assigneeName\").val(\"\");\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("            	doAction(ui.item.value,\"reportAssigneeName\");\r\n");
      out.write("            	doAction(ui.item.uid,\"reportAssigneeUid\");\r\n");
      out.write("            	location.reload();\r\n");
      out.write("            }\r\n");
      out.write("        },\r\n");
      out.write("        error : function(error){\r\n");
      ...
      out.write("			type : \"milestone_report\"\r\n");
      out.write("		},\r\n");
      out.write("		success : function(response){\r\n");
