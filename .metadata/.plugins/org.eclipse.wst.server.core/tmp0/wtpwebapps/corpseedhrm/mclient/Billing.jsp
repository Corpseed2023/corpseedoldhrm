...
<div class="container">   
          <div class="bread-crumb">
            ...
            <a>Generate Billing</a>
            </div><a href="<%=request.getContextPath()%>/manage-billing.html"><button class="bkbtn" style="margin-left:893px;">Back</button></a>
          </div>
        </div>
...
<span class="pad-rt05"><a href="<%=request.getContextPath()%>/billreceiptprint.html?refid=<%=billing[i][1]%>&estInv=ESTINV1" target="_blank" title="Print Invoice !"> <i class="fa fa-file-text pointers" style="font-size: 20px;color: cornflowerblue;"></i></a></span>
</div>
<div class="pad0 col-md-1 col-sm-2 col-xs-4 text-right mtop10">
...
<div class="pad0 col-md-1 col-sm-2 col-xs-4 text-right mtop10">
<span class="pad-rt05"><a class="fancybox" href="<%=request.getContextPath()%>/confirmclientpaymentbyadmin.html?brf=<%=billing[i][1]%>&btpe=billing"> <i class="fa fa-money pointers" style="font-size: 20px;color: cornflowerblue;"  title="Confirm Paid Amount !"></i></a></span>
</div>
</div>
</div>
<%}} %>
...
<a class="UnlockProject" onclick="checkDeliverDate('<%=projectDetails[j][0] %>')"><span class="fa fa-lock" style="color: red;"></span></a>
<h2 class="normal_txt txt_orange mglft27" title="<%=projectDetails[j][1] %>&nbsp;:&nbsp;<%=projectDetails[j][4] %>"><%=projectDetails[j][1] %>&nbsp;:&nbsp;<%=projectDetails[j][4] %></h2>
</div>
...
if(projectDetails.length>0){
	for(int j=0;j<projectDetails.length;j++){
%>
<option value="<%=projectDetails[j][0]%>#<%=projectDetails[j][7] %>"><%=projectDetails[j][1] %>&nbsp;:&nbsp;<%=projectDetails[j][4] %></option>
<%}} %>
</select>
</div>
...
<button type="submit" class="bt-style1 bt-link bt-radius bt-loadmore" onclick="return itemValidations();">Add</button>
</div>
</div>
</div>
</div>
          ...
          <div class="clearfix">          
           ...
           <div class="box-width7 col-xs-1 box-intro-bg">
            ...
            <div class="box-width7 col-xs-6 box-intro-bg">
              ...
              <div class="box-width8 col-xs-6 box-intro-bg">
               <div class="box-intro-border">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="clearfix">          
           ...
           <div class="box-width7 col-xs-6 box-intro-background">
            ...
            <div class="box-width8 col-xs-6 box-intro-background">
               <div class="link-style12">
           ...
           <div class="box-width24 col-xs-6 box-intro-background">
               <div class="link-style12">
               <p class=""><a class="" href="javascript:void(0);" onclick="deleteItem('<%=itemDetails[i][0]%>');"><i class="fa fa-trash"></i> </a></p>
               </div>
           </div>
        </div>
      </div>
...
<button type="submit" class=" bt-link bt-radius bt-loadmore" onclick="generateBill()" id="FinishSale">Finish</button>
</div>
...
function checkDeliverDate(preguid){	
...
function generateBill(){
	...
	$.ajax({
		...
		success : function(response){
			...
			xhttp.open("GET", "<%=request.getContextPath()%>/GenerateBill111?cuid="+cuid, true);
			xhttp.send();	
		}else{
...
function deleteItem(id){
	...
	xhttp.open("GET", "<%=request.getContextPath()%>/DeleteBillItem111?info="+id, true);
	xhttp.send();
	}
}
</script>
