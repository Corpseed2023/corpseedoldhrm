	...
	<div id="content">
		<div class="container">   
          <div class="bread-crumb relative_box">
			...
			<a href="<%=request.getContextPath()%>/managereport.html" style="margin-left: 888px;"><button class="bkbtn">Back</button></a>	
          </div>
        </div>
...
<button type="button" class="filtermenu" style="width: 104px;margin-left: -14px;">Account</button>
</div>
</div>
				...
				<div class="row">
                	<div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="menuDv partner-slider8" style="padding-left: 30px;">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Account Asset</div>
							...
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Total  Asset</div>
							...
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Accounting fees</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;4500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>	
							<div class="row" style="padding-top: 15px;padding-bottom: 22px;margin-right: 15px;border-bottom: 1px solid #f2f1f1;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Utilities fees</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;4000</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>						
							<div class="row" style="padding-top: 15px;padding-bottom: 15px;margin-right: 15px;border-bottom: 1px solid #645f5f;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Total Expense</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;8500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px;padding-bottom: 15px;margin-right: 15px;border-bottom: 1px solid #645f5f;font-weight: 600;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Total for all account</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;8500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
					</div>
