	...
	<div id="content">
		<div class="container">   
          <div class="bread-crumb relative_box">
			...
			<a href="<%=request.getContextPath()%>/managereport.html" style="margin-left: 931px;"><button class="bkbtn">Back</button></a>			
          </div>
        </div>
...
<button type="button" class="filtermenu" style="width: 200px;margin-left: -14px;">Sales & Purchase</button>
</div>
</div>
                        ...
                        <div class="menuDv partner-slider8">
							...
							<div class="clearfix">
                               <div class="clearfix box-intro-bg">
                                <div class="box-width24 col-md-1 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;"></p>
                                    </div>
                                </div>
								<div class="box-width2 col-md-1 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;"><span style="font-weight: normal;margin-bottom: 6px;margin-top:-24px; ">Date&nbsp;&nbsp;<i class="fa fa-long-arrow-down"></i></span></p>
                                    </div>
                                </div>
                                <div class="box-width145 col-md-1 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%; ">Invoice</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">Subject to Tax</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>                                    
                                    </p>
                                    </div>
                                </div>
                                 <div class="box-width145 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
									<span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">Sales</span><br>
									<span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">Subject to Tax</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;1300002</span>
                                    </p>
                                    </div>
                                </div>
								<div class="box-width145 col-xs-1 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">Tax amount on</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">sales</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;57000</span>                                    
                                    </p>
                                    </div>
                                </div>
                                <div class="box-width145 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">Bills</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">Subject to purchase tax</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>                                    
                                    </p>
                                    </div>
                                </div>
								<div class="box-width145 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">Purchase</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">Subject to purchase tax</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>
                                    </p>
                                    </div>
                                ...
                                <div class="box-width145 col-xs-12 box-intro-bg">
                                    ...
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">Tax amount on</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">Purchase</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>                                    
                                    </p>
                                    </div>
                                </div>                                   
                               ...
                               <div class="clearfix">                               
                                <div class="box-width24 col-md-1 col-xs-12 box-intro-background">
                                    ...
                                    <p class="news-border text-center"><input type="checkbox" name=""></p> 
                                    </div>
                                </div>
								<div class="box-width2 col-md-1 col-xs-12 box-intro-background">
                                	<div class="link-style12">
                                    <p class="news-border">2020-08-22</p>
                                    </div>
                                </div>
                                <div class="box-width145 col-md-1 col-xs-12 box-intro-background">
                                	<div class="link-style12">
                                    <p class="news-border">0003 - project name</p>
                                    </div>
                                </div> 
                                <div class="box-width145 col-xs-12 box-intro-background">
                                	<div class="link-style12">
                                    <p class="news-border"><i class="fa fa-inr"></i>&nbsp;5000000</p>
                                    </div>
                                </div>
								<div class="box-width145 col-xs-1 box-intro-background">
                                	<div class="link-style12">
                                    <p class="news-border"><i class="fa fa-inr"></i>&nbsp;1300002</p>
                                    </div>
                                </div>
								<div class="box-width145 col-xs-12 box-intro-background">
                                	<div class="link-style12">
