    ...
    <div class="row advert">
        <div class="col-md-12 col-sm-12 col-xs-12 mb10">
            <div class="menuDv partner-slider8">
                <div class="box-intro">
                  <h2><span class="title">Set Project's Price</span></h2>
                </div>
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                   <div class="clearfix">
                   <div class="box-width21 col-xs-1 box-intro-bg">
                        ...
                        <p class="news-border">Project's No.</p>
                        </div>
                    </div>
                    ...
                    <div class="box-width45 col-xs-1 box-intro-bg">
                        <div class="box-intro-border">
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                   ...
                   <div class="box-width21 col-xs-1 box-intro-background">
                    ...
                    <div class="box-width45 col-xs-1 box-intro-background">
                        <div class="link-style12">
                        <p class="news-border" title="<%=project[3] %>"><%=project[3] %></p>
                        </div>
                    </div>                    
                   </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="box-width24 col-xs-1 box-intro-background">
                        ...
                        <div class="box-width21 col-xs-2 box-intro-background">
                            <div class="link-style12">
                            <p class="text-center"><a  href=""<%if(!project[5].equalsIgnoreCase("Delivered")){ %>  onclick="deletePrice('<%=projectPrice[i][0] %>')"<%}else{ %>style="cursor: not-allowed;"<%} %>><i class="fa fa-trash" title="Delete this price type."></i></a></p>
                            </div>
                        </div>
                     </div>
                   </div>
