...
<head>
	...
	<title>Grant/Deny Access Sub-Folder Permission</title>
    ...
    <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="menuDv marg10">
                    <div class="box-intro">
                      <h2><span class="title">Grant/Deny Access Sub-Folder Permission</span></h2>
                    </div>
...
<script type="text/javascript">
	function deletePermission(id){
		if(confirm("Warning : Are You Sure Want to delete ?")){
		var xhttp;
...
$(function() {
	$("#User_Id").autocomplete({
		source : function(request, response) {
			...
			if(document.getElementById('User_Id').value.trim().length>=2)
			$.ajax({
				url : "getalluser.html",
				type : "POST",
				dataType : "JSON",
		...
		change: function (event, ui) {
            if(!ui.item){     
            	document.getElementById("useridErr").innerHTML="Select From List.";
