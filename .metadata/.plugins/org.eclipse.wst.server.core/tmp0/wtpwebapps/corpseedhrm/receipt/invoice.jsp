...
if(billing.length>0){
	...
	clgstin=Clientmaster_ACT.getClientName(billing[0],token);
...
<%-- <p style="font-weight:600;" class="text-left"><%=billno %></p> --%>
<a onclick="javascript:saveAspdf()"><i class="fa fa-print" style="font-size: 25px;float: left;" id="PrintIcon"></i></a>
<a onclick="javascript:emailAspdf()"><i class="fa fa-envelope-o" style="font-size: 25px;float: left;margin-left: 15px;" id="EmailIcon"></i></a>
<a onclick="javascript:downloadAspdf()"><i class="fa fa-download" style="font-size: 25px;float: left;margin-left: 15px;" id="DownloadIcon"></i></a>
</div>
</div>
</div>
<div class="clear"></div>
...
<p class="rcptstatus"><span style="color: <%=color%>;"><%=paystatus %></span></p>
</div>
