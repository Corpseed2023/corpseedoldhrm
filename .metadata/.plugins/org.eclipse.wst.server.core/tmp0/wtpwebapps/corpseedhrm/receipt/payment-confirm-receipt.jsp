...
<p style="font-weight:600;" id="EstimateBillNo"># <%=payment[0][1]%></p>
</div>
</div>
</div>
<div class="clear"></div>
...
<p><span style="font-weight:600;color:#888;">Date :</span> <span style="padding-left:20px;"><%=payment[0][0]%></span></p>
</div>
...
<td style="padding: 3px;font-weight:600" colspan="7"><%=payment[0][5] %></td></tr>
<%
double rate=0;
double gstSum=0; 
...
<td style="padding: 3px;"><%=CommonHelper.withLargeIntegers(Math.round(Double.parseDouble(payment[0][4])))%></td>
</tr>
</table>
</div>
<div class="clear"></div>
...
<p style="font-size: 11px;color:#888;"><%=payment[0][7] %></p>
<%} %>
</div>
<div class="clearfix" style="width:100%;">
<p style="color:#888;">
...
$( document ).ready(function() {
	var totalAmount="<%=Math.round(Double.parseDouble(payment[0][4]))%>";
