...
<form action="<%=request.getContextPath()%>/added-daily-expenses.html" method="post" name="add_expence">
<div class="row">
...
<input type="text" name="invoiceno" id="Invoice No" class="form-control" placeholder="Invoice No.*" onblur="requiredFieldValidation('Invoice No','InvoiceNoerrorMSGdiv');validateUserName('Invoice No','InvoiceNoerrorMSGdiv');validateValue('Invoice No','InvoiceNoerrorMSGdiv');" >
</div>
...
<input type="text" name="Amount" id="Amount" class="form-control" placeholder="Amount*" onblur="requiredFieldValidation('Amount','AmounterrorMSGdiv');validateGreater('Amount','AmounterrorMSGdiv');" onkeypress="return isNumberKey(event)">
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="form-icon fa fa-money"></i></span>
<select name="gst" id="GST" class="form-control" onblur="requiredFieldValidation('GST','GSTerrorMSGdiv');" onchange="showHide(this.value);">
...
<input type="text" name="gstcategory" id="GST Category" value="NA" class="form-control" placeholder="GST Category*" onblur="requiredFieldValidation('GST Category','gstcategoryerrorMSGdiv');validateName('GST Category','gstcategoryerrorMSGdiv');" >
</div>
...
<input type="text" name="gsttax" id="GST Tax" value="NA" class="form-control" placeholder="GST Tax*" onblur="addgst();requiredFieldValidation('GST Tax','gsttaxerrorMSGdiv');" >
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="form-icon fa fa-money"></i></span>
<input type="text" name="gstvalue" id="GST Value" value="NA" class="form-control" readonly placeholder="GST Value*" onblur="requiredFieldValidation('GST Value','gstvalueerrorMSGdiv');" >
</div>
...
<input type="text" name="place" id="Place" class="form-control" placeholder="Place*" onblur="requiredFieldValidation('Place','PlaceerrorMSGdiv');validateLocation('Place','PlaceerrorMSGdiv');validateValue('Place','PlaceerrorMSGdiv');addgst();" >
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="form-icon fa fa-file"></i></span>
<input type="text" name="servicecode" id="Service Code" class="form-control" placeholder="Service Code*" onblur="requiredFieldValidation('Service Code','ServiceCodeerrorMSGdiv');validateUserName('Service Code','ServiceCodeerrorMSGdiv');validateValue('Service Code','ServiceCodeerrorMSGdiv');" >
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="form-icon fa fa-user"></i></span>
<input type="text" name="Paid To" id="Paid_To" autocomplete="off" class="form-control" placeholder="Paid To*" onblur="requiredFieldValidation('Paid_To','PaidToerrorMSGdiv');validateName('Paid_To','PaidToerrorMSGdiv');validateValue('Paid_To','PaidToerrorMSGdiv');" >
</div>
...
<input type="text" name="ExpensesCategory" id="Expenses Category" class="form-control" placeholder="Expenses Category*" onblur="requiredFieldValidation('Expenses Category','ExpensesCategoryerrorMSGdiv');validateName('Expenses Category','ExpensesCategoryerrorMSGdiv');" >
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="form-icon fa fa-money"></i></span>
<input type="text" name="totalinvoiceamount" id="Total Invoice Amount" class="form-control" readonly placeholder="Total Invoice Amount*" onblur="requiredFieldValidation('Total Invoice Amount','totalinvoiceAmounterrorMSGdiv');" >
</div>
...
<textarea name="Description" id="Description" placeholder="Description*" class="form-control" onblur="requiredFieldValidation('Description','DescriptionerrorMSGdiv');validateLocation('Description','DescriptionerrorMSGdiv');"></textarea>
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="form-icon fa fa-user"></i></span>
<input type="text" name="ApprovedBy" id="ApprovedBy" class="form-control" placeholder="Approved By*" autocomplete="off" onblur="requiredFieldValidation('ApprovedBy','ApprovedByerrorMSGdiv');validateName('ApprovedBy','ApprovedByerrorMSGdiv');validateValue('ApprovedBy','ApprovedByerrorMSGdiv');">
</div>
...
<input type="text" name="PaidDate" id="PaidDate" class="form-control readonlyAllow" placeholder="Paid Date*" onchange="requiredFieldValidation('PaidDate','PaidDateerrorMSGdiv');" onblur="requiredFieldValidation('PaidDate','PaidDateerrorMSGdiv');" readonly>
</div>
...
{
PaidDateerrorMSGdiv.innerHTML="PaidDate is required.";
