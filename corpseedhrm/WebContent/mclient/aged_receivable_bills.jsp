...
<head>
	...
	<title>Aged Receivables Bills</title>
	...
	<div id="content">
		<div class="container">   
          <div class="bread-crumb relative_box">
            ...
            <a>Aged Receivables Bills</a>
            </div>
			<a href="<%=request.getContextPath()%>/managereport.html" style="margin-left: 860px;"><button class="bkbtn">Back</button></a>			
          </div>
        </div>
...
<button type="button" class="filtermenu" style="width: 200px;margin-left: -14px;">Aged Receivables Bills</button>
</div>
</div>
