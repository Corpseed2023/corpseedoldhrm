...
<head>
	...
	<title>Aged Receivables Invoice</title>
...
<%if(!MB07){%><jsp:forward page="/login.html" /><%} %>
	...
	<%-- 	<div class="container">   
          <div class="bread-crumb relative_box">
            ...
            <a>Aged Receivables Invoice</a>
            </div>
			<a href="<%=request.getContextPath()%>/managereport.html" style="margin-left: 843px;"><button class="bkbtn">Back</button></a>			
          </div>
        </div> --%>
...
<div class="bg_wht clearfix mbt20">  
<div class="row">
<div class="col-md-5 col-sm-5 col-xs-12"> 
<div class="col-md-2 box-width7">
<button type="button" class="filtermenu" style="width: 200px;margin-left: -14px;">Aged Receivables Invoice</button>
</div>
</div>
							...
							<div class="clearfix">
                               <div class="clearfix box-intro-bg">
                                ...
                                <div class="box-width145 col-md-1 col-xs-12 box-intro-bg">
                                    ...
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%; ">Not yet over due</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">&nbsp;23&nbsp; Invoices</span>
                                    </p>
                                    </div>
                                </div>
                                 <div class="box-width145 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
									<span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">30 or less days</span><br>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">&nbsp;23&nbsp; Invoices</span>
									</p>
                                    </div>
								...
								<div class="box-width145 col-xs-1 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">31 to 60 days</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">&nbsp;23&nbsp; Invoices</span>
                                    </p>
                                    </div>
                                ...
                                <div class="box-width145 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">61 to 90 days</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">&nbsp;23&nbsp; Invoices</span>
                                    </p>
                                    </div>
								...
								<div class="box-width145 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">91 or more</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">&nbsp;23&nbsp; Invoices</span>
                                    </p>
                                    </div>
                                ...
                                <div class="box-width145 col-xs-12 box-intro-bg">
                                	<div class="box-intro-border">
                                    <p class="news-border" style="height: 60px;">
                                    <span style="font-weight: normal;margin-bottom: 6px;margin-top:6px;width: 100%;">Not yet paid</span>
                                    <span class="fa fa-inr" style="font-weight: 600;margin-left: 1px;margin-bottom: 6px;width: 100%;">&nbsp;0.00</span>
                                    <span style="color: #aaaa;font-weight: normal;margin-left: -2px;margin-bottom: 6px;width: 100%;">&nbsp;23&nbsp; Invoices</span>
                                    </p>
                                    </div>
