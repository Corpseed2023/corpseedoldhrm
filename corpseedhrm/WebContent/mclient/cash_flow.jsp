	...
	<div id="content">
		<div class="container">   
          <div class="bread-crumb relative_box">
			...
			<a href="<%=request.getContextPath()%>/managereport.html" style="margin-left: 928px;"><button class="bkbtn">Back</button></a>			
          </div>
        </div>
...
<button type="button" class="filtermenu" style="width: 140px;margin-left: -14px;">Cash Flow</button>
</div>
</div>
				...
				<div class="row">
                	<div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="menuDv partner-slider8" style="padding-left: 30px;">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">CASH INFLOW AND OUTFLOW</div>
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Operating Activities</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Sales</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;4500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Purchase</div>
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">Sales Taxes</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;4000</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Total  Cash from operating activities</div>
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Investing Activities</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
							...
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Net Cash flow investing activities</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;8500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="background: #f0eeeeaa;margin-right: 15px;margin-top: 25px;">
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Financing Activities</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
							...
							<div class="row" style="background: #f0eeeeaa;margin-right: 15px;margin-top: 25px;">
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Overview</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Gross Cash inflow</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;200</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>	
							<div class="row" style="padding-top: 15px;padding-bottom: 22px;margin-right: 15px;border-bottom: 1px solid #f2f1f1;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Gross Cash outflow</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;200</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>						
							<div class="row" style="padding-top: 15px; padding-bottom: 14px;margin-right: 15px;border-bottom: 1px solid #f2f1f1;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Net Cash Flow</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;8500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600">Ending balance</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;540000</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
					</div>
				</div>
