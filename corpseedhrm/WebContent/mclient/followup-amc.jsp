...
<title>Follow-Up AMC Account</title>
...
<input type="hidden" name="transferpage" value="amc-account.html" readonly>
<input type="hidden" name="fromfollowup" value="amc" readonly>
<input type="hidden" name="projectno" value="<%=projectDetails[0][1]%>" readonly>
<input type="hidden" name="pfupid" id="pfupid" value="<%=projectDetails[0][0]%>" readonly>
<div class="col-md-12 col-sm-12 col-xs-12">
<div class="clearfix footer-bottom2">
<div class="box-width26 col-sm-3 col-xs-12  box-intro-background">
...
<div class="box-width11 col-sm-2 col-xs-12  box-intro-background">
<div class="add-enquery">
...
<div class="box-width33 col-sm-4 col-xs-12  box-intro-background">
<div class="add-enquery">
<input type="text" name="pfuddate" id="pfuddate" placeholder="Date of Delivery" value="<%=projectDetails[0][7]%>" class="form-control readonlyAllow" data-date-format="dd-mm-yyyy  HH:ii p" readonly="readonly" disabled="disabled">
<input type="hidden" name="deliverydate" id="deliverydate" value="<%=projectDetails[0][7]%>">
</div>
</div>
</div>
<div class="clearfix">
...
<p><a onclick="deleteFollowUp(<%=getFollowUpById[i][0]%>);"><i class="fa fa-trash-o"></i></a></p>
</div>
</div>
<div class="clearfix">
<div class="col-xs-12 box-intro-background">
...
function statusValidations() {
	if(document.getElementById('pfustatus').value.trim()=="" ) {
	    document.getElementById('pfustatus').focus();
	return false;
	}
	if(document.getElementById('followupby').value.trim()=="" ) {
	    document.getElementById('followupby').style.border = "1px solid red";
	    document.getElementById('followupby').focus();
	return false;
	}
	if(document.getElementById('pfudate').value.trim()=="" ) {
	    document.getElementById('pfudate').style.border = "1px solid red";
	    document.getElementById('pfudate').focus();
	return false;
	}

	if(document.getElementById('pfuddate').value.trim()=="" ) {
	    document.getElementById('pfuddate').value="NA";
	}
	if(document.getElementById('showclient').value.trim()=="" ) {
	    document.getElementById('showclient').style.border = "1px solid red";
	    document.getElementById('showclient').focus();
	return false;
	}
	}
</script>
