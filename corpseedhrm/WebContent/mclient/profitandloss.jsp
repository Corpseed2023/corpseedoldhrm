		...
		<div class="container">   
          <div class="bread-crumb relative_box">
            ...
            <a>Profit & Loss</a>
				...
				<a href="<%=request.getContextPath()%>/managereport.html" style="margin-left: 913px;"><button class="bkbtn">Back</button></a>		
          </div>
        </div>
...
<button type="button" class="filtermenu" style="width: 140px;margin-left: -14px;">Profit & Loss</button>
</div>
</div>
                	...
                	<div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="menuDv partner-slider8" style="padding-left: 30px;">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: -13px;">2020</div>
							 <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: -7px;">2019</div>
							</div>
							<div class="row" style="background: #f0eeeeaa;margin-right: 15px;margin-top: 10px;">
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Income</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Sales Income</div>
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">Interest Income</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;4000</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Total Income</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;4500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="background: #f0eeeeaa;margin-right: 15px;margin-top: 25px;">
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Cost of Goods Sold</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
							<div class="row" style="padding-top: 15px;padding-bottom: 14px;margin-right: 15px;border-bottom: 1px solid #f2f1f1;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Total Cost of Goods Sold</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;0</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Gross Profit</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;8500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="background: #f0eeeeaa;margin-right: 15px;margin-top: 25px;">
                            <div class="col-md-8 col-sm-8 col-xs-12" style="font-weight: 600;font-size: 14px; padding: 4px 0px 4px 15px;">Expense</div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							 <div class="col-md-2 col-sm-2 col-xs-12"></div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Bank Charges & Interest Expense</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;200</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Contractor Expense</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;200</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Office Expense</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;200</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; padding-bottom: 14px;margin-right: 15px;border-bottom: 1px solid #f2f1f1;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Payroll Expense</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;200</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px;padding-bottom: 14px;margin-right: 15px;border-bottom: 1px solid #f2f1f1;;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Total Expense</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;8500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
							<div class="row" style="padding-top: 15px; margin-bottom: 10px;margin-right: 15px;">
                            <div class="col-md-8 col-sm-8 col-xs-12">Net Income</div>
							 <div class="col-md-2 col-sm-2 col-xs-12  fa fa-inr">&nbsp;8500</div>
							 <div class="col-md-2 col-sm-2 col-xs-12 fa fa-inr">&nbsp;0</div>
							</div>
					</div>
