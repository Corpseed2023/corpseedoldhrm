...
<div class="wrap">
    ...
    <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="menuDv">
                    <div class="box-intro">
                      <h2><span class="title">SMS</span></h2>
                    </div>
                <div class="clearfix pad_box2">
                       <form method="post" action="<%=request.getContextPath() %>/"  name="follow-up-form">
                            ...
                            <input type="text" id="SMS" maxlength="10" autocomplete="off" name="name" onblur="validateMobileno('SMS','nameErr');" class="form-control" placeholder="Mobile Number here !" onkeypress="return isNumber(event)"/>
...
<script type="text/javascript">
	...
	var sms=document.getElementById('SMS').value.trim();
	var message=document.getElementById('Message').value.trim();	
		
	if(sms=="" ) {
		nameErr.innerHTML="Mobile No. is required.";
