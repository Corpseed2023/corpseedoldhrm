...
<%
String salesrefid=request.getParameter("uid").trim();

salesrefid=salesrefid.substring(13,salesrefid.length()-5);
...
String clientLocation=TaskMaster_ACT.getClientlocation(clientKey,token); 
...
String dashboardCommunication=(String)session.getAttribute("dashboardCommunication");
if(dashboardCommunication==null||dashboardCommunication.length()<=0)dashboardCommunication="NA";
//getting all dynamic form template
String template[][]=TaskMaster_ACT.getAllFormTemplate(token);
String activityType=(String)session.getAttribute("searchByActivity1");
...
%>
<%-- <%if(!MT03){%><jsp:forward page="/login.html" /><%} %> --%>
<div id="content">
<div class="container">
...
<div class="pright add_btn_box mtop10">
<a class="add_btn sub-btn1" onclick="goBack()">Back</a>
</div>
</div>
</div>
...
<div class="flex_box mennbox col-md-8 col-sm-8 col-xs-12"> 
<div class="filterBox_inner "> 
<div class="filterBox_title box_shadow1"><span>Follow up</span><%if(!unseenChat.equalsIgnoreCase("0")){ %><span class="homeNotification"><%=unseenChat %></span><%} %></div>
<ul class="filterBox_dropdown"><%if(closeDate.equalsIgnoreCase("NA")){ %>
<li><a class="openChat" data-related="open_chat" id="OpenChatByClickId" onclick="openChatBox()">Chat<%if(!unseenChat.equalsIgnoreCase("0")){ %><span class="homeNotification"></span><%} %></a></li><%} %>
...
<div class="filterBox_inner">
<div class="filterBox_title box_shadow1 showmilestone" data-related="show_milestone" onclick="openMilestoneBox()"><span>Milestone</span></div>
</div>
<div class="filterBox_inner">
...
<%-- <p>Service : <%=productName %>&nbsp;( <%=jurisdiction %> )</p> --%>
<div class="location_box">
<i><img src="<%=request.getContextPath() %>/staticresources/images/location_icon.png" alt=""/></i><span><%=clientLocation%></span> 
</div>

<div class="clearfix mbt20 box_shadow1">
<div class="clearfix search_section"> 
<h4 class="normal_txt" id="AssigneeBoxId"><span id="SelectAssigneeId">Select Assignee</span>
<span class="toggle_box" id="SearchAssigneeId"><i class="fas fa-search" style="position: absolute;margin: 12px;"></i>
<input type="text" style="padding-left: 30px;" autocomplete="off" oninput="searchMilestone(this.value)" name="SearchAssigneName" id="SearchAssigneName" placeholder="Type milestone name" class="form-control"></span>
</h4> 
<span class="search_icon text-center">
<i onclick="searchAssigneName('SelectAssigneeId','SearchAssigneeId','AssigneeBoxId','SearchAssigneName')">
<img src="<%=request.getContextPath() %>/staticresources/images/search_icon.png" alt=""  id="SearchIconId"/></i>
<span class="fas fa-times toggle_box" id="TimesIconId" onclick="hideAssigneName('SelectAssigneeId','SearchAssigneeId','AssigneeBoxId','SearchAssigneName')"></span>
</span>
</div>
<div class="clearfix">

<div id="MilestoneListBoxId"></div>
...
<h4 class="normal_txt"><span>My Task</span></h4> 
</div>
<div class="clearfix" id="TeamAdminAssignedTaskAppendId"></div>
...
<div class="filterBox_inner mobileactivity " >
<div class="filterBox_title"><img src="<%=request.getContextPath() %>/staticresources/images/arrow_down1.png" alt=""/> All Activities</div>
<ul class="filterBox_dropdown mobiledropdown" style="display:none">
<li><a onclick="doAction('NA','searchByActivity1');"><span class="dot_circle0"></span>All</a></li>
<li><a onclick="doAction('Call log','searchByActivity1');"><span class="dot_circle"></span>Call logs</a></li>
<li><a onclick="doAction('Email','searchByActivity1');"><span class="dot_circle1"></span>Email</a></li>
<li><a onclick="doAction('Public Reply','searchByActivity1');"><span class="dot_circle2"></span>Chats</a></li>
<li><a onclick="doAction('Note','searchByActivity1');"><span class="dot_circle3"></span>Note</a></li>
<li><a onclick="doAction('Notification','searchByActivity1');"><span class="dot_circle4"></span>Notification</a></li>
<li><a onclick="doAction('Reminder','searchByActivity1');"><span class="dot_circle5"></span>Reminders</a></li>
<li><a onclick="doAction('Expense','searchByActivity1');"><span class="dot_circle6"></span>Expense</a></li>
</ul> 
</div>
...
<div class="filterBox_inner mposition">
<a href="javascript:void(0)" class="doticon"> <i class="fa fa-ellipsis-v " aria-hidden="true"></i></a>
<div class="filterBox_title mobilehide"><img src="<%=request.getContextPath() %>/staticresources/images/arrow_down1.png" alt=""/> All Activities</div>
<ul class="filterBox_dropdown mobiledropdown" >
<li><a onclick="doAction('NA','searchByActivity1');"><span class="dot_circle0"></span>All</a></li>
<li><a onclick="doAction('Call log','searchByActivity1');"><span class="dot_circle"></span>Call logs</a></li>
<li><a onclick="doAction('Email','searchByActivity1');"><span class="dot_circle1"></span>Email</a></li>
<li><a onclick="doAction('Public Reply','searchByActivity1');"><span class="dot_circle2"></span>Chats</a></li>
...
<div class="flex_box justify_end col-md-8 col-sm-8 col-xs-11"> 
<div class="filterBox_inner"> 
<div class="filterBox_title box_shadow1"><span>Follow up</span><%if(!unseenChat.equalsIgnoreCase("0")){ %><span class="homeNotification"><%=unseenChat %></span><%} %></div>
<ul class="filterBox_dropdown"><%if(closeDate.equalsIgnoreCase("NA")){ %>
<li><a class="openChat" data-related="open_chat" id="OpenChatByClickId" onclick="openChatBox()">Chat<%if(!unseenChat.equalsIgnoreCase("0")){ %><span class="homeNotification"></span><%} %></a></li><%} %>
...
<%
String threds[][]=TaskMaster_ACT.getAllThread(salesrefid,uaid,userRole,teamLeaderUid,token,activityType,"NA"); 
...
<%-- 	<span class="gray_txt bdr_bt pointers" onclick="editTextarea('NotesWrittenId<%=i %>','DisplayNoneJsId<%=i %>','DisplayNoneSubmitId<%=i %>','DisplayNoneTimerId<%=i %>')">Edit</span> --%>
...
%>
	...
	<div class="contentInnerBox contentInnerBox3 box_shadow1 relative_box mb10">
	<%
	String chatThread[][]=TaskMaster_ACT.getAllTodaysChats(datePrinted,salesrefid,uaid,userRole,teamLeaderUid,token,"NA");
	...
	<span><span class="gray_txt bdr_bt fntsize10"><%=time %></span></span>
	</div>	
	<%}} %>
...
<button class="bt-link bt-radius bt-loadmore" id="exp_btn" type="submit" onclick="return validateAddExpense()">Submit</button>
</div>
</form>                                  
</div>
...
<div class="clearfix add_inner_box pad_box4 addcompany" id="show_milestone" style="display: none;">
<div class="close_icon close_box"><i class="fa fa-times"></i></div>
<div class="rttop_title">
<h3 style="color: #42b0da;"><i class="fas fa-file"></i>Milestones : <span style="color:#357b8bf5;"><%=projectNo %></span></h3> 
</div>
...
<div class="close_icon close_box"><i class="fa fa-times"></i></div>
<div class="rttop_title">
<h3 style="color: #42b0da;"><i class="fas fa-file"></i>Document List : <span style="color:#357b8bf5;"><%=projectNo %></span></h3> 
</div>
<div class="tab">
...
// System.out.println(orderPaidAmount[1]+"#"+orderPaidAmount[0]);
...
<div class="clearfix bg_wht link-style12">
   ...
   <div class="col-xs-2 box-intro-background">
      ...
      <span id="AppendDocDownload<%=i %>"></span>
       ...
       <button onclick="uploadDocModal('<%=i %>','<%=doclist[i][0] %>','2')" style="border: none;background: #ffff;"><i class="fas fa-file"></i></button>
       </span>
...
<div class="clearfix bg_wht link-style12">
   ...
   <div class="col-xs-2 box-intro-background">
      ...
      <span id="AppendDocDownload1<%=i %>"></span>
       <span style="margin-right: 3px;">
       <button onclick="uploadDocModal('<%=i %>','<%=doclist1[i][0] %>','1')" style="border: none;background: #ffff;"><i class="fas fa-file"></i></button>
       </span>
...
<li class="" id="InternalreplyLi" onclick="showInternalReply('PublicreplyLi','InternalreplyLi','ReplyNotesBoxId','InternalNotesBoxId','ChatReplyButtonId')"><a >Internal note</a></li>
</ul>
...
<span class="bg_circle"><input type="datetime-local" id="MilestoneAssignDate" readonly></span></span> 
...
<select id="ChatReplyBoxTaskId" onchange="setStartingDate(this.value)">	
</select>
</div>
</div>
</form>
...
<ul class="filterBox_dropdown" id="AppendCompletedOption">  
...
<div class="modal fade" id="AddNewDocumentList" tabindex="-1" role="dialog" aria-labelledby="DocumentListModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
  	 <div class="modal-header">
        <h5 class="modal-title" >+&nbsp;Document List : <span style="color:#357b8bf5;"><%=projectNo %></span></h5>
        <button type="button" class="closeBox" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="UploadNewDocument" tabindex="-1" role="dialog" aria-labelledby="DocumentListModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row location_box">
			<div class="col-md-6">
				<select class="form-control" name="DocumentUploadBy" id="DocumentUploadTask">
					<option value="">Select Task</option>					
				</select>
			</div>						
			<div class="col-md-6">
				<input type="file" name="NewDocumentFile" onchange="validateFileSize('NewDocumentFile')" id="NewDocumentFile" class="form-control">
			</div>
		 ...
		 <div class="modal-footer">
		 <input type="hidden" name="IndexNumber" id="IndexNumber">
		 <input type="hidden" name="DocumentKey" id="DocumentKey">
		 <input type="hidden" name="DocumentIdChange" id="DocumentIdChange">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary" onclick="return validateUploadDocument()">Submit</button>
      </div> 
      </div>
	</form>  
  </div>
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row location_box">
		 ...
		 <div class="modal-footer">
		 <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
         <button type="button" class="btn btn-primary" onclick="saveNotesReply('NA','NA')">Submit</button>
      </div> 
      </div>
	</form>  
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">          
		  ...
		  <div class="row mb10">
            ...
            <div class="form-group-payment col-md-12 col-sm-12 col-12">
			<label>Message</label>
            <textarea class="form-control" name="Email_description" id="Email_Description" placeholder="Description..." autocomplete="off"><p>Dear, <%=contactName %> </p><p>You have new follow-up on project number <b><%=projectNo %></b></p></textarea>
            </div>
            </div>
          </div>
		  </div>  		  
...
<input type="hidden" id="ActiveEmployeeName" value="<%=loginUserName%>">
<input type="hidden" id="ActiveEmployeeProject" value="<%=projectNo%>">
...
function setStartingDate(data){
	if(data!=null&&data!=""){
		var x=data.split("#");
		$("#MilestoneAssignDate").val(x[2]);
		
		setExtendDate(x[2],x[0]);
		changeSubmitStatus(x[3]);
	}
}
function changeSubmitStatus(workPercent){
	if(Number(workPercent)==100){
		$(".removeComplected").remove();
		$("#AppendCompletedOption").append('<li class="removeComplected"><a onclick="validateChatReply(\'Completed\')"><span class="dot_circle_completed"></span>Completed</a></li>');
	}else{
		$(".removeComplected").remove();
	}
...
function uploadFile(uploadbox,MainDownloadIcon,AppendDocDownload,docKey,File,DocumentListDateId,assignKey,workStartPrice){	
	if($("#"+File).val()!=""){
		showLoader();
	var today="<%=today%>";
...
function fillAdminAssignedTask(){
	$(".MyTaskAssigned").remove();
	var salesrefid="<%=salesrefid%>";
	var leaderUid="<%=teamLeaderUid%>";	
// 	alert(salesrefid+"/"+leaderUid);
showLoader()
	$.ajax({
		type : "POST",
		url : "GetAllAssignedSalesMilestoneList111",
		dataType : "HTML",
		data : {				
			salesrefid : "<%=salesrefid%>",
			leaderUid : leaderUid
...
// 			 var k=1;
			 for(var i=0;i<Number(len);i++){	
				...
				var mamemberassigndate=response[i]["mamemberassigndate"];
				var workPercent=response[i]["workPercent"];
				var salesmilestonekey=response[i]["salesmilestonekey"];
				
					var TaskAssignedMeId="TaskAssignedMeId"+i;
					var TaskPercentagedone="TaskPercentagedone"+i;
					$(''+
							'<div class="clearfix MyTaskAssigned">'+
							'<div class="clearfix inner_section"> '+
							'<span class="icon_box1 text-center">ts</span>'+ 
							'<span class="text_box1"><label>'+milestonename+'</label><span>'+mamemberassigndate+'</span></span>'+
							...
							'<div class="input-group">'+
							'<span class="input-group-addon"><i class="form-icon fa fa-check"></i></span>'+
							'<input type="text" name="task'+i+'" id="Task'+i+'" placeholder="" value="'+milestonename+'" class="form-control" readonly="readonly">'+
							'</div>'+
							'</div>'+
							'<div class="form-group">'+
							...
							'<input type="number" name="taskdate'+i+'" min="0" max="100" value="'+workPercent+'" onchange="validateNumber(this.value,\''+TaskPercentagedone+'\')" id="'+TaskPercentagedone+'" placeholder="Percentage" class="form-control" onkeypress="return isNumber(event)">'+
							'</div>'+
							'</div>'+
							'<div class="clearfix mtop10 mb10 row">'+
							'<div class="col-md-12 col-sm-12 col-xs-12">'+
							'<div class="clearfix tips mtop10">'+
							'<div class="tooltips pointers" data-related="Task_Step" onclick="openToolTipBox(\''+milestonename+'\',\''+salesmilestonekey+'\')">Task Tips<i class="fa fa-lightbulb-o"></i>'+
							'</div>'+
							'</div>'+
							'</div>'+
							...
							'<button class="bt-link bt-radius bt-loadmore" type="button" onclick="saveWorkPercentage(\''+refid+'\',\''+TaskPercentagedone+'\',\''+salesmilestonekey+'\')">Save</button>'+
							'</div>'+
							'</div>'+
							'</div>'+
							'</div>'+
							'</div>'
							).insertBefore("#TeamAdminAssignedTaskAppendId");					
			}			 
		 }
		}}
	});
}
function setToolTipText(salesmilestonekey){
	$(".toolTipRemove").remove();
	var jurisdiction="<%=jurisdiction%>";
	showLoader();
	$.ajax({
		type : "POST",
		url : "GetAllToolTips111",
		dataType : "HTML",
		data : {				
		 ...
		 if(len>0){
			 ...
			 for(var i=0;i<Number(len);i++){	
				var content=response[i]["content"];
			 	...
			 	if(document=="NA"){
				$(''+
					'<div class="toolTipRemove"><h6>STEP - '+step+'</h6>'+content+'</div>'										
						).insertBefore("#AppendToolTipId");
			 	}else{
			 		$(''+
			 		'<div class="toolTipRemove"><h6>STEP - '+step+'</h6>'+content+''+
			 		'<span class="attachment">'+
					'<div class="file-upload-box">'+
					'<i class="far fa-file"></i>'+
					'<span id="StepGuideFileName1">'+document.substring(21)+'</span>'+
					'<div class="action-btn"><a href="'+home+document+'" download>'+
			...
			$('<div class="toolTipRemove"><h6>No tips provided !!</h6></div>').insertBefore("#AppendToolTipId");
		}},
		complete : function() {
            hideLoader();
        }
		...
		response = JSON.parse(response);			
		 ...
		 if(len>0){
			 ...
			 for(var i=0;i<Number(len);i++){	
				...
				var massignDate=response[i]["massignDate"];
				var workPercent=response[i]["workPercent"];
				var workStartedPercentage=response[i]["workStartedPercentage"];
				var workStartedDate=response[i]["workStartedDate"];
				var workStartedTime=response[i]["workStartedTime"];
				
				if(workStartedTime=="NA")workStartedTime="09:00";
				else if(workStartedTime.length==4)workStartedTime="0"+workStartedTime;
				
				if(memberassigndate=="00-00-0000"){
					memberassigndate=today;
				}
				if(i==0&&Number(workPercent)==100){
					$("#AppendCompletedOption").append('<li class="removeComplected"><a onclick="validateChatReply(\'Completed\')"><span class="dot_circle_completed"></span>Completed</a></li>');
				}
				
				var assTitle="Unassigned !!";
				if(memberName!="Unassigned"){assTitle="Assigned to "+memberName+" on "+massignDate+". !!";}				
				var assignIcon="<%=request.getContextPath() %>/staticresources/images/down_arrow.png";
				if(memberid!=null&&memberid!=""&&memberid!="NA"){assignIcon="<%=request.getContextPath() %>/staticresources/images/assigned.png";}
				var SelectTeam="SelectTeam"+i;
				var Select_Assignee="Select_Assignee"+i;
				var milestone="milestoneName"+i;
				var assignkeyid="assignkeyid"+i;
				var AssigndateId="AssigndateId"+i;
				var assignThisTaskId="assignThisTaskId"+i;
				var assignTaskIconId="assignTaskIconId"+i;
				
				var wStartDate=workStartedDate.substring(6)+workStartedDate.substring(2,6)+workStartedDate.substring(0,2)+"T"+workStartedTime;
				
				if(k==0&&workStartedDate!="00-00-0000"){k=1;
					$("#MilestoneAssignDate").val(wStartDate);
					setExtendDate(workStartedDate,milestonekey);
				}
				if(workStartedDate!="00-00-0000"){					
					var mData=milestonekey+"#"+name+"#"+wStartDate+"#"+workPercent;
					$("#ChatReplyBoxTaskId").append("<option value='"+mData+"'>"+name+"</option>");
				}
				
				$(''+
						'<div class="clearfix inner_section milestoneBox" title="'+assTitle+'"> '+
				'<span class="icon_box1 text-center">T</span> '+
				'<span class="text_box1"><label>'+name+'</label><span>'+aassignDate+'</span></span> '+
				'<span class="link_icon text-center toggleBtn"><i onclick="showAssignBox(\''+assignThisTaskId+'\')"><img id="'+assignTaskIconId+'" src="'+assignIcon+'" alt=""/></i></span>'+
				'</div>'+
				'<div class="clearfix padBox0 marg0 access_box_info toggleBox" id="'+assignThisTaskId+'">'+
				'<div class="bg_ltgray pad_box3 pad-lft10 pad-rt10">'+
				'<div class="form-group">'+
				'<label>Check for </label>'+
				'<div class="input-group">'+
				'<span class="input-group-addon"><i class="form-icon fa fa-check"></i></span> '+
				'<input type="text" autocomplete="off" name="'+milestone+'" id="'+milestone+'" placeholder="Milestone name.." value="'+name+'" class="form-control"/>'+
				'<input type="hidden" name="'+assignkeyid+'" id="'+assignkeyid+'" value="'+assignkey+'"/>'+
				'</div>'+
				'<div id="checkforEerorMSGdiv" class="errormsg"></div> '+
				'</div>'+
				'<div class="form-group">'+
				'<div class="clearfix">'+
				'<div class="pad0 col-md-8 col-sm-8 col-xs-8">'+
				'<label>Select Assigne </label>'+
				'</div>'+
				'<div class="pad0 col-md-4 col-sm-4 col-xs-4">'+
				'<div class="clearfix tips text-right">'+
				'<a><span onclick="assignToTeamAdmin(\''+milestone+'\',\''+assignkeyid+'\',\''+leaderUid+'\',\''+AssigndateId+'\',\''+assignThisTaskId+'\',\''+assignTaskIconId+'\')">Take it</span></a>'+
				'</div>'+
				'</div>'+
				'</div>'+
				'<div class="relative_box"> '+
				'<select name="selectteam" id="'+SelectTeam+'" class="form-control" onchange="setTeamMember(this.value,\''+Select_Assignee+'\')">'+
				'</select>'+
				'</div>'+
				'<div id="selectassigneeEerorMSGdiv" class="errormsg"></div>'+
				'</div> '+
				'<div class="form-group">'+
				'<div class="clearfix">'+
				'<div class="relative_box"> '+
				'<select name="selectassignee" id="'+Select_Assignee+'" class="form-control">'+
				...
				'<div class="input-group">'+
				'<span class="input-group-addon"><i class="form-icon fa fa-calendar"></i></span> '+
				'<input type="text" autocomplete="off" name="'+AssigndateId+'" onclick="openCalendar(\''+AssigndateId+'\')" id="'+AssigndateId+'" value="'+memberassigndate+'" placeholder="DD-MM-YYYY" class="searchdate form-control pointers" readonly="readonly"/>'+
				'</div>'+
				'<div id="dateEerorMSGdiv" class="errormsg"></div>'+
				'</div>'+
				'<div class="clearfix mtop10 mb10 text-right">'+
				'<button class="bt-link bt-radius bt-gray cancelBtn" type="button" onclick="hideAssignBox(\''+assignThisTaskId+'\')">Cancel</button>'+
				'<button class="bt-link bt-radius bt-loadmore" type="button" onclick="assignThisToMember(\''+assignkeyid+'\',\''+SelectTeam+'\',\''+Select_Assignee+'\',\''+AssigndateId+'\',\''+milestone+'\',\''+assignThisTaskId+'\',\''+assignTaskIconId+'\')">Save</button>'+
				'</div>'+
				'</div>'+
				'</div>'
				).insertBefore("#MilestoneListBoxId");		 
				setAllTeam(SelectTeam,Select_Assignee,memberid,childTeamKey);
				$(function(){$(".searchdate").datepicker({changeMonth:true,changeYear:true,dateFormat:'yy-mm-dd'});});
				$("#DocumentUploadTask").append("<option value='"+assignkey+"#"+workStartedPercentage+"'>"+name+"</option>")
...
// 				if(Number(data[1].length)==4)data[1]="0"+data[1];
				...
				$(''+
						'<span class="bg_circle removeDelvDate"><span class="pointers"><input id="SetDeliveryDateId" onchange="dateExtendRecord(\''+deliveryDate+'T'+data[1]+'\')" type="datetime-local" value="'+deliveryDate+'T'+data[1]+'" min="'+deliveryDate+'T'+data[1]+'"></span></span>'
...
function saveWorkPercentage(assignKey,workPercentageId,salesmilestonekey){
	...
	if(workPercentage==null||workPercentage==""||Number(workPercentage)<0||Number(workPercentage)>100){
		document.getElementById('errorMsg').innerHTML ="Work Percentage between 0-100 !!.";
		$('.alert-show').show().delay(2000).fadeOut();
		return false;
	}	
...
function assignToTeamAdmin(milestoneId,assignkeyid,leaderUid,AssigndateId,FormBoxId,AssignTaskIconId){
	var milestoneName=$("#"+milestoneId).val();
	var assignKey=$("#"+assignkeyid).val();
	var teamRefKey="<%=teamKey%>";
	var memberId=leaderUid;
	var assignDate=$("#"+AssigndateId).val();
	var assignedTeamKey="<%=teamKey%>";
	var salesKey="<%=salesrefid%>";
	
	if(milestoneName==null||milestoneName==""){
		document.getElementById('errorMsg').innerHTML ="Please enter milestone name !!.";
		$('.alert-show').show().delay(2000).fadeOut();
		return false;
	}
	if(assignDate==null||assignDate==""){
		document.getElementById('errorMsg').innerHTML ="Please choose assign date !!.";
		$('.alert-show').show().delay(2000).fadeOut();
		return false;
	}
	//assign this milestone to selected tem's member
	showLoader();
	$.ajax({
		type : "POST",
		url : "AssignThisToAssignee111",
		dataType : "HTML",
		data : {				
			assignKey : assignKey,
			milestoneName : milestoneName,
			teamRefKey : teamRefKey,
			memberId : memberId,
			assignDate : assignDate,
			assignedTeamKey : assignedTeamKey,
			salesKey : salesKey
		},
		success : function(data){
			if(data=="pass"){	
				$("#"+FormBoxId).hide();
				$("#"+AssignTaskIconId).attr("src","<%=request.getContextPath() %>/staticresources/images/assigned.png");
				$("#ReloadTaskThread").load(location.href + " #ReloadTaskThread1");
				fillAdminAssignedTask();
				hideLoader();
			}else if(data=="exist"){
				document.getElementById('errorMsg').innerHTML =milestoneName +' already assigned to this assignee !!';
				$('.alert-show').show().delay(4000).fadeOut();
			}else{
...
function assignThisToMember(assignkeyid,SelectTeam,Select_Assignee,
		AssigndateId,milestoneId,FormBoxId,AssignTaskIconId){
	var milestoneName=$("#"+milestoneId).val();
	var assignKey=$("#"+assignkeyid).val();
	var teamRefKey=$("#"+SelectTeam).val();
	var memberId=$("#"+Select_Assignee).val();
	var assignDate=$("#"+AssigndateId).val();
	var assignedTeamKey="<%=teamKey%>";
	var salesKey="<%=salesrefid%>";
	...
	if(teamRefKey==null||teamRefKey==""){
		document.getElementById('errorMsg').innerHTML ="Please select team !!.";
		$('.alert-show').show().delay(2000).fadeOut();
		return false;
	}
	if(memberId==null||memberId==""){
		document.getElementById('errorMsg').innerHTML ="Please select Assignee !!.";
		$('.alert-show').show().delay(2000).fadeOut();
		return false;
	}
	if(assignDate==null||assignDate==""){
...
<script type="text/javascript">
/* $( document ).ready(function() {
	var fbSetEditor = document.getElementById('Filledbuild-wrap');
	var formSetBuilder = $(fbSetEditor).formBuilder();
	document.getElementById('setData').addEventListener('click', function() {
		...
		$.ajax({
			...
			success : function(response){
				...
				var formData=response[0]["formData"];
				alert(formData);
				formSetBuilder.actions.setData(formData);
			    $("#FilledDynamicFormData").modal("show");			
			}}
		});	    
		}, 200);
	});
...
$('#UpdateContactcomAddress').on( "click", function(e) {
	...
	function setAllTeam(TeamId,Select_Assignee,memberid,childTeamKey){
		$.ajax({
		    type: "POST",
		    dataType: "html",
		    url: "<%=request.getContextPath()%>/GetAllTeamList111",
		    data:  {  },
		    success: function (response) {
		    	if(Object.keys(response).length!=0){
		     	response = JSON.parse(response);			     			     		
				 ...
				 if(Number(len)>0){
					...
					for( var i =0; i<len; i++){		
						...
						$("#"+TeamId).append("<option value='"+refid+"'>"+name+"</option>");
						
					}
					if(childTeamKey!=null&&childTeamKey!="NA"&&childTeamKey!=""){
						$("#"+TeamId).val(childTeamKey);
						setTeamMember(childTeamKey,Select_Assignee,memberid);
					}else{
						$("#"+TeamId).val(teamRefKey);
						setTeamMember(teamRefKey,Select_Assignee,memberid);
					}
		    	}
		    	}
		    },
		    error: function (error) {
		    	alert("error in setAllTeam() " + error.responseText);
		    }
		});		
	}
	
	function setTeamMember(teamrefid,Select_Assignee,memberid){	
// 		console.log(teamrefid+"#"+Select_Assignee);
		if(teamrefid!=""){			
		$.ajax({
		    type: "POST",
		    dataType: "html",
			...
			response = JSON.parse(response);			
			 ...
			 if(len>0){
				 for(var i=0;i<Number(len);i++){	
					...
					'<div class="pad0 col-md-4 col-sm-4 col-xs-4">'+
					'<div class="clearfix tips text-right">'+
					'<a><span onclick="assignToTeamAdmin(\''+milestone+'\',\''+assignkeyid+'\',\''+leaderUid+'\',\''+AssigndateId+'\',,\''+assignTaskIconId+'\')">Take it</span></a>'+
					'</div>'+
					'</div>'+
					'</div>'+
					'<div class="relative_box"> '+
					...
					'<div class="input-group">'+
					'<span class="input-group-addon"><i class="form-icon fa fa-calendar"></i></span> '+
					'<input type="text" autocomplete="off" onclick="openCalendar(\''+AssigndateId+'\')" name="'+AssigndateId+'" id="'+AssigndateId+'" value="'+memberassigndate+'" placeholder="DD-MM-YYYY" class="searchdate form-control pointers" readonly="readonly"/>'+
					'</div>'+
					'<div id="dateEerorMSGdiv" class="errormsg"></div>'+
					'</div>'+
					'<div class="clearfix mtop10 mb10 text-right">'+
	...
	function hideAssigneName(SelectAssigneeId,SearchAssigneeId,AssigneeBoxId,SearchAssigneName){
		$("#SearchAssigneName").val('');
		searchMilestone("NA");
		$("#"+AssigneeBoxId).addClass("normal_txt");
		$("#"+AssigneeBoxId).removeClass("searchBox");		
		$("#"+SearchAssigneeId).hide();
		$("#"+SelectAssigneeId).show();
		$("#TimesIconId").hide();
		$("#SearchIconId").show();		
	}
	
	function searchAssigneName(SelectAssigneeId,SearchAssigneeId,AssigneeBoxId,SearchAssigneName){
		$("#"+AssigneeBoxId).addClass("searchBox");
		$("#"+AssigneeBoxId).removeClass("normal_txt");
		$("#"+SelectAssigneeId).hide();
		$("#"+SearchAssigneeId).show();
		$("#"+SearchAssigneName).focus(); 
		$("#SearchIconId").hide();
		$("#TimesIconId").show();
	}	
		...
		$.ajax({
			...
			success : function(data){
				if(data=="pass"){	
					...
					if(UploadBy=="Agent")					
						$("#DocumentListBox").load(location.href + " #DocumentListBox1");
					if(UploadBy=="Client")					
						$("#DocumentListBox2").load(location.href + " #DocumentListBox3");
				}else{
					document.getElementById('errorMsg').innerHTML = 'Something went wrong , Try Sometime later !!';
					$('.alert-show').show().delay(4000).fadeOut();
				}
...
$(function() {
	$("#AddHSN_Code").autocomplete({
		source : function(request, response) {
			if(document.getElementById("AddHSN_Code").value.trim().length>=1){
				showLoader();
			$.ajax({
...
function openMilestoneBox(){
	$(".milestoneSidClass").remove();
	fillMilestones();
	var id = $(".showmilestone").attr('data-related'); 
	$('.fixed_right_box').addClass('active');
	    $("div.add_inner_box").each(function(){
	        $(this).hide();
	        if($(this).attr('id') == id) {
...
function openToolTipBox(task,salesmilestonekey){
	$("#TaskMilestoneName").html(task);
	setToolTipText(salesmilestonekey);
	...
	$.ajax({
        ...
        success : function(msg) {
        	...
        	if(data[0]=="pass"){
        		...
        		$("#MilestoneAssignDate").val(mAssignDate);
...
<script type="text/javascript">
$( document ).ready(function() {
	var openChat="<%=dashboardCommunication%>";
	if(openChat!="NA"){
		setTimeout(function(){
			$("#OpenChatByClickId").click();
			clearSession('dashboardCommunication');
		},1000);
	}
});
...
function uploadDocModal(i,docKey,sn){
	$("#IndexNumber").val(i);
	$("#DocumentKey").val(docKey);
	$("#DocumentIdChange").val(sn);
	$("#UploadNewDocument").modal("show");
}
function validateUploadDocument(){
	var task=$("#DocumentUploadTask").val(); 
	var docFile=$("#NewDocumentFile").val();
	var i=$("#IndexNumber").val();
	var dockey=$("#DocumentKey").val();
	var docId=$("#DocumentIdChange").val();
	if(task==""){
		document.getElementById('errorMsg').innerHTML ="Task is required !!";
		$('.alert-show').show().delay(3000).fadeOut();
		return false;
	}
	if(docFile==""){
		document.getElementById('errorMsg').innerHTML ="Choose file to upload !!";
		$('.alert-show').show().delay(3000).fadeOut();
		return false;
	}
	$("#UploadNewDocument").modal("hide");
	var x=task.split("#");
	if(Number(docId)==1)
		uploadFile("upload-box","MainDownloadIcon1"+i,"AppendDocDownload1"+i,dockey,"NewDocumentFile","DocumentListDateId1"+i,x[0],x[1]);
	else
		uploadFile("upload-box","MainDownloadIcon"+i,"AppendDocDownload"+i,dockey,"NewDocumentFile","DocumentListDateId"+i,x[0],x[1]);
}
...
$(document).ready(function () {
    $('.mobileactivity .filterBox_title').click(function (e) {
        $('.mobiledropdown ').stop(true).slideToggle();
    });
    $(document).click(function (e) {
        if (!$(e.target).closest('.filterBox_title, .mobiledropdown ').length) {
            $('.mobiledropdown ').stop(true).slideUp();
        }
    });
});
