		...
		<div class="main-content">
			<div class="container">
              <div class="row mb10">
               ...
               <label>Product ID :</label><output name="enquid" id="enquid" class="" title="<%=prodNo%>"><%=prodNo%></output>
               </div>
                               ...
                               <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                   <div class="clearfix">
                                    ...
                                    <input type="text" placeholder="Fill Product name" id="Product_Name" name="product_name" class="form-control pointers">
	...
	<!-- 	price  start-->
								...
								<div class="row">
								 ...
								 <div class="mb10 flex_box align_center relative_box">
									...
									<input type="checkbox" name="globalType" id="Global" value="1" <%if(global.equals("1")){ %> checked="checked"<%} %>>
									<span>Global</span>
									</span>
									<span class="mlft10 input_radio bg_wht pad_box2 pad_box3"> 
									<input type="checkbox" name="centralType" id="Central" value="1" <%if(central.equals("1")){ %> checked="checked"<%} %>>
									<span>Central</span>
									</span>
									<span class="mlft10 input_radio bg_wht pad_box2 pad_box3">
									<input type="checkbox" name="stateType" id="State" value="1" <%if(state.equals("1")){ %> checked="checked"<%} %>>
									<span>State</span>
									</span>									
									</div>								 
								 <div class="clearfix  clerrow link-style12">
								<div class="clearfix" id="AppendEditProductPrice"></div>
...
<!-- 	milestone  start-->
							<div class="clearfix" id="ProductMilestoneDivSpace" style="display: none;">	
								...
								<div class="col-md-2 col-sm-3 col-xs-12">                                                                   
                                 ...
                                 <input type="text" name="addtimelineunit" autocomplete="off" id="MainTimelineUnit" class="form-control bdrnone pointers" readonly="readonly" style="width: 51%;position: absolute;top: 0px;right: 10px;">
...
<!-- 	document  end-->	
								...
								<div class="row">
                                 ...
                                 <div class="row"> 
                                  ...
                                  <button class="bt-link bt-radius bt-loadmore" type="submit" onclick="return validateProduct();">Update</button>
                                  </div>
                               </div>
                             </div>
                             </div>
...
$(function() {
	$("#"+BoxId).autocomplete({
		source : function(request, response) {
			if(document.getElementById(BoxId).value.trim().length>=2)
			$.ajax({
...
$(function() {
 ...
 $(function() {
	$("#NewProductType").autocomplete({
		source : function(request, response) {
			if(document.getElementById('NewProductType').value.trim().length>=2)
			$.ajax({
				url : "<%=request.getContextPath()%>/getnewproduct.html",
				type : "POST",
				dataType : "JSON",
...
$(document).ready(function(){
	...
	$.ajax({
		...
		success : function(response){
			...
			var len=response.length;	
			for(var j=0;j<len;j++){				
			    var pid=response[j]['pid'];
			    var name=response[j]['name'];
			    var value=response[j]['value'];
			    var ptype=response[j]['ptype'];
			    var pdesc=response[j]['pdesc'];
			    var prefid=response[j]['prefid'];	
			    var tatValue=response[j]['tatValue'];
			    var tatType=response[j]['tatType'];
			    
            	$("#Product_Name").val(value);
            	$("#SubProductType").val(ptype);
            	$("#SubProductName").val(value);
            	$("#productregrefid").val(prefid);
            	$("#Product_Remarks").val(pdesc);
            	$("#Product_Price").val(value+" - Price");
            	$("#Product_Milestone").val(value+" - Milestone");
            	$("#Product_Documents").val(value+" - Document");
            	$("#MainSubDivCont").css("display",'block');
            	$("#ProductPriceDivSpace").css("display",'block');
            	$("#ProductMilestoneDivSpace").css("display",'block');
            	$("#ProductDocumentDivSpace").css("display",'block');
...
//             	$("#MainProductCloseBtn").css("display",'block');         	
            	...
            	$("#Product_TAT").val(tatValue);
            	$("#tatType").val(tatType);
            	
            	fillProductPrice(prefid);
            	fillProductMilestone(prefid);
            	fillProductDocuments(prefid);
			}
		}}
	});
});
		...
		success : function(response){
			...
			for(var j=0;j<len;j++){
				...
				if(Number(j)==0){     
					...
					var documentVisibility="documentVisibility"+j;
					$(''+
					 '<div class="clearfix  clerrow link-style12" id="'+DocumentDivId+'">'+
					 '<div class="row" id="'+DocumentRow+'">'+
					 '<div class="col-md-4 col-sm-4 col-xs-12">'+                             
		...
		success : function(response){
			...
			for(var j=0;j<len;j++){
				...
				if(Number(j)==0){   
					...
					$("#MilestoneInputDiv4").attr('onClick', "addMainInput('TimelineBox','MainTimelineUnit','Minute','MainTimelineValue','pm_timelineunit',"+id+")");
					$("#MilestoneInputDiv5").attr('onClick', "addMainInput('TimelineBox','MainTimelineUnit','Hour','MainTimelineValue','pm_timelineunit',"+id+")");
		...
		success : function(response){
			...
			for(var j=0;j<Number(len);j++){
				...
				if(service=="Professional fees"||service=="Government fees"||service=="Service charges"||service=="Other fees"){   
					...
					var AddServiceName="AddService"+j+"Name";
					var AddProductPrice="AddProduct"+j+"Price";
					var SmallBtnEdit="SmallBtn"+j+"Edit";
					var SmallBtnPlus="SmallBtn"+j+"Plus";
					var HSNCode="HSN"+j+"Code";
					var AppliedTax="Applied"+j+"Tax";
					var PriceRow="Price"+j+"Row"
					var ProductTotalPrice="Product"+j+"TotalPrice"
					
					$(''+
					'<div class="row" id="'+PriceRow+'">'+
					 '<div class="col-md-3 col-sm-3 col-xs-12">'+
                     '<input type="text" name="'+AddServiceName+'" value="'+service+'" autocomplete="off" id="'+AddServiceName+'" class="form-control bdrnone" placeholder="Add Service" readonly="readonly">'+
                    '</div>'+
					'<div class="col-md-2 col-sm-2 col-xs-12">'+
                     '<input type="text" name="'+AddProductPrice+'" autocomplete="off" id="'+AddProductPrice+'" onchange="updateMainPriceList(\''+AddProductPrice+'\',\'pp_price\',\''+id+'\',\''+ProductTotalPrice+'\');"  class="form-control bdrnone" value="'+price+'" placeholder="Price" onkeypress="return isNumberKey(event)">'+
                    '</div>'+
                   '<div class="col-md-2 col-sm-2 col-xs-12"> '+
                   '<div class="clearfix relative_box" onmouseover="showOptions(\''+SmallBtnEdit+'\',\''+SmallBtnPlus+'\')" onmouseout="hideOptions(\''+SmallBtnEdit+'\',\''+SmallBtnPlus+'\')">'+
                    '<div class="fa fa-pencil smallBtnEdit pointers" id="'+SmallBtnEdit+'" title="Edit" onclick="setMainDivId(\''+HSNCode+'\',\''+AppliedTax+'\',\''+id+'\')"></div>'+
						 '<div class="fa fa-plus-circle smallBtnPlus pointers" data-toggle="modal" data-target="#TaxModal" id="'+SmallBtnPlus+'" title="Add" onclick="setMainActions(\''+HSNCode+'\',\''+AppliedTax+'\',\''+id+'\')"></div>'+
                  ' <input type="text" id="'+HSNCode+'" onkeypress="searchHSNCode(\''+HSNCode+'\',\''+AppliedTax+'\')" onchange="updateMainPriceList(\''+HSNCode+'\',\'pp_hsncode\',\''+id+'\',\'NA\');" value="'+hsn+'" class="form-control bdrnone" autocomplete="off" placeholder="HSN for tax">'+
                   '</div>'+
                   '</div>'+
                   '<div class="col-md-2 col-sm-2 col-xs-12">'+
                     '<input type="text" name="'+AppliedTax+'" autocomplete="off"  id="'+AppliedTax+'" value="'+tax+'" class="form-control bdrnone" placeholder="Tax" readonly="readonly">'+
                    '</div>'+
                   '<div class="col-md-3 col-sm-2 col-xs-12">'+
                     '<input type="text" name="'+ProductTotalPrice+'" autocomplete="off" id="'+ProductTotalPrice+'" class="form-control bdrnone" value="'+total+'" placeholder="Total Price" onkeypress="return isNumberKey(event)" readonly="readonly">'+
                    '</div>'+
                    
                   '</div>').insertBefore("#AppendEditProductPrice");
...
function addEditNewPrice(){
	...
	'<div class="row" id="Price2Row">'+
	 '<div class="col-md-3 col-sm-3 col-xs-12">'+                               
      '<input type="text" name="addservice2name" value="Service charges" autocomplete="off" id="AddService2Name" class="form-control bdrnone" placeholder="Add Service">'+
    ' </div>'+
	'<div class="col-md-2 col-sm-2 col-xs-12">'+                                                                   
	...
	'<div class="row" id="Price3Row">'+
	 '<div class="col-md-3 col-sm-3 col-xs-12">'+                               
      '<input type="text" name="addservice3name" value="Other fees" autocomplete="off" id="AddService3Name" class="form-control bdrnone" placeholder="Add Service">'+
     '</div>'+
	'<div class="col-md-2 col-sm-2 col-xs-12">'+                                                                   
...
function validateProduct(){ 
	...
	if($("#AddService0Name").val().trim()==""||$("#AddService1Name").val().trim()==""){
	...
	if(document.getElementById("AddProduct0Price").value.trim()==""||document.getElementById("AddProduct0Price").value.trim()=="0"){
		document.getElementById('errorMsg').innerHTML ="Please add professional fee.";
		$('.alert-show').show().delay(4000).fadeOut();
		return false;
	} 
 	if(document.getElementById("Product_TAT").value.trim()==""){
		document.getElementById('errorMsg').innerHTML ="Please enter product TAT value.";
		$('.alert-show').show().delay(4000).fadeOut();
		return false;
	}
	if(document.getElementById("tatType").value.trim()==""){
		document.getElementById('errorMsg').innerHTML ="Please select TAT type.";
		$('.alert-show').show().delay(4000).fadeOut();
		return false;
	}
...
// $('.show_psww').click(function(event){
