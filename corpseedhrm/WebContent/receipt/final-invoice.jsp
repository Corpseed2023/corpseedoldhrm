...
<p style="font-weight:600;" id="EstimateBillNo"># <%=invoiceDetails[0][1]%></p>
...
<p style="font-weight: 600;margin-bottom: 1rem;"><%=invoiceDetails[0][14] %></p>
<%if(invoiceDetails[0][15]!=null&&!invoiceDetails[0][15].equalsIgnoreCase("NA")){ %>
<p style="margin-top: -1rem;">PAN <%=invoiceDetails[0][15] %></p><%} %>
<%}else if(invoiceDetails[0][13].equals("Business")){%>
<p style="margin:0px;">Bill To : </p>
<p style="font-weight: 600;margin-bottom: 1rem;"><%=invoiceDetails[0][3] %></p>
<%if(invoiceDetails[0][4]!=null&&!invoiceDetails[0][4].equalsIgnoreCase("NA")){ %>
<p style="margin-top: -1rem;">GSTIN <%=invoiceDetails[0][4] %></p><%} %>
<%} %>
</div>
<div class="clear"></div>
...
<span><%=invoiceDetails[0][14] %></span><br>
<span><%=invoiceDetails[0][18] %>, <%=invoiceDetails[0][19] %></span></p>
<p>Place Of Supply: <span><%=invoiceDetails[0][16] %>, <%=invoiceDetails[0][17] %><%if(invoiceDetails[0][20]!=null&&!invoiceDetails[0][20].equalsIgnoreCase("NA")){%> (<%=invoiceDetails[0][20] %>)<%} %></span></p>
<%}else if(invoiceDetails[0][13].equals("Business")){ %>
<p style="margin-bottom:5px;">Ship To : <br>
<span><%=invoiceDetails[0][3] %></span><br>
<span><%=invoiceDetails[0][10] %>, <%=invoiceDetails[0][5] %></span></p>
<p>Place Of Supply: <span><%=invoiceDetails[0][8] %>, <%=invoiceDetails[0][9] %><%if(invoiceDetails[0][11]!=null&&!invoiceDetails[0][11].equalsIgnoreCase("NA")){%> (<%=invoiceDetails[0][11] %>)<%} %></span></p>
<%} %>
</div>
<div style="width:50%;text-align:right;">
<p><span style="font-weight:600;color:#888;">Date :</span> <span style="padding-left:20px;" id="EstimateDate"><%=invoiceDetails[0][2]%></span></p>
</div>
</div>
<div class="clear"></div>
...
<div style="width:97%;">
<p style="margin: 0; font-size: 11px;">&nbsp;<%=invoiceDetails[0][6] %> </p>
</div>
</div>
<%
double totalRate=0;
...
<div style="width:13%;" class="hsn"><p style="margin:0;text-align: right;"><%=paymentDetails[j][1] %></p></div>
...
<div class="clearfix total_web" style="font-weight: 600;border-top: 1px dotted black;border-bottom: 1px dotted black;padding: 5px 0px 5px 0px;display: flex;">
	...
	<p style="margin:0;font-size: 11px;">Total Qty. : &nbsp;<span><%=invoiceDetails[0][22] %></span></p></div>
