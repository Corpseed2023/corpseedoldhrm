...
<%if(!SAL03){%><jsp:forward page="/login.html" /><%} %>
<div id="content">
    <div class="container">   
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="menuDv post-slider clearfix">
                        <form action="<%=request.getContextPath() %>/update-salary-structure.html" method="post" name="registerEmployee" id="registerEmployee">
                        ...
                        <input type="hidden" name="emid" id="emid" readonly value="<%=salStr[0][21]%>">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="form-group">
                              ...
                              <input type="text" name="EmployeeDesignation" id="emdesig" readonly class="form-control" value="<%=salStr[0][20]%>">
                               </div>
                             </div>
                            </div>
                            </div>
                          ...
                          <div class="row">
                            ...
                            <button class="bt-link bt-radius bt-loadmore" type="submit" onclick="return validateSalaryStructure();">Update<i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                            </div>
                          </div>
                        </form>
                    </div>
