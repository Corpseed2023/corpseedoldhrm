...
public class Enquiry_ACT {
	...
	public static int getTotalEstimateQty(String salesno,String token) {
		...
		try{
			getacces_con=DbCon.getCon("","","");				 
			 ps=getacces_con.prepareStatement("select count(esid) from estimatesalectrl where estoken='"+token+"' and essaleno='"+salesno+"' group by esrefid");
			rs=ps.executeQuery();
			if(rs.next())newsdata=rs.getInt(1);
		}catch(Exception e)
		{
	...
	public static long findConsultingPercentage(String salesKey,String token,String today) {
		...
		try{
			getacces_con=DbCon.getCon("","","");				 
			 ps=getacces_con.prepareStatement("select renewal_value,renewal_type,renewal_end_date,str_to_date(post_date,'%d-%m-%Y') from consulting_sale where sales_key='"+salesKey+"' and token='"+token+"'");
			rs=ps.executeQuery();
			if(rs.next()) {
...
//				System.out.println(renewal_value+"#"+renewal_type+"#"+renewal_end_date+"#"+postDate);
				if(renewal_end_date==null||renewal_end_date.equalsIgnoreCase("NA"))newsdata=0;
				else {
...
//					System.out.println("daysBetweenTwoDates="+daysBetweenTwoDates);
					if(daysBetweenTwoDates<0)newsdata=100;
					else {
	...
	public static long getTotalSalesQty(String role,String uaid,String teamKey,String token) {
		...
		try{
			...
			if(role.equals("Admin")||role.equals("Manager"))
				...
				query="select count(msid) from managesalesctrl where mstoken='"+token+"' and exists(select tmid from manageteammemberctrl where tmteamrefid='"+teamKey+"' and tmuseruid=mssoldbyuid) or mssoldbyuid='"+uaid+"'";
			}else {
...
//			System.out.println(query);
			...
			rs=ps.executeQuery();
			if(rs.next())newsdata=rs.getLong(1);
		}catch(Exception e)
		{
	...
	public static long getTotalEstimateQty(String role,String uaid,String teamKey,String token) {
		...
		try{
			...
			if(role.equals("Admin")||role.equals("Manager"))
				...
				query="select count(esid) from estimatesalectrl where estoken='"+token+"' and exists(select tmid from manageteammemberctrl where tmteamrefid='"+teamKey+"' and tmuseruid=essoldbyid) or essoldbyid='"+uaid+"'";
			}else {
...
//			System.out.println(query);
	...
	public static boolean updateDocumentName(String docrefid,String imgname,String loginuid,
			String date,String token,String assignKey,String workStartPrice){
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
			...
			ps = con.prepareStatement(query);	
			ps.setString(1, imgname);ps.setString(2, loginuid);ps.setString(3, date);
			ps.setString(4, assignKey);ps.setString(5, workStartPrice);ps.setString(6, docrefid);
	...
	public static boolean updateEstimateToInvoiced(String invoiceno,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE estimatesalectrl SET esstatus='Invoiced' WHERE essaleno='"+invoiceno+"' and estoken='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateBillingInvoice(String invoice,String estinvoice,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbinvoiceno='"+invoice+"',cbinvoice_status='3' WHERE cbestimateno='"+estinvoice+"' and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateHoldBillingDeclineAmount(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbholdamount=cbholdamount-"+amount+",cbholdnotification=cbholdnotification-"+1+" WHERE (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			ps.executeUpdate();
			status = true;
		} catch (Exception e) {
	...
	public static boolean updateBillingDeclineAmount(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbtransactionamount=cbtransactionamount-"+amount+",cdnotificationcount=cdnotificationcount-"+1+" WHERE (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			ps.executeUpdate();
			status = true;
		} catch (Exception e) {
	...
	public static boolean updateBillingHoldAmount(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbtransactionamount=cbtransactionamount-"+amount+",cbholdamount=cbholdamount+"+amount+",cdnotificationcount=cdnotificationcount-"+1+",cbholdnotification=cbholdnotification+"+1+" WHERE (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
//			System.out.println(query);
			ps = con.prepareStatement(query);						
			ps.executeUpdate();
			status = true;
	...
	public static boolean updateBillingRegisterAmount(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbpaidamount=cbpaidamount+"+amount+",cbdueamount=cbdueamount-"+amount+" WHERE cbinvoiceno='"+invoiceno+"' and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateClientKeyInBilling(String invoiceno,String clientrefkey,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbclientrefid='"+clientrefkey+"' WHERE (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateHoldBillingAmount(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbholdamount=cbholdamount-"+amount+",cbpaidamount=cbpaidamount+"+amount+",cbdueamount=cbdueamount-"+amount+",cbholdnotification=cbholdnotification-"+1+" WHERE cbdueamount>0 and (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateHoldBillingAmountPo(String invoiceno,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbholdnotification=cbholdnotification-"+1+" WHERE (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateInvoiceTaxAmount(int invoiceId,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE manage_invoice SET due_amount=due_amount-"+amount+" WHERE id='"+invoiceId+"' and token='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateBillingAmount(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbtransactionamount=cbtransactionamount-"+amount+",cbpaidamount=cbpaidamount+"+amount+",cbdueamount=cbdueamount-"+amount+",cdnotificationcount=cdnotificationcount-"+1+" WHERE cbdueamount>0 and (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateBillingAmountPo(String invoiceno,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cdnotificationcount=cdnotificationcount-"+1+" WHERE (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
	...
	public static boolean updateConsultingBillingAmount(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cborderamount=cborderamount+"+amount+",cbdueamount=cbdueamount+"+amount+" WHERE cbinvoiceno='"+invoiceno+"' and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			int k=ps.executeUpdate();
			if(k>0)status = true;
	...
	public static boolean updateBillingDetails(String invoiceno,double amount,String token){
		...
		boolean status = false;
		try {
			String query = "UPDATE hrmclient_billing SET cbtransactionamount=cbtransactionamount+"+amount+" WHERE (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(query);						
			ps.executeUpdate();
			status = true;
		} catch (Exception e) {
	...
	public static boolean updateContactDetails(String salesid,String contactid,String colname,String colvalue,String token){
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
			String query = "UPDATE salescontactboxvirtual SET "+colname+"=? WHERE scvcontactboxid=? and scvtokenno=? and scvsalesid=?";
			ps = con.prepareStatement(query);
	...
	public static boolean EditEnquiry(String enquid, String enqType,String company,String industry,String enqName,String enqMob,String enqEmail, String country, String state,
			String city, String enqStatus, String enqAdd, String enqRemarks,String altermob,String addedby,String token,String productType,String product_name) {
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
	...
	public static String[][] findSalesUserPermission(String uaid,String token) {
		...
		try {
			String queryselect = "SELECT m.msid,m.msrefid,m.msprojectnumber,m.msinvoiceno,m.msproductname,"
					+ "m.mssolddate FROM managesalesctrl m join user_sales_info u on m.msid=u.sales_id where u.user_id='"+uaid+"'"
							+ " and u.token='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
...
//			System.out.println(queryselect);
	...
	public static String[][] getEstimateSaleData(String estimateKey,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT essaleno,escontactrefid,esclientrefid,esprodtype,esprodname FROM estimatesalectrl where esrefid ='"+estimateKey+"' and estoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getApproveTask(String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT marefid,masalesrefid,mamilestonerefid,mamilestonename,mamemberassigndate,maassignedbyuid,mateammemberid,machildteamrefid,maapprovalstatus FROM manage_assignctrl where maapprovalstatus!='1' and matokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getSalesCreditHistory(String token,String dateRange,int page,int rows,String sort,String order) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
		ResultSet rsGCD = null;
		String[][] newsdata = null;
		...
		try {
			...
			StringBuffer queryselect =new StringBuffer("SELECT swkey,swsaleskey,swprojectno,swinvoiceno,swprojectname,swcreditdate,swdepositamt,swremarks FROM salesworkpricectrl where swtokenno='"+token+"'");
			...
			if(sort.length()<=0)			
				...
				else if(sort.equals("date"))queryselect.append("order by swaddedon "+order+" limit "+((page-1)*rows)+","+rows);
				else if(sort.equals("invoice"))queryselect.append("order by swinvoiceno "+order+" limit "+((page-1)*rows)+","+rows);
				else if(sort.equals("product"))queryselect.append("order by swprojectname "+order+" limit "+((page-1)*rows)+","+rows);
				else if(sort.equals("description"))queryselect.append("order by swremarks "+order+" limit "+((page-1)*rows)+","+rows);	
				else if(sort.equals("amount"))queryselect.append("order by swdepositamt "+order+" limit "+((page-1)*rows)+","+rows);
//			System.out.println(queryselect);
	...
	public static int countSalesCreditHistory(String token,String dateRange) {
		...
		try {
			...
			StringBuffer queryselect =new StringBuffer("SELECT count(swid) FROM salesworkpricectrl where swtokenno='"+token+"'");
			if (!fromDate.equalsIgnoreCase("NA") && !toDate.equalsIgnoreCase("NA")) {
				queryselect.append(" and str_to_date(swaddedon,'%Y-%m-%d')<='" + toDate
						+ "' and str_to_date(swaddedon,'%Y-%m-%d')>='" + fromDate + "'");
			}		
//			System.out.println(queryselect);
	...
	public static String[][] getSalesByRefId(String srefid,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT msrefid,msclientrefid,mscontactrefid,msinvoiceno,msestimateno,mscompany,msproducttype,msproductname,msproductplan,msplanperiod,msplantime,mssoldbyuid,mssolddate,msworkstatus,msassignedtorefid,msworkpriority,msprojectnumber FROM managesalesctrl where msstatus='1' and mstoken='"+token+"' and msrefid='"+srefid+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getAllDeliveryManager(String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT uaid,uaname FROM user_account where uadepartment='Delivery' and uarole='Manager' and uastatus='1' and uavalidtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getAllTeams(String token,String loginUaid,String userRole) {
		...
		String[][] newsdata = null;
		try {
			StringBuffer queryselect = new StringBuffer("SELECT mtid,mtrefid,mtteamname FROM manageteamctrl where mtstatus='1' and mtdepartment='Delivery'");
...
//			System.out.println(queryselect);
	...
	public static int countAllTaskReport(String token,String projectNo,String assigneeUid) {
		...
		try{
				...
				if(!projectNo.equalsIgnoreCase("NA"))queryselect.append(" and m.msprojectnumber='"+projectNo+"' ");
				if(!assigneeUid.equalsIgnoreCase("NA"))queryselect.append(" and t.assignee_uid='"+assigneeUid+"' ");
//				System.out.println(queryselect);
			ps = con.prepareStatement(queryselect.toString());
			rsGCD = ps.executeQuery();
	...
	public static String[][] getAllTaskReport(String token,String projectNo,String assigneeUid,int page,int rows,String sort,
			String order) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
		ResultSet rsGCD = null;
		...
		try{
				...
				if(sort.length()<=0)			
					...
					else if(sort.equals("id"))queryselect.append(" order by t.id "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("project"))queryselect.append(" order by m.msproductname "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("milestone"))queryselect.append(" order by t.task_name "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("assignee"))queryselect.append(" order by t.assignee_name "+order+" limit "+((page-1)*rows)+","+rows);
...
//						System.out.println(queryselect);
	...
	public static String[][] getAllDeliverySales(String userRole,String loginuaid,String token,String deliveryDoAction,
			String deliveryInvoice,String dateRange,String clientName,String contactName,int page,int rows,String sort,
			String order) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
		ResultSet rsGCD = null;
		...
		try{
			...
			if(userRole==null||userRole.equalsIgnoreCase("NA")||userRole.length()<=0)userRole="NA";
				...
				if(!userRole.equalsIgnoreCase("NA")&&userRole.equalsIgnoreCase("Assistant")){
					queryselect.append(" and exists(select t.mtid from manageteamctrl t where ms.msassignedtorefid=t.mtrefid and t.mtadminid='"+loginuaid+"' and t.mttoken='"+token+"') ");
				}
				...
				if(!deliveryInvoice.equalsIgnoreCase("NA"))queryselect.append(" and ms.msinvoiceno='"+deliveryInvoice+"' ");
				...
				if(sort.length()<=0)			
					...
					else if(sort.equals("date"))queryselect.append("order by ms.mssolddate "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("invoice"))queryselect.append("order by ms.msinvoiceno "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("client"))queryselect.append("order by ms.mscompany "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("project"))queryselect.append("order by ms.msproductname "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("progress"))queryselect.append("order by ms.msworkpercent "+order+" limit "+((page-1)*rows)+","+rows);	
					else if(sort.equals("tags"))queryselect.append("order by ms.msworktags "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("status"))queryselect.append("order by ms.msworkstatus "+order+" limit "+((page-1)*rows)+","+rows);
					else if(sort.equals("assigned_to"))queryselect.append("order by ms.msassignedtoname "+order+" limit "+((page-1)*rows)+","+rows);	
					else if(sort.equals("priority"))queryselect.append("order by ms.msworkpriority "+order+" limit "+((page-1)*rows)+","+rows);
						System.out.println(queryselect);
			ps = con.prepareStatement(queryselect.toString());
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static int countAllDeliverySales(String userRole,String loginuaid,String token,
			String deliveryDoAction,String deliveryInvoice,String dateRange,
...
//						System.out.println(queryselect);
	...
	public static String[][] getAllCollectionSales(String token,String collectionDoAction,
			String collectionInvoice,String dateRange,String clientName,String contactName,
			int page,int rows,String sort,String order,String userRole,String loginuaid,
		...
		try{
			...
			if(!dateRange.equalsIgnoreCase("NA")){
				...
				if(!collectionUserUaid.equalsIgnoreCase("NA"))queryselect.append("and ms.document_assign_uaid='"+collectionUserUaid+"' ");
				
				if(!collectionDoAction.equalsIgnoreCase("NA")&&!collectionDoAction.equalsIgnoreCase("All")){
					if(collectionDoAction.equalsIgnoreCase("Cancelled"))queryselect.append(" and ms.mscancelstatus='1' ");
					else if(collectionDoAction.equalsIgnoreCase("Assigned"))queryselect.append(" and ms.delivery_assign_status='1' and ms.mscancelstatus='2' ");
					else if(collectionDoAction.equalsIgnoreCase("Unassigned"))queryselect.append(" and ms.delivery_assign_status='2' and ms.mscancelstatus='2' ");
					else if(collectionDoAction.equalsIgnoreCase("DocumentAssigned"))queryselect.append(" and ms.document_assign_uaid>0 ");
					else if(collectionDoAction.equalsIgnoreCase("DocumentUnassigned"))queryselect.append(" and ms.document_assign_uaid=0 ");
					else if(collectionDoAction.equalsIgnoreCase("Uploaded"))queryselect.append(" and ms.doc_uploaded='1' and ms.mscancelstatus='2' ");
					else if(collectionDoAction.equalsIgnoreCase("Unuploaded"))queryselect.append(" and ms.doc_uploaded='2' and ms.mscancelstatus='2' ");
					else if(collectionDoAction.equalsIgnoreCase("ReUpload"))queryselect.append(" and ms.doc_re_upload='1' and ms.mscancelstatus='2' ");
					else if(collectionDoAction.equalsIgnoreCase("Active"))queryselect.append(" and ms.document_status='1' and ms.mscancelstatus='2' ");
					else if(collectionDoAction.equalsIgnoreCase("Inactive"))queryselect.append(" and ms.document_status='2' and ms.mscancelstatus='2' ");
					else if(collectionDoAction.equalsIgnoreCase("Expired"))queryselect.append(" and ms.document_status='3' and ms.mscancelstatus='2' ");
//					else queryselect.append(" and ms.msworkstatus='"+collectionDoAction+"' and ms.mscancelstatus='2' ");
				}else
					queryselect.append(" and ms.mscancelstatus='2' ");
				if(!collectionInvoice.equalsIgnoreCase("NA"))queryselect.append(" and ms.msinvoiceno='"+collectionInvoice+"' ");
				if(!clientName.equalsIgnoreCase("NA"))queryselect.append(" and ms.mscompany='"+clientName+"' ");
				if(!contactName.equalsIgnoreCase("NA"))queryselect.append(" and c.cbname='"+contactName+"' ");
				if(!fromDate.equalsIgnoreCase("NA")&&!toDate.equalsIgnoreCase("NA")){
					queryselect.append(" and str_to_date(ms.mssolddate,'%d-%m-%Y')<='"+toDate+"' and str_to_date(ms.mssolddate,'%d-%m-%Y')>='"+fromDate+"' ");
				...
				else if(sort.equals("document_assign"))queryselect.append("order by ms.document_assign_name "+order+" limit "+((page-1)*rows)+","+rows);	
				else if(sort.equals("priority"))queryselect.append("order by ms.msworkpriority "+order+" limit "+((page-1)*rows)+","+rows);
...
//				System.out.println(queryselect);
	...
	public static int countAllAssignedSalesDocument(String token,String collectionDoAction,
			String collectionInvoice,String dateRange,String clientName,String contactName
	...
	public static int countAllCompletedSalesDocument(String token,String collectionDoAction,
			String collectionInvoice,String dateRange,String clientName,String contactName
			,String userRole,String loginuaid,String collectionUserUaid) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
	...
	public static int countAllExpiredSalesDocument(String token,String collectionDoAction,
			String collectionInvoice,String dateRange,String clientName,String contactName
			,String userRole,String loginuaid,String collectionUserUaid) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
	...
	public static int countAllCollectionSales(String token,String collectionDoAction,
			String collectionInvoice,String dateRange,String clientName,String contactName
			,String userRole,String loginuaid,String collectionUserUaid) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
...
//						System.out.println(queryselect);
	...
	public static int countAllSales(String userRole,String loginuaid,String token,String InvoiceNo,String PhoneKey,
		...
		try{			
			...
			StringBuffer queryselect =new StringBuffer("SELECT ms.msid FROM managesalesctrl ms INNER "
					+ "JOIN contactboxctrl c on ms.mscontactrefid=c.cbrefid where ms.msstatus='1' and "
					+ "ms.mstoken='"+token+"'");
			...
			if(salesFilter.equalsIgnoreCase("All"))
				...
				queryselect.append(" and ms.mscancelstatus='2' and exists(select h.cbuid from hrmclient_billing h where h.cbinvoiceno=ms.msinvoiceno and h.cbdueamount>0)");
	...
	public static String[][] getAllSales(String userRole,String loginuaid,String token,String InvoiceNo,String PhoneKey,
			String ProductName,String ClientName,String SoldByUid,String dateRange,String contactName,int page,int rows,
			String sort,String order,String department,String salesFilter) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
		ResultSet rsGCD = null;
		String[][] newsdata = null;
		...
		try{			
			...
			StringBuffer queryselect =new StringBuffer("SELECT ms.msrefid,ms.msclientrefid,ms.mscontactrefid,"
					...
					+ "INNER JOIN contactboxctrl c on ms.mscontactrefid=c.cbrefid where ms.msstatus='1' and ms.mstoken='"+token+"'");
			...
			if(sort.length()<=0)			
			queryselect.append("order by ms.msid desc limit "+((page-1)*rows)+","+rows);
			else if(sort.equals("date"))queryselect.append("order by str_to_date(ms.mssolddate,'%d-%m-%Y') "+order+" limit "+((page-1)*rows)+","+rows);
			else if(sort.equals("estimate"))queryselect.append("order by cast(SUBSTRING(ms.msestimateno,6) as unsigned) "+order+" limit "+((page-1)*rows)+","+rows);
			else if(sort.equals("project"))queryselect.append("order by cast(SUBSTRING(ms.msprojectnumber,6) as unsigned)"+order+" limit "+((page-1)*rows)+","+rows);
			else if(sort.equals("product"))queryselect.append("order by ms.msproductname "+order+" limit "+((page-1)*rows)+","+rows);
			else if(sort.equals("company"))queryselect.append("order by ms.mscompany "+order+" limit "+((page-1)*rows)+","+rows);	
			else if(sort.equals("progress"))queryselect.append("order by cast(ms.msworkpercent as unsigned) "+order+" limit "+((page-1)*rows)+","+rows);
...
//			System.out.println(queryselect);
	...
	public static String[][] getAllSales(String token) {
		...
		String[][] newsdata = null;
		try{			
			StringBuffer queryselect =new StringBuffer("SELECT msrefid,msinvoiceno,msworkpercent FROM managesalesctrl where msstatus='1' and mstoken='"+token+"' ");
	...
	public static String[][] getAllSales(String invoice,String token) {
		...
		String[][] newsdata = null;
		try{			
			StringBuffer queryselect =new StringBuffer("SELECT msrefid,msproductname FROM managesalesctrl where msstatus='1' and msinvoiceno='"+invoice+"' and mstoken='"+token+"'");
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect.toString());
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String getSalesKey(String invoiceNo,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT msrefid FROM managesalesctrl where (msinvoiceno ='"+invoiceNo+"' or msestimateno='"+invoiceNo+"') and mstoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
...
//			System.out.println(queryselect);
	...
	public static String getEstimateKey(String estimateNo,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT esrefid FROM estimatesalectrl where essaleno ='"+estimateNo+"' and estoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String getSalesPayType(String salesKey,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT smpaytype FROM salesmilestonectrl where smsalesrefid ='"+salesKey+"' and smtoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
...
//			System.out.println(queryselect);
	...
	public static int countHoldPayment(String token) {
		...
		int newsdata = 0;
		try {
			String queryselect = "SELECT count(sid) FROM salesestimatepayment where stransactionstatus='4' and stokenno ='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
...
//			System.out.println(queryselect);
	...
	public static String getSalesClientKey(String invoice,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT msclientrefid FROM managesalesctrl where msinvoiceno='"+invoice+"' and mstoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
...
//			System.out.println(queryselect);
	...
	public static String getClientKey(String contKey,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT ccbclientrefid FROM clientcontactbox where ccbrefid='"+contKey+"' and cctokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String getEstimateSalesSoldByUaid(String estimateNo,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT essoldbyid FROM estimatesalectrl where essaleno='"+estimateNo+"' and estoken='"+token+"' order by esid limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String getSalesSoldByUaid(String invoice,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT mssoldbyuid FROM managesalesctrl where (msinvoiceno='"+invoice+"' or msestimateno='"+invoice+"') and mstoken='"+token+"' order by msid limit 1";
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String getSalesUuidByInvoice(String invoice,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT msrefid FROM managesalesctrl where msinvoiceno='"+invoice+"' and mstoken='"+token+"' limit 1";
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String getSalesContactKeyByInvoice(String invoice,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT mscontactrefid FROM managesalesctrl where msinvoiceno='"+invoice+"' and mstoken='"+token+"' limit 1";
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String getEstimateContactKey(String estimateKey,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT escontactrefid FROM estimatesalectrl where esrefid='"+estimateKey+"' and estoken='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String getSalesContactKey(String salesKey,String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT mscontactrefid FROM managesalesctrl where msrefid='"+salesKey+"' and mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
	...
	public static String[][] getContactKey(String contactKey,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT cbcontactrefid FROM contactboxctrl where cbrefid='"+contactKey+"' and cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getEstimateProducts(String estimateno,String token) {
		...
		try {
			String queryselect = "SELECT esrefid,escompany,esprodtype,esprodqty,esprodname,esprodplan,esplanperiod,esplantime"
					...
					+ ",espurchasedate,tat_value,tat_type,sales_type FROM estimatesalectrl where essaleno='"+estimateno+"' "
							+ "and estoken='"+token+"' order by esid";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getProductMilestone(String prodrefid,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT pm_prodrefid,pm_milestonename,pm_timelinevalue,pm_timelineunit,pmsteps,pm_assign,pm_pricepercent,pmid FROM product_milestone where pm_prodrefid='"+prodrefid+"' and pm_tokeno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getSalesDocumentList(String prodrefid,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT pd_docname,pd_description,pd_uploadby,pd_visibility FROM product_documents where pd_prodrefid='"+prodrefid+"' and pd_token='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
...
//			String queryselect = "SELECT spprodrefid,sppricetype,spminpriceofone,sphsncode,spcgstpercent,spsgstpercent,spigstpercent FROM salesproductprice where spessalerefid='"+esrefid+"' and sptokenno='"+token+"'";
			String queryselect = "SELECT spprodrefid,sppricetype,spprice,sphsncode,spcgstpercent,spsgstpercent,spigstpercent FROM salesproductprice where spessalerefid='"+esrefid+"' and sptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getProductsRefid(String invoiceno,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT spprodrefid FROM salesproductprice where spsalesid='"+invoiceno+"' and sptokenno='"+token+"' group by spprodrefid order by spid";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getClientDetails(String contactref,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT cbname,cbmobile1st,cbid,cbcontactrefid,cbmobile2nd,cbemail1st,cbemail2nd FROM contactboxctrl where cbrefid='"+contactref+"' and cbtokenno='"+token+"' order by cbid";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String[][] getInvoiceClientDetails(String contactref,String token) {
		...
		String[][] newsdata = null;
		try {
			String queryselect = "SELECT c.cbname,cb.ccpan,cb.cccountry,cb.ccstate,cb.cccity,cb.ccaddress,cb.ccstatecode FROM contactboxctrl c INNER JOIN clientcontactbox cb on c.cbcontactrefid=cb.ccbrefid where c.cbrefid='"+contactref+"' and c.cbtokenno='"+token+"' order by c.cbid";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static String findInvoicedSalesType(String salesNo,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT sales_type FROM managesalesctrl where msinvoiceno='"+salesNo+"' and mstoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
	...
	public static String findSalesType(String salesNo,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT sales_type FROM estimatesalectrl where essaleno='"+salesNo+"' and estoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getSalesPricePercentage(String estrefid,String mid,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT epworkpaytype,epworkpricepercentage FROM estimateconvert_pricepercentage where epsalesrefid='"+estrefid+"' and epmilestoneid='"+mid+"' and eptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
				getinfo = rset.getString(1);	
				if(getinfo.equalsIgnoreCase("Full Pay")){getinfo="100";}
				else if(getinfo.equalsIgnoreCase("Partial Pay")){getinfo="50";}
				else if(getinfo.equalsIgnoreCase("Milestone Pay")){getinfo=rset.getString(2);}
	...
	public static String[] getSalesNumber(String estimateKey,String token) {
		...
		try {
			String queryselect = "SELECT essaleno,esclientrefid,esregdate,escontactrefid,esordernumber,espurchasedate FROM estimatesalectrl where esrefid='"+estimateKey+"' and estoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getPaymentData(String srefid,String token) {
		...
		try {
			String queryselect = "SELECT saddeddate,sestsaleno,sinvoiceno,sapproveddate,stransactionamount,stransactionstatus,service_name,payment_invoice,sunbill_no FROM salesestimatepayment where srefid='"+srefid+"' and stokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getInvoiceSalesNumber(String salesKey,String token) {
		...
		String getinfo[] =new String[6];
		try {
			String queryselect = "SELECT msinvoiceno,msclientrefid,mssolddate,mscontactrefid,msordernumber,mspurchasedate FROM managesalesctrl where msrefid='"+salesKey+"' and mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getSalesDataByUnbill(String msrefid,String token) {
		...
		try {
			String queryselect = "SELECT mscontactrefid,msproductname FROM managesalesctrl where msrefid='"+msrefid+"' and mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getSalesDataForInvoice(String invoice,String token) {
		...
		try {
			String queryselect = "SELECT msclientrefid,mssolddate FROM managesalesctrl where msinvoiceno='"+invoice+"' and mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getCompanyAddress(String compname,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT cregaddress FROM hrmclient_reg where cregname='"+compname+"' and cregtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getFileName(String docrefid,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT sddocname FROM salesdocumentctrl where sdrefid='"+docrefid+"' and sdtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getBillingInvoiceNumber(String invoiceno,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT cbinvoiceno FROM hrmclient_billing where (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getInvoiceNumber(String salesno,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT cbinvoiceno FROM hrmclient_billing where cbestimateno='"+salesno+"' and cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getProductJurisdiction(String prodrefid,String token) {
		...
		String getinfo[] =new String[3];
		try {
			String queryselect = "SELECT pcentral,pstate,pglobal FROM product_master where prefid='"+prodrefid+"' and ptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getProductRefId(String prodtype,String prodname,String token) {
		...
		try {
			String queryselect = "SELECT prefid,pcentral,pstate,pglobal FROM product_master where ptype='"+prodtype+"' and pname='"+prodname+"' and ptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static boolean isPaymentInvoiceExist(String invoice,String token) {
		...
		try {
			String queryselect = "SELECT sid FROM salesestimatepayment where payment_invoice='"+invoice+"' and stokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
...
//			System.out.println(queryselect);
	...
	public static boolean isInvoiceExist(String saleno,String token) {
		...
		boolean getinfo =false;
		try {
			String queryselect = "SELECT cbuid FROM hrmclient_billing where cbinvoiceno='"+saleno+"' and cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static boolean isEstimateExist(String saleno,String token) {
		...
		boolean getinfo =false;
		try {
			String queryselect = "SELECT cbuid FROM hrmclient_billing where cbestimateno='"+saleno+"' and cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getSalesPaidAmount(String estimateNo,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(stransactionamount) FROM salesestimatepayment where sestsaleno='"+estimateNo+"' and stokenno='"+token+"' and stransactionstatus!='3'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getProductAmount(String salesrefid,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(sptotalprice) FROM salespricectrl where spsalesrefid='"+salesrefid+"' and sptokenno='"+token+"' and spstatus='1'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getBillingOrderAmount(String invoiceno,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT cborderamount FROM hrmclient_billing where (cbestimateno='"+invoiceno+"' or cbinvoiceno='"+invoiceno+"') and cbtokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
				getinfo = rset.getDouble(1);				
	...
	public static double getTotalDiscountPrice(String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(cbdiscount) FROM hrmclient_billing where cbinvoiceno!='NA' and cbtokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
				getinfo = rset.getDouble(1);				
	...
	public static double getSalesOrderAmount(String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(cborderamount) FROM hrmclient_billing where cbinvoiceno!='NA' and cbtokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
				getinfo = rset.getDouble(1);				
	...
	public static String getPONumber(String refid,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT stransactionid FROM salesestimatepayment where srefid='"+refid+"' and stokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
...
//			System.out.println(queryselect);
	...
	public static String getPaymentMode(String refid,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT spaymtmode FROM salesestimatepayment where srefid='"+refid+"' and stokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getTransactionAmount(String refid,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT stransactionamount FROM salesestimatepayment where srefid='"+refid+"' and stokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getProductPrice(String saleno,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(sptotalprice) FROM salesproductprice where spsalesid='"+saleno+"' and sptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getPaidAmount(String salesno,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(stransactionamount) FROM salesestimatepayment where sestsaleno='"+salesno+"' and stransactionstatus='1' and stokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getOrderAmount(String salesno,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(sptotalprice) FROM salesproductprice where spsalesid='"+salesno+"' and sptokenno='"+token+"'";
	...
	public static double getEstimateFirstMilestonePercent(String saleskey,String productKey,String token) {
		...
		try {
			String queryselect="SELECT e.epworkpricepercentage FROM estimateconvert_pricepercentage e left join product_milestone p "
					+ "on e.epmilestoneid=p.pmid where e.epsalesrefid='"+saleskey+"' and "
					+ "p.pm_prodrefid='"+productKey+"' and "
					+ "p.pm_tokeno='"+token+"' and p.pmsteps='1' limit 1";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
				getinfo= rset.getDouble(1);	
	...
	public static String getSalesProductKey(String salesKey,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT spprodrefid FROM salesproductprice where spessalerefid='"+salesKey+"' and sptokenno='"+token+"' limit 1";
	...
	public static double getEstimateSaleOrderAmount(String salesKey,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(sptotalprice) FROM salesproductprice where spessalerefid='"+salesKey+"' and sptokenno='"+token+"'";
	...
	public static double getSalesTax(double orderamt,String salesno,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT * FROM salesproductprice where spsalesid='"+salesno+"' and sptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getClientKeyBySalesKey(String salesKey,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT msclientrefid FROM managesalesctrl where msrefid='"+salesKey+"' and mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getSalesCloseDate(String salesKey,String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT project_close_date FROM managesalesctrl where msrefid='"+salesKey+"' and mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
...
//			System.out.println(queryselect);
	...
	public static double getSalesWorkProgress(String salesKey,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT msworkpercent FROM managesalesctrl where msrefid='"+salesKey+"' and mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static double getOrderAmountWithoutTax(String salesno,String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT sum(spprice) FROM salesproductprice where spsalesid='"+salesno+"' and sptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
...
//			System.out.println(queryselect);
	...
	public static String[] getClientCompanyDetail(String compname,String token) {
		...
		String[] getinfo =new String[2];
		try {
			String queryselect = "SELECT cregstatecode,creggstin FROM hrmclient_reg where cregname='"+compname+"' and cregtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getContactDetail(String contactrefid,String token) {
		...
		try {
			String queryselect = "SELECT c.cbname,cc.ccaddress,cc.ccstate,cc.ccstatecode,cc.ccpan,"
					...
					+ "clientcontactbox cc on c.cbcontactrefid=cc.ccbrefid where c.cbrefid='"+contactrefid+"' and c.cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getClientsDetail(String clientrefid,String token) {
		...
		try {
			String queryselect = "SELECT cregname,cregaddress,cregstate,cregstatecode,creggstin FROM hrmclient_reg where cregclientrefid='"+clientrefid+"' and cregtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getClientsDetail(String clientrefid) {
		...
		String[] getinfo =new String[5];
		try {
			String queryselect = "SELECT cregname,cregaddress,cregstate,cregstatecode,creggstin FROM hrmclient_reg where cregclientrefid='"+clientrefid+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getFolderDetails(String salesrefid,String token) {
		...
		String[] getinfo =new String[2];
		try {
			String queryselect = "SELECT frefid,fname FROM folder_master where fsalesrefid='"+salesrefid+"' and ftokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
				getinfo[0] = rset.getString(1);
	...
	public static String getLastStatus(String enqid,String token) {
		...
		String getinfo = "NA";
		try {
			String queryselect = "SELECT enqfstatus FROM userenquiryfollowup where enqfeuid='"+enqid+"' and enqftokenno='"+token+"' order by enqfuid desc limit 1";
			ps = con.prepareStatement(queryselect);
//			System.out.println(queryselect);
			rset = ps.executeQuery();
	...
	public static int getProductNumber(String salesid,String token) {
		...
		int getinfo = 0;
		try {
			String queryselect = "SELECT spvsalesno FROM salesproductvirtual where spvsalesid='"+salesid+"' and spvtokenno='"+token+"' order by spvid desc limit 1";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static String getSalesClientName(String salesrefid,String token) {
		...
		String getinfo = null;
		try {
			String queryselect = "SELECT enqCompanyName FROM userenquiry where enqrefid='"+salesrefid+"' and enqTokenNo='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static String getFolderRefIdByClientId(String clientid,String token) {
		...
		String getinfo = "NA";
		try {
			String queryselect = "SELECT frefid FROM folder_master where fclientid='"+clientid+"' and ftokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static String getFolderRefId(String salesrefid,String token) {
		...
		String getinfo = null;
		try {
			String queryselect = "SELECT frefid FROM folder_master where fsalesrefid='"+salesrefid+"' and ftokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static String getuniquecode(String token) {
		...
		String getinfo = null;
		try {
			String queryselect = "SELECT estinvoiceno FROM estimateinvoicectrl where esttokenno='"+token+"' order by estid desc limit 1";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static boolean isGstApplied(String gen_key) {
		...
		boolean flag=false;
		try{
			ps=con.prepareStatement("select id from generate_estimate_details where generate_key='"+gen_key+"' and (cgst!='0' or sgst!='0' or igst!='0') limit 1");
//			System.out.println("select id from generate_estimate_details where generate_key='"+gen_key+"' and cgst!='0' and sgst!='0' and igst!='0' limit 1");
	...
	public static boolean isProductInOrder(String prodrefid,String salesno,String token,String addedby) {
		...
		boolean flag=false;
		try{
			ps=con.prepareStatement("select spid from salesproductprice where spprodrefid='"+prodrefid+"' and spsalesid='"+salesno+"' and sptokenno='"+token+"'");
			rs=ps.executeQuery();
			if(rs!=null&&rs.next())flag=true;
		}
		catch (Exception e) {
	...
	public static boolean isProductContactExist(String estimateNo,String token,String addedby) {
		...
		boolean flag=false;
		try{
			ps=con.prepareStatement("select scvid from salescontactboxvirtual where "
					+ "scvsalesid='"+estimateNo+"' and scvaddedby='"+addedby+"' "
					+ "and scvtokenno='"+token+"' "
	...
	public static boolean isProductInCart(String prodrefid,String token,String addedby) {
		...
		boolean flag=false;
		try{
			ps=con.prepareStatement("select spvid from salesproductvirtual where spvrefpid='"+prodrefid+"' and spvaddedby='"+addedby+"' and spvtokenno='"+token+"'");
			rs=ps.executeQuery();
			if(rs!=null&&rs.next())flag=true;
		}
		catch (Exception e) {
	...
	public static boolean isContactExist(String mobile,String salesid,String token,String addedby,String email) {
		...
		boolean flag=false;
		try{
			String query="select scvid from salescontactboxvirtual where "
					+ "scvsalesid='"+salesid+"' and (scvcontactmobile1st='"+mobile+"' or scvcontactmobile2nd='"+mobile+"' "
...
//			System.out.println(query);
	...
	public static boolean isEstimateInvoiceSend(String srefid) {
		...
		try{
			...
			rs=ps.executeQuery();
			if(rs.next()){if(rs.getString(1)!=null)flag=true;}
		}
		catch (Exception e) {
	...
	public static boolean deleteSalesDocument(String dmuid) {
		...
		try{
			...
			rs=ps.executeQuery();
			if(rs.next())docpath=rs.getString(1);
	...
	public static void deletePriceMilestone(String uid,String token,String enq) {
		...
		Connection con = DbCon.getCon("","","");
		try{
			ps=con.prepareStatement("delete from project_price where preguid='"+uid+"' and tokenno='"+token+"' and enq='"+enq+"'");
			ps.execute();
			
			ps=con.prepareStatement("delete from project_milestone where preguid='"+uid+"' and tokenno='"+token+"' and enq='"+enq+"'");
			ps.execute();
		}
		catch (Exception e) {
	...
	public static int[] getTotalTime(String prodrefid,String token) {
		...
		try{
			...
			int month=0;
			int year=0;
			ps=con.prepareStatement("select pm_timelineunit,pm_timelinevalue from product_milestone where pm_prodrefid='"+prodrefid+"' and pm_tokeno='"+token+"'");
			rs=ps.executeQuery();
			while(rs.next()){
				if(rs.getString(1).equalsIgnoreCase("Day")){day+=rs.getInt(2);}
				else if(rs.getString(1).equalsIgnoreCase("Week")){week+=rs.getInt(2);}
				else if(rs.getString(1).equalsIgnoreCase("Month")){month+=rs.getInt(2);}
				else if(rs.getString(1).equalsIgnoreCase("Year")){year+=rs.getInt(2);}
			}
			data[0]=day;
			data[1]=week;
			data[2]=month;
...
//	}
	...
	public static String getEnqStatus(String enqid,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
			ps=con.prepareStatement("select enqfstatus from userenquiryfollowup where enqfeuid='"+enqid+"' and enqftokenno='"+token+"'");
			rs=ps.executeQuery();
			while(rs.next()){
	...
	/*saving project milestone*/
	public static void addProjectMilestone(String pid,String enqid, String token,String addedby,String datetime,String Enq) {
		PreparedStatement ps = null;
		PreparedStatement ps1 = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
		try{
			ps=con.prepareStatement("select pm_worktype,pm_unittime,pm_duration,pm_smsid,pm_emailid from product_milestone where pm_pid='"+pid+"' and pm_tokeno='"+token+"'");
			rs=ps.executeQuery();
//			System.out.println("select pm_worktype,pm_unittime,pm_duration,pm_smsid,pm_emailid from product_milestone where pm_pid='"+pid+"' and pm_tokeno='"+token+"'");
			while(rs.next()){
				ps1=con.prepareStatement("insert into project_milestone(preguid,worktype,unittime,duration,smsid,emailid,status,tokenno,addedby,addedon,enq)values(?,?,?,?,?,?,?,?,?,?,?)");				
	...
	public static boolean saveForExpenseApproval(String expkey,String expname,String today,
			String expNumber,String expAmount,String expCategory,String expHSN,
			String expDepartment,String expAccount,String expNote,String token,
			String addedby,String loginuaid,String salesKey,String approvalStatus,
	...
	public static boolean saveInTransactionHistory(String laserkey,String invoice,String today,String contactname,
		...
		Connection con = DbCon.getCon("","","");
		try{		
				ps=con.prepareStatement("insert into managetransactionctrl(mtrefid,mtinvoice,mtdate,mtclientname,mtclientmobile,mtaccounts,mtcategory,mtwithdraw,mtdeposit,mtaddedby,mttokenno,mtremarks,mttype,mtdepartment,mthsncode,mtrefunddate) "
						+ "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
	...
	public static boolean saveMilestoneToSale(String milestonekey,String saleskey,String prodrefid,String milestonename,String timelinevalue,String timelineunit,String steps,String assign,String pricePercent,String addedby,String token,String payType){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{		
				ps=con.prepareStatement("insert into salesmilestonectrl(smrefid,smsalesrefid,smprodrefid,smmilestonename,smtimelinevalue,smtimelineperiod,smstep,smnextassignpercentage,smtoken,smaddedby,smpricepercentage,smpaytype) "
						+ "values(?,?,?,?,?,?,?,?,?,?,?,?)");
	...
	try {
		String queryselect = "SELECT sdid FROM salesdocumentctrl where sdestkey='"+estkey+"' and sdtokenno='"+token+"' and sddocname='NA' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
	...
	public static boolean addDocumentList(String dockey,String saleskey,String docname,
			String description,String uploadby,String addedby,String token,
			String visibiltiy,String estimateKey){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{		
				ps=con.prepareStatement("insert into salesdocumentctrl(sdrefid,sdsalesrefid,sduploaddocname,sddescription,sduploadby,adaddedby,sdtokenno,sdvisibility,sdestkey) "
						+ "values(?,?,?,?,?,?,?,?,?)");
	...
	public static boolean convertEstimatePriceToSale(String pricekey,String saleskey,String prodrefid,String pricetype,double price,String hsncode,double cgstpercent,double sgstpercent,double igstpercent,double cgstprice,double sgstprice,double igstprice,double total,String token,String addedby){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{		
				ps=con.prepareStatement("insert into salespricectrl(sprefid,spsalesrefid,spprodrefid,sppricetype,spprice,sphsncode,spcgstpercent,spsgstpercent,spigstpercent,spcgstprice,spsgstprice,spigstprice,sptotalprice,sptokenno,spaddedby) "
						+ "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
	...
	public static boolean saveGeneratedInvoice(String uuid,String invoice,String uid,
			String token,String date,String type){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{		
				ps=con.prepareStatement("insert into invoice_generator(uuid,invoice,user_uid,token,date,type) "
						+ "values(?,?,?,?,?,?)");
	...
	public static boolean saveNewInvoice(String invoice,String addedby,String token){
		...
		Connection con = DbCon.getCon("","","");
		try{		
				ps=con.prepareStatement("insert into salesinvoicectrl(siinvoice,siaddedby,sitokenno) "
						+ "values(?,?,?)");
	...
	public static boolean convertEstimateToSale(String key,String company,String prodtype,
			String prodname,String prodplan,String planperiod,String plantime,String today,
			String soldbyid,String contactrefid,String clientrefid,String remarks,String token,
			String addedby,String invoice,String estno,String projectno,String invoiceNotes,
			String jurisdiction,String estKey,String orderNumber,String purchaseDate,int tatValue,
			String tatType,int salesType){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{		
	...
	public static boolean addDefaultPlanOrder(String key,String servicetype,String prodname,
			String salesno,String company,String contactrefid,String clientrefid,
			String loginuaid,String token,String addedby,String today,String notes,String orderNumber,
			String purchaseDate){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{
			if(company.equalsIgnoreCase("...."))clientrefid="NA";
	...
	public static boolean addDefaultPlan(String key,String token,String addedby){
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("insert into salesproductrenewalvirtualctrl(spvprodrefid,spvprodplan,spvplanperiod,spvplantime,spvtokenno,spvaddedby) "
						+ "values(?,?,?,?,?,?)");
	...
	public static boolean addSalesContactToVirtual(String key,String contactid,String name,String email,String workMobile,String mobile,String salesid,String token,String addedby,String ckey){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("insert into salescontactboxvirtual(scvrefid,scvsalesid,scvcontactname,scvcontactemail1st,scvcontactmobile1st,scvcontactmobile2nd,scvtokenno,scvaddedby,scvcontactboxid,scvcontactrefid) "
						+ "values(?,?,?,?,?,?,?,?,?,?)");
	...
	public static boolean addPaymentDetails(String billrefid,String today,String salesno,String company,String clientrefid,String contactrefid,String amount,double orderamt,double paidamt,double dueamt,String token,String coupon,String type,String value,double discount) {
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{			
				ps=con.prepareStatement("insert into hrmclient_billing(cbrefid,cbestimateno,cbclientrefid,cbcompanyname,cbcontactrefid,cborderamount,cbpaidamount,cbdueamount,cbtransactionamount,cdnotificationcount,cbdate,cbtokenno,cbcoupon,cbtype,cbvalue,cbdiscount) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				ps.setString(1, billrefid);ps.setString(2, salesno);ps.setString(3, clientrefid);ps.setString(4, company);
				ps.setString(5, contactrefid);ps.setDouble(6, orderamt);ps.setDouble(7, paidamt);ps.setDouble(8, dueamt);
				ps.setString(9, amount);ps.setString(10, "1");ps.setString(11, today);ps.setString(12, token);
				ps.setString(13, coupon);ps.setString(14, type);ps.setString(15, value);ps.setDouble(16, discount);
	...
	public static boolean approveThisExpense(String expKey,String today,String loginuaid,String token,String approveStatus) {
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update expense_approval_ctrl set expapprovalstatus=?,expapprovebyuid=?,expapproveddate=? where expkey=? and exptoken=?");
	...
	public static boolean updateBillingInvoice(String invoice,String estimateno,String duedate,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update hrmclient_billing set cbinvoiceno=?,cbduedate=?,cbnextduedate=? where cbestimateno=? and cbtokenno=?");
				ps.setString(1, invoice);
	...
	public static boolean updateInvoicePaymentDetails(String salesno,String amount,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update hrmclient_billing set cbtransactionamount=cbtransactionamount+"+amount+",cdnotificationcount=cdnotificationcount+"+1+" where cbinvoiceno='"+salesno+"' and cbtokenno='"+token+"'");
	...
	public static boolean updatePaymentDetails(String salesno,String amount,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update hrmclient_billing set cbtransactionamount=cbtransactionamount+"+amount+",cdnotificationcount=cdnotificationcount+"+1+" where cbestimateno='"+salesno+"' and cbtokenno='"+token+"'");
	...
	public static boolean addSalesPayment(String key,String today,String estinvoice,String invoiceno,
			String loginuaid,String paymentmode,String transactionid,String amount,String token,
			String addedby,String imgname,String imgpath,String service_name,String pinvoice,
			String remarks,String unbillNo,int serviceQty){
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{
	...
	public static boolean uploadSalesProductPayment(String key,String paymentmode,String pymtdate,String transactionid,
			String amount,String salesno,String imgname,String imgpath,String token,String addedby,String invoiceno,
			String service_Name,String pinvoice,String remarks,String loginuaid,int serviceQty) {
		PreparedStatement ps = null;		
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{
	...
	public static boolean addPriceInCart(String key,String salesid,int prodno,String prodrefid,String pricetype,String price,String hsn,String cgst,String sgst,String igst,String total_price,String key1,String token,String addedby) {
		PreparedStatement ps = null;		
		ResultSet rs=null;
		boolean status=false;
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("insert into salesproductvirtual(spvvirtualid,spvrefpid,spvpricetype,spvprice,spvhsncode,spvcgstpercent,spvsgstpercent,spvigstpercent,spvtotalprice,spvtokenno,spvaddedby,spvrefid,spvsalesid,spvsalesno,spvminprice) "
						+ "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
	...
	public static void createProjectFolder(String folderrefid,String projectno,String addedby,String token,String folcategory,String foldertype,String saleskey,String clientid,String subfolkey){
		PreparedStatement ps = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
		try{
			ps=con.prepareStatement("insert into folder_master(frefid,fname,fstatus,faddedby,ftokenno,fprojectno,fclientid,fsfrefid,ffcategory,ftype,fsalesrefid) values(?,?,?,?,?,?,?,?,?,?,?)");
	...
	public static boolean createClientFolder(String key,String foldername,String addedby,String token,String folcategory,String foldertype,String salesrefid,String clientid) {
		PreparedStatement ps = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
		boolean flag=false;
	...
	public static void createSalesFolder(String key,String enquid,String addedby,String token,String folcategory,String ftype,String salesrefid) {
		PreparedStatement ps = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
		try{
	...
	public static void addEstimatedInvoice(String key,String refid,String today,String uarefid,String token,String status,String estinvoiceno) {
		PreparedStatement ps = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("insert into estimateinvoicectrl(estuuid,estsalesrefid,estcreateddate,estcreatedbyrefid,esttokenno,eststatus,estinvoiceno) values(?,?,?,?,?,?,?)");
	...
	public static boolean declinePayment(String refid,String loginuaid,String today,String token,String comment) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update salesestimatepayment set sapproveddate=?,sapprovedby=?,stransactionstatus=?,scomment=? where srefid=? and stokenno=?");
	...
	public static boolean holdPayment(String refid,String loginuaid,String today,String token,String comment) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update salesestimatepayment set sapproveddate=?,sapprovedby=?,stransactionstatus=?,hold_comment=? where srefid=? and stokenno=?");
	...
	public static boolean approvePaymentDetails(String refid,String token,String date,
			String loginuid,String comment) {
		PreparedStatement ps = null;		
		ResultSet rs=null;
		boolean flag=false;
		Connection con = DbCon.getCon("","","");
	...
	public static boolean updatePaymentDetails(String unbillNo,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update salesestimatepayment set sinvoice_status=? "
						+ "where sunbill_no=? and stokenno=?");
	...
	public static boolean updatePaymentAmounts(String refid,String value,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update salesestimatepayment set stransactionamount=? where srefid=? and stokenno=?");
	...
	public static boolean updatePricePercent(String refKey,String value,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update estimateconvert_pricepercentage set epworkpricepercentage=? where eprefid=? and eptokenno=?");
	...
	public static boolean updatePayTypeStatus(String salesKey,String payType,String token) {
		...
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("update estimateconvert_pricepercentage set epworkpaytype=? where epsalesrefid=? and eptokenno=?");
	...
	/*adding estimate invoice details*/
	public static void uploadSalesPaymentDoc(String key,String today,String sref,String paystatus,String addedby,String token,String imgname) {
		PreparedStatement ps = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
		try{
				ps=con.prepareStatement("insert into salesestimatepayment(srefid,saddeddate,senqrefid,spaymtmode,stransactionid,stransactionamount,stransactionstatus,saddedby,sstatus,stokenno,sdocumentname) values(?,?,?,?,?,?,?,?,?,?,?)");
	...
	/*adding estimate invoice details*/
	public static boolean addEstimatePaymentDetails(String key,String pdate,String sref,String payoption,String transid,String transamt,String pymtstatus,String addedby,String status,String token) {
		PreparedStatement ps = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
		boolean flag=false;
		try{
				ps=con.prepareStatement("insert into salesestimatepayment(srefid,saddeddate,senqrefid,spaymtmode,stransactionid,stransactionamount,stransactionstatus,saddedby,sstatus,stokenno) values(?,?,?,?,?,?,?,?,?,?)");
	...
	public static void addProjectPrice(String pid,String enqid, String token,String addedby,String datetime,String Enq) {
		PreparedStatement ps = null;
		PreparedStatement ps1 = null;		
		ResultSet rs=null;
		Connection con = DbCon.getCon("","","");
...
//			System.out.println("select pp_pricetype,pp_price,pp_service_type,pp_term,pp_term_time,pp_gst_status,pp_gst,pp_gst_price,pp_total_price from product_price where pp_pid='"+pid+"' and pp_tokenno='"+token+"'");
			while(rs.next()){
				ps1=con.prepareStatement("insert into project_price(preguid,pricetype,price,servicetype,term,termtime,gststatus,gst,gstprice,totalprice,status,tokenno,addedby,addedon,enq,penqsale) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
//	}
	...
	@SuppressWarnings("resource")
	public static String updatePriceMilestone(String pregpuno,String pregcuid,String token,String enqid,String buildingtime) {
		Connection con = DbCon.getCon("", "", "");
		PreparedStatement ps = null;
		ResultSet rset = null;
		String getinfo = null;
		try {
			String queryselect="SELECT preguid FROM hrmproject_reg where 	pregpuno='"+pregpuno+"' and pregcuid='"+pregcuid+"' and pregtokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
			...
			if(getinfo!=null)
			ps = con.prepareStatement("update project_price set preguid=?,enq=? where preguid=? and enq=? and tokenno=?");
			...
			ps.setString(5,token);			
			ps.execute();
			ps = con.prepareStatement("update project_milestone set preguid=?,enq=? where preguid=? and enq=? and tokenno=?");
			ps.setString(1,getinfo );
			ps.setString(2,"NA" );
			ps.setString(3,enqid );			
			ps.setString(4,"enquiry" );
	...
	public static String getSalesDueAmount(String salesNo,String token) {
		...
		String getinfo = "NA";
		try {
			String queryselect="SELECT cbdueamount FROM hrmclient_billing where cbestimateno='"+salesNo+"' and cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static double findSalesDueAmount(String invoiceNo,String token) {
		...
		double getinfo = 0;
		try {
			String queryselect="SELECT cbdueamount FROM hrmclient_billing where cbinvoiceno='"+invoiceNo+"' and cbtokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static String getEnquiryId(String enquid,String company,String token) {
		...
		String getinfo = null;
		try {
			String queryselect="SELECT enqid FROM userenquiry where enquid='"+enquid+"' and enqCompanyName='"+company+"' and 	enqTokenNo='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static String getProductId(String productType,String token) {
		...
		String getinfo =null;
		try {
			String queryselect="SELECT pid FROM product_master where pname='"+productType+"' and 	ptokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo= rset.getString(1);				
	...
	public static String getClientsAccountid(String clientid,String token) {
		...
		String getinfo = "NA";
		try {
			String queryselect="SELECT caid FROM client_accounts where cacid='"+clientid+"' and catokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static String getClientId(String client_no,String token) {
		...
		String getinfo = null;
		try {
			String queryselect="SELECT creguid FROM hrmclient_reg where cregucid='"+client_no+"' and cregtokenno='"+token+"'";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
...
//			String queryselect = "SELECT CAST((SUBSTRING(enquid,4)) as UNSIGNED) AS maxval FROM userenquiry where enqcompany='"+company+"' order by enqid desc limit 1";
			String queryselect="SELECT essaleno FROM estimatesalectrl where estoken='"+token+"' and essalesstatus='new' order by esid desc limit 1";
	...
	public static String getSalesProductName(String salesKey,String token) {
		...
		String getinfo = null;
		try {
			String queryselect="SELECT msproductname FROM managesalesctrl where msrefid='"+salesKey+"' and  mstoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static String getCompanyName(String invoice,String token) {
		...
		String getinfo = null;
		try {
			String queryselect="SELECT mscompany FROM managesalesctrl where msinvoiceno='"+invoice+"' and  mstoken='"+token+"' order by msid limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static String getProjectNumber(String token) {
		...
		String getinfo = null;
		try {
			String queryselect="SELECT msprojectnumber FROM managesalesctrl where msstatus='1' and  mstoken='"+token+"' order by msid desc limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static String getExpenseNumber(String token) {
		...
		String getinfo = null;
		try {
			String queryselect="SELECT mtinvoice FROM managetransactionctrl where mttokenno='"+token+"' and mttype='Expense' order by mtid desc limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static String generateInvoice(String token,String date,String type) {
		...
		String getinfo = "NA";
		try {
			String queryselect="select invoice from invoice_generator where type='"+type+"' and token='"+token+"' and date='"+date+"' order by id desc limit 1";
	...
	public static String getInvoiceNumber(String token) {
		...
		String getinfo = null;
		try {
			String queryselect="SELECT siinvoice FROM salesinvoicectrl where sitokenno='"+token+"' order by siid desc limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
	...
	public static String getEnqUID(String token) {
		...
		try {
//			String queryselect = "SELECT CAST((SUBSTRING(enquid,4)) as UNSIGNED) AS maxval FROM userenquiry where enqcompany='"+company+"' order by enqid desc limit 1";
			String queryselect="SELECT enquid FROM userenquiry where enqTokenNo='"+token+"' order by enqid desc limit 1";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static String getEnqUInitial(String company) {
		...
		String getinfo = null;
		try {
			String queryselect = "SELECT SUBSTRING(enquid,1,3) FROM userenquiry where enqcompany='"+company+"' order by enqid desc limit 1";
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			while (rset != null && rset.next()) {
				getinfo = rset.getString(1);
	...
	public static boolean addPricePercentage(String pricePercKey, String saleskey, String milestoneid,String milestoneName,String payType,String pricePercent,String token,String addedby,String newsalesid) {
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {			
	...
	public static boolean AddEstimateSale(String saleno, String prodtype, String company,String Remarks,String addedby,
			...
			String orderNo,String purchaseDate,int tatValue,String tatType,String salesType) {
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
			if(plan.equalsIgnoreCase("Renewal")){
				if(planperiod.equalsIgnoreCase("NA")||plantime.equalsIgnoreCase("NA")){
					plan="OneTime";planperiod="NA";plantime="NA";
				}
			}
			if(company.equalsIgnoreCase("....")&&(clientrefid==null||clientrefid.length()<=0||clientrefid.equalsIgnoreCase("NA")))clientrefid="NA";
	...
	public static boolean AddEnquiry(String enquid, String enqType, String company,String enqRemarks,String addedby,String token,String product_name,String key,String today,String loginuaid,String contactrefid,String clientrefid) {
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
	...
	public static String[] getSalesProductType(String prodrefid,String token){
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT ptype,pname,prefid,tat_value,tat_type FROM product_master where prefid='"+prodrefid+"' and ptokenno='"+token+"'");
	...
	public static String[] getProductPlan(String groupkey,String token){
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT spvprodplan,spvplanperiod,spvplantime,spvjurisdiction FROM salesproductrenewalvirtualctrl where spvprodrefid='"+groupkey+"' and spvtokenno='"+token+"' ");
	...
	public static String[][] getAllProductsPayment(String groupkey,String token){
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT psvrefid,psvmode,psvdate,psvtransactionid,psvtransactionamount,psvdocumentname,psvdocpath FROM pymtsalesvirtual where psvprodvirtualrefid='"+groupkey+"' and psvtokenno='"+token+"' ");
	...
	public static String[][] getEachProductsPriceDetails(String groupkey,String token,String username){
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT spvrefpid,spvpricetype,spvprice,spvhsncode,spvcgstpercent,spvsgstpercent,spvigstpercent,spvtotalprice,spvrefid,spvqty,"
					+ "spvminprice FROM salesproductvirtual where spvprice!='0' and spvvirtualid='"+groupkey+"' and spvaddedby='"+username+"' and spvtokenno='"+token+"' ");
...
//			System.out.println(VCQUERY);
	...
	public static String[][] getProductPriceList(String prodkey,String token){
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT * FROM product_price where pp_prodrefid='"+prodkey+"' and pp_tokenno='"+token+"' ");
//			System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getSalesProductList(String salesid,String token,String addedby) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT spvvirtualid,spvsalesno,spvrefpid,spvqty FROM salesproductvirtual where spvsalesid='"+salesid+"' and spvtokenno='"+token+"' and spvaddedby='"+addedby+"' group by spvsalesno order by spvsalesno ");
	...
	public static String[][] getSalesContactList(String salesid,String token,String addedby) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT scvcontactname,scvcontactemail1st,scvcontactemail2nd,scvcontactmobile1st,scvcontactmobile2nd,scvcontactrefid FROM "
					+ "salescontactboxvirtual where scvsalesid='"+salesid+"' and scvtokenno='"+token+"' and scvaddedby='"+addedby+"' order by scvid ");
//			System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getAllSalesDocument(String folrefid,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT dmuid,dmdate,dmdoctype,dmdocument_name FROM document_master where dmrefno='"+folrefid+"' and dmtokenno='"+token+"' ");
	...
	public static String[][] getFolderAccessUser(String fKey,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT fp.fpid,ua.uaname FROM user_account ua join folder_permission fp on fp.fp_uid=ua.uaid where fp.fp_frefid='"+fKey+"' and fp.fptoken='"+token+"' and ua.uavalidtokenno='"+token+"' group by fp.fp_uid order by fpid desc");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getEstimateProduct(String salesNo,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT esprodname,sales_type FROM estimatesalectrl where essaleno='"+salesNo+"' and estoken='"+token+"' group by esprodname");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getCancelledInvoice(String invoice,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT uuid,invoice_no,date,total_amount FROM invoice where invoice_no='"+invoice+"' and token='"+token+"' and status='2'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getGeneratedEstimate(String estKey,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT date,uuid,amount,invoice FROM generate_estimate where estimate_key='"+estKey+"' and token='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
...
//				System.out.println(VCQUERY);
	...
	public static String[][] getEstimateTaxList(String salesNo,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT sphsncode,spcgstpercent,spsgstpercent,spigstpercent FROM salesproductprice where spsalesid='"+salesNo+"' and sptokenno='"+token+"' and sphsncode!='NA' and sphsncode!='' group by sphsncode");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getSalesInvoiceTaxList(String invoice,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT sphsncode,spcgstpercent,spsgstpercent,spigstpercent FROM salespricectrl where exists(select msid from managesalesctrl where msinvoiceno='"+invoice+"' and msrefid=spsalesrefid) and sptokenno='"+token+"' and sphsncode!='NA' and sphsncode!='' group by sphsncode");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getInvoiceTaxList(String invoice,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT hsn,cgst,sgst,igst FROM invoice_items where invoice_no='"+invoice+"' and token='"+token+"' and hsn!='NA' and hsn!='' group by hsn");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getGenerateInvoiceTaxList(String invoiceKey) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT i.hsn,i.cgst_percent,i.sgst_percent,i.igst_percent FROM invoice_product_items i inner join invoice_product p "
					+ "on i.invoice_product_key=p.refkey where p.invoice_key='"+invoiceKey+"' and i.hsn!='NA' and i.hsn!='' group by i.hsn");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
...
//				System.out.println(VCQUERY);
	...
	public static double[] getEstimatePrice(String salesno,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT sum(spprice),sum(spcgstprice),sum(spsgstprice),sum(spigstprice),sum(sptotalprice) FROM salesproductprice where spsalesid='"+salesno+"' and sptokenno='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
	...
	public static String[][] getEstimatePriceList(String refid,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT sprefid,sppricetype,spprice,sphsncode,spcgstpercent,spsgstpercent,spigstpercent,"
					+ "spcgstprice,spsgstprice,spigstprice,sptotalprice,spaddedon FROM salesproductprice where spessalerefid='"+refid+"' and sptokenno='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
...
//				System.out.println(VCQUERY);
	...
	public static String[][] getInvoicePaymentList(String invoice,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT type,hsn,amount,cgst,sgst,igst FROM invoice_items where invoice_no='"+invoice+"' and token='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getPaymentList(String refid,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT * FROM estimatepaymentdetails where payment_uid='"+refid+"' and token='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
...
//				System.out.println(VCQUERY);
	...
	public static String[][] getSalesPriceList(String refid,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT sprefid,sppricetype,spprice,sphsncode,spcgstpercent,spsgstpercent,spigstpercent,spcgstprice,spsgstprice,spigstprice,sptotalprice,spaddedon FROM salespricectrl where spsalesrefid='"+refid+"' and sptokenno='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
...
//			System.out.println(VCQUERY);
	...
	public static String[][] getSalesInvoiceProductList(String invoice,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT msrefid,msproductname,msinvoicenotes,sales_type FROM managesalesctrl where msinvoiceno='"+invoice+"' and mstoken='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
	...
	public static String[][] getSoldSalesProductList(String invoice,String token) {
		...
		try {
			...
			VCQUERY = new StringBuffer("SELECT msrefid,msproductname,mssolddate,msclientrefid,msproducttype FROM managesalesctrl where msinvoiceno='"+invoice+"' and mstoken='"+token+"'");
//				System.out.println(VCQUERY);
			stmnt = getacces_con.prepareStatement(VCQUERY.toString());
			rsGCD = stmnt.executeQuery();
			rsGCD.last();
...
public static String[][] getSalesPayment(String invoiceno,String token,String status) {
	// Initialing variables
	Connection getacces_con = null;
	PreparedStatement stmnt = null;
	ResultSet rsGCD = null;
	...
	try {
		...
		VCQUERY = new StringBuffer("SELECT p.srefid,p.saddeddate,p.spaymtmode,p.stransactionid,"
				...
				+ "p.service_name,p.hold_comment,p.po_validity FROM "
				+ "salesestimatepayment p INNER JOIN user_account u on p.saddedbyuid=u.uaid "
				+ "where (p.sestsaleno='"+invoiceno+"' or p.sinvoiceno='"+invoiceno+"') and p.stokenno='"+token+"' "
...
//			System.out.println(VCQUERY);
	...
	public static boolean updateSaleProductPrice(String sprefid,double price,double cgstprice,double sgstprice,double igstprice,double totalprice,String token) {
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
			...
			ps = con.prepareStatement(query);
			ps.setDouble(1, price);ps.setDouble(2, cgstprice);ps.setDouble(3, sgstprice);ps.setDouble(4, igstprice);ps.setDouble(5, totalprice);ps.setString(6, sprefid);ps.setString(7, token);
			int k=ps.executeUpdate();
			if(k>0)status = true;
		} catch (Exception e) {
...
//			System.out.println(query);
	...
	public static boolean deleteManageInvoice(String refKey,String token) {
		...
		boolean status = false;
		try {
			String query = "update manage_invoice set active_status=false WHERE refkey='" + refKey + "' and token='"+token+"'";
//			System.out.println(query);
			ps = con.prepareStatement(query);
			ps.execute();
			status = true;
	...
	public static boolean enquiryDelete(String uid,String token) {
		...
		boolean status = false;
		try {
			ps = con.prepareStatement("DELETE FROM project_price WHERE preguid='" + uid + "' and enq='enquiry' and tokenno='"+token+"'");
			ps.execute();
			ps = con.prepareStatement("DELETE FROM project_milestone WHERE preguid='" + uid + "' and enq='enquiry' and tokenno='"+token+"'");
			ps.execute();
	...
	public static boolean updateSalesContactToVirtual(String contactid,String name,String email,
			String workMobile,String mobile,String salesid,String token,String addedby) {
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
	...
	public static boolean saveFollowUpStatus(String enqfeuid, String enqfstatus,String enqdate,String enqfdate,String token) {
		PreparedStatement ps = null;
		Connection con = DbCon.getCon("", "", "");
		boolean status = false;
		try {
	...
	public static String[] getSalesData(String salesKey,String token) {
		...
		String getinfo[] =new String[3];
		try {
			String queryselect = "SELECT msinvoiceno,msestimateno,msproductname FROM managesalesctrl where (msrefid='"+salesKey+"' or msinvoiceno='"+salesKey+"') and mstoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String findEstimateSalesPayType(String estimateNo, String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT epworkpaytype FROM estimateconvert_pricepercentage where epsaleno='"+estimateNo+"' and eptokenno='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getEstimateSalesPayType(String estimateKey, String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT epworkpaytype FROM estimateconvert_pricepercentage where epsalesrefid='"+estimateKey+"' and eptokenno='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getProductKeyByNo(String productNo, String token) {
		...
		String getinfo ="NA";
		try {
			String queryselect = "SELECT prefid FROM product_master where pprodid='"+productNo+"' and ptokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static boolean isTransactionExist(String transactionId, String token) {
		...
		boolean getinfo =false;
		try {
			String queryselect = "SELECT sid FROM salesestimatepayment where stransactionid='"+transactionId+"' and stokenno='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[][] getVirtualProductList(String enquid, String token) {
		...
		String[][] newsdata=null;
		try {
			String queryselect = "SELECT spvrefpid,spvqty FROM salesproductvirtual where spvsalesid='"+enquid+"' and spvtokenno='"+token+"' group by spvsalesid";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rsGCD = ps.executeQuery();
			rsGCD.last();
	...
	public static double getEstimateDiscount(String essaleno, String token) {
		...
		double getinfo =0;
		try {
			String queryselect = "SELECT esdiscount FROM estimatesalectrl where essaleno ='"+essaleno+"' and estoken='"+token+"' limit 1";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String[] getAppliedCoupon(String salesno, String token) {
		...
		String getinfo[] =new String[3];
		try {
			String queryselect = "SELECT escoupon,estype,esvalue FROM estimatesalectrl where essaleno='"+salesno+"' and estoken='"+token+"'";
//			System.out.println(queryselect);
			ps = con.prepareStatement(queryselect);
			rset = ps.executeQuery();
			if (rset != null && rset.next()) {
	...
	public static String getContactEmail(String contactKey, String token) {
		...
		String newsdata = "NA";
		try {
			String queryselect = "SELECT cbemail1st FROM contactboxctrl where cbrefid ='"+contactKey+"' and cbtokenno='"+token+"' limit 1";
...
public static boolean addDownloadHistory(String key, String type, String download_key, String from_to_date, String today,
		String time, String uaid,String page,String token) {
	PreparedStatement ps = null;
	Connection con = DbCon.getCon("", "", "");
	boolean status = false;
	try {
...
public static boolean updateSalesWorkStatus(String status, String salesKey, String token) {
	...
	boolean flag = false;
	try {
		queryselect = new StringBuffer("update managesalesctrl set msworkstatus=?"
...
public static boolean saveEmail(String email, String cc, String subject, 
		String message, int estatus,String token) {
	PreparedStatement ps = null;
	Connection con = DbCon.getCon("", "", "");
	boolean status = false;
	try {
...
public static double[] getFees(String estimateno, String token,String type) {
	...
	Connection con = DbCon.getCon("","","");
	try{
		ps=con.prepareStatement("select sum(sptotalprice),sum(spcgstprice),sum(spsgstprice),sum(spigstprice) from salesproductprice where spsalesid='"+estimateno+"' and sppricetype='"+type+"' and sptokenno='"+token+"'");
		rs=ps.executeQuery();
		if(rs.next()) {
...
public static int[] getMaxTax(String estimateno, String token, String type) {
	...
	Connection con = DbCon.getCon("","","");
	try{
		ps=con.prepareStatement("select spcgstpercent,spsgstpercent,spigstpercent from salesproductprice where spsalesid='"+estimateno+"' and sppricetype='"+type+"' and sptokenno='"+token+"' order by (spcgstpercent+spsgstpercent+spigstpercent) desc limit 1");
...
public static boolean savePaymentDetails(String dkey, String payment_uid, String type, int cgst,
		int sgst, int igst, String token, String date,String typeAmount) {	
	PreparedStatement ps = null;		
	boolean status=false;
	Connection con = DbCon.getCon("","","");
	try{
			ps=con.prepareStatement("insert into estimatepaymentdetails(uid,payment_uid,type,cgst,sgst,igst,token,date,amount) "
					+ "values(?,?,?,?,?,?,?,?,?)");
...
public static boolean isComplianceExist(String ckey,String data, String token) {
	...
	Connection con = DbCon.getCon("","","");
	try{
			ps=con.prepareStatement("select id from compliance where product_name='"+data+"' and uuid!='"+ckey+"' and token='"+token+"' limit 1");
...
public static boolean isComplianceExist(String data, String token) {
	...
	Connection con = DbCon.getCon("","","");
	try{
			ps=con.prepareStatement("select id from compliance where product_name='"+data+"' and token='"+token+"' limit 1");
			rs=ps.executeQuery();
			if(rs.next())status=true;								
	}
	catch (Exception e) {
...
public static boolean isInvoiceConverted(String salesno, String token) {
	...
	Connection con = DbCon.getCon("","","");
	try{
			ps=con.prepareStatement("select esid from estimatesalectrl where essaleno='"+salesno+"' and estoken='"+token+"' and esstatus='Invoiced' limit 1");
			rs=ps.executeQuery();
			if(rs.next())status=true;								
	}
	catch (Exception e) {
...
public static boolean saveGenerateEstimate(String uuid, String estKey, String products, 
		String pymtamount, String date,String time, String token,String invoice,String estimateNotes) {
	PreparedStatement ps = null;		
	boolean status=false;
	Connection con = DbCon.getCon("","","");
	try{
...
public static void saveGeneratePymtDetails(String gkey, String uuid, String type, int professionalCgst,
	...
	Connection con = DbCon.getCon("","","");
	try{
			ps=con.prepareStatement("insert into generate_estimate_details(uuid,generate_key,type,amount,cgst,sgst,igst,token) "
					+ "values(?,?,?,?,?,?,?,?)");
...
public static String getSalesInvoiceNumber(String unbillno,String token) {
	...
	String newsdata = "NA";
	try {
		String queryselect = "SELECT sinvoiceno FROM salesestimatepayment where sunbill_no='"+unbillno+"' and stokenno='"+token+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static String[][] getInvoiceDetails(String uuid) {
	...
	try {
		String queryselect = "SELECT uuid,invoice_no,date,company,gstin,address,service_name,"
				...
				+ "contact_address,contact_state_code,token,service_qty"
				+ " FROM invoice where uuid='"+uuid+"'";
...
public static String[][] getInvoiceDetails(String invoice, String token) {
	...
	try {
		String queryselect = "SELECT uuid,invoice_no,date,company,gstin,address,service_name,"
				+ "total_amount,country,state,city,state_code,status,invoice_type,"
				+ "contact_name,contact_pan,contact_country,contact_state,contact_city,"
				+ "contact_address,contact_state_code"
				+ " FROM invoice where invoice_no='"+invoice+"' and token='"+token+"' and status='1'";
...
public static String[][] getCancelledInvoiceDetails(String invoice, String token) {
	...
	try {
		String queryselect = "SELECT unbill_no,invoice_no,company,gstin,address,service_name,"
				...
				+ "contact_name,contact_pan,contact_country,contact_state,contact_city,"
				+ "contact_address,contact_state_code,service_qty"
				+ " FROM invoice where invoice_no='"+invoice+"' and token='"+token+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
		rsGCD.last();
...
public static String[][] getEstimateDocument(String estKey, String token) {
	...
	String[][] newsdata = null;
	try {
		String queryselect = "SELECT sdrefid,sduploaddocname,sddocname,sduploaddate FROM salesdocumentctrl where sdestkey='"+estKey+"' and sduploadby='Client' and sdtokenno='"+token+"' order by sdid desc";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
		rsGCD.last();
...
public static String getSalesKeyByEstimateKey(String estKey, String uavalidtokenno) {
	...
	String getinfo ="NA";
	try {
		String queryselect = "SELECT msrefid FROM managesalesctrl where msestkey='"+estKey+"' and mstoken='"+uavalidtokenno+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static String isPaymentApproved(String estimateno,String token	) {
	...
	String getinfo ="No";
	try {
		String queryselect = "SELECT sid FROM salesestimatepayment where sestsaleno='"+estimateno+"' and stransactionstatus='1' and stokenno='"+token+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static boolean isEstimateInvoiced(String salesKey, String token) {
	...
	boolean getinfo =false;
	try {
		String queryselect = "SELECT esstatus FROM estimatesalectrl where esrefid='"+salesKey+"' and estoken='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
			if(rset.getString(1).equalsIgnoreCase("Invoiced"))getinfo=true;			
		}
	} catch (Exception e) {
...
public static List<String> getEstimatePriceType(String estKey, String token) {
	...
	try {
		...
		VCQUERY = new StringBuffer("SELECT sppricetype FROM salesproductprice where spessalerefid='"+estKey+"' and sptokenno='"+token+"'");
//			System.out.println(VCQUERY);
		stmnt = getacces_con.prepareStatement(VCQUERY.toString());
		rsGCD = stmnt.executeQuery();
		rsGCD.last();
...
public static String getProductKeyByTypeAndName(String category, String name,String token) {
	...
	String getinfo ="NA";
	try {
		String queryselect = "SELECT prefid FROM product_master where ptype='"+category+"' and pname='"+name+"' and ptokenno='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static int countCompliance(String product,String service,String token) {
	...
	try{
		...
		if(!product.equalsIgnoreCase("NA"))VCQUERY.append("and product_name like '%"+product+"%' or indended_use like '%"+product+"%' ");
		if(!service.equalsIgnoreCase("NA"))VCQUERY.append("and service_name like '%"+service+"%' ");
...
public static boolean updateCompliance(String ckey, String productName, String serviceName, 
		String intendedUse,String testingFee, String governmentFee, String token, String uaid) {
	PreparedStatement ps = null;
	Connection con = DbCon.getCon("", "", "");
	boolean status = false;
	try {
...
public static String[][] getComplianceByKey(String ckey, String token) {
	...
	try{
		...
		StringBuffer VCQUERY=new StringBuffer("SELECT * FROM compliance where uuid='"+ckey+"' and token='"+token+"'");
...
public static String getPaymentPersonName(String unbillno,String token) {
	...
	try {
		String queryselect = "select u.uaname from user_account u where "
				...
				+ "exists(select i.id from invoice i where s.sunbill_no=i.unbill_no and i.unbill_no='"+unbillno+"')) and u.uavalidtokenno='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static void sendEstimateNotes(String notes,String userInChat,String userUid,
		String addedby,String salesKey, String estimateKey, String token) {
	// TODO Auto-generated method stub
	try {
...
public static String[][] getEstimateNotesByEstimateKey(String estimate_key, String token) {
	...
	try{
		...
		StringBuffer VCQUERY=new StringBuffer("SELECT notes,users_uaid,login_uaid,addedby,uuid FROM estimate_notes where estimate_key='"+estimate_key+"' and token='"+token+"' and status='2'");
//		System.out.println(VCQUERY);
		stmnt=getacces_con.prepareStatement(VCQUERY.toString());
		rsGCD=stmnt.executeQuery();
		rsGCD.last();
...
public static String getEstimateNoFromPayment(String estpaymentKey, String token) {
	...
	String newsdata = "NA";
	try {
		String queryselect = "select sestsaleno from salesestimatepayment where srefid='"+estpaymentKey+"' and stokenno='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static boolean updateEstimateStatus(String action,String estSaleNo,String token) {
	...
	boolean flag=false;
	try {
		String query = "UPDATE estimatesalectrl SET esstatus='"+action+"' WHERE essaleno='"+estSaleNo+"' and esstatus!='Invoiced' and estoken='"+token+"'";
		ps = con.prepareStatement(query);						
		int k=ps.executeUpdate();
		if(k>0)
		flag=true;
...
public static void updateUnbilledStatus(String action,String unbillKey,String token) {
	...
	Connection con = DbCon.getCon("", "", "");
	try {
		String query = "UPDATE salesestimatepayment SET sarchivestatus='"+action+"' WHERE srefid='"+unbillKey+"' and stokenno='"+token+"'";
//		System.out.println(query);
		ps = con.prepareStatement(query);						
		ps.execute();
	} catch (Exception e) {
...
public static String[][] getAllDraftSaleByDate(String date7Daybefore,String salesPersonId) {
	...
	try{
		...
		StringBuffer VCQUERY=new StringBuffer("SELECT esregdate,essaleno,esprodname,esprodqty,escontactrefid,escompany,essoldbyid,estoken,sales_type FROM estimatesalectrl "
				+ "where esstatus='Draft' and str_to_date(esregdate,'%d-%m-%Y')<'"+date7Daybefore+"'");
		if(!salesPersonId.equalsIgnoreCase("NA"))VCQUERY.append(" and essoldbyid='"+salesPersonId+"'");
...
public static String[][] getAllDraftSalePersonByDate(String date7Daybefore) {
	...
	try{
		...
		StringBuffer VCQUERY=new StringBuffer("SELECT essoldbyid,estoken FROM estimatesalectrl where esstatus='Draft' and str_to_date(esregdate,'%d-%m-%Y')<='"+date7Daybefore+"' group by essoldbyid");
...
public static String[][] getAllDraftSaleByDateForManager(String date7Daybefore,String teamKey,String TeamLeaderUid) {
	Connection getacces_con = null;
	PreparedStatement stmnt=null;
	ResultSet rsGCD=null;
	String[][] newsdata = null;
...
public static String[][] fetchAllCancelReport(String invoice, String type, String token) {
	...
	try{
		...
		if(type.equalsIgnoreCase("estimate"))VCQUERY.append("estimate_invoice='"+invoice+"' ");
		else if(type.equalsIgnoreCase("sales"))VCQUERY.append("sales_invoice='"+invoice+"' ");
...
public static String getSalesInvoiceHeading(String invoice, String token) {
	...
	String newsdata = "";
	try {
		String queryselect = "SELECT msproductname FROM managesalesctrl where msinvoiceno='"+invoice+"' and mstoken='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
		int i=0;
...
public static String getEstimateInvoiceHeading(String invoice, String token) {
	...
	String newsdata = "";
	try {
		String queryselect = "SELECT esprodname FROM estimatesalectrl where essaleno='"+invoice+"' and estoken='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
		int i=0;
...
public static int findSalesIdByKey(String saleskey, String token) {
	...
	int newsdata = 0;
	try {
		String queryselect = "SELECT msid FROM managesalesctrl where msrefid='"+saleskey+"' and mstoken='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
		if(rsGCD.next())newsdata=rsGCD.getInt(1);
...
public static boolean isContactRefUsed(String crefid, String token) {
	...
	boolean getinfo =false;
	try {
		String queryselect = "SELECT cbid FROM contactboxctrl where cbcontactrefid='"+crefid+"' and cbtokenno='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static boolean findSalesUserMapping(String salesId, String uaid, String uavalidtokenno) {
	...
	boolean getinfo =false;
	try {
		String queryselect = "SELECT id FROM user_sales_info where user_id='"+uaid+"' and sales_id='"+salesId+"' and token='"+uavalidtokenno+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static boolean findCompanyUserMapping(String companyId, String uaid, String uavalidtokenno) {
	...
	boolean getinfo =false;
	try {
		String queryselect = "SELECT id FROM client_user_info where user_id='"+uaid+"' and client_id='"+companyId+"' and token='"+uavalidtokenno+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static String findTeamKeyByUaid(String token,String department) {
	...
	String newsdata = "NA";
	try {
		String queryselect = "SELECT mtrefid FROM manageteamctrl where mtdepartment='"+department+"' and mttoken='"+token+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static String[][] findTeamMembers(String teamKey,String token) {
	...
	String[][] newsdata = null;
	try {
		String queryselect = "SELECT tmuseruid,tmusername FROM manageteammemberctrl where tmteamrefid='"+teamKey+"' and tmtoken='"+token+"' and tmstatus='1'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
		rsGCD.last();
...
public static String[] findSalesDocumentUser(String salesKey, String token) {
	...
	String getinfo[] =new String[2];
	try {
		String queryselect = "SELECT document_assign_uaid,document_assign_name FROM managesalesctrl where msrefid='"+salesKey+"'"
...
public static String[] findConsultingSaleDetails(String salesKey, String token) {
	...
	try {
		String queryselect = "SELECT c.consultation_type,c.renewal_value,c.renewal_type,c.renewal_end_date,u.uaname FROM consulting_sale c "
				+ "join user_account u on c.consultant_uaid=u.uaid where c.sales_key='"+salesKey+"' and c.token='"+token+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static boolean saveConsultingSale(String estimateKey, String consultationType, String consultationRenewalValue,
		String consultationRenewalType, String consultationEndDate, String consultationFeeType, double price,
		String consultationHsn, double cgst, double sgst, double igst, double cgstprice, double sgstprice,
		double igstprice, double totalprice, String token, String today,String paymentDate,String consultantUaid) {
	PreparedStatement ps = null;		
	boolean status=false;
	Connection con = DbCon.getCon("","","");
	try{		
...
public static String findSalesTypeBySalesKey(String salesKey, String token) {
	...
	String newsdata = "NA";
	try {
		String queryselect = "SELECT sales_type FROM managesalesctrl where msrefid='"+salesKey+"' and mstoken='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static String findSalesTypeByKey(String refid, String token) {
	...
	String newsdata = "NA";
	try {
		String queryselect = "SELECT sales_type FROM estimatesalectrl where esrefid='"+refid+"' and estoken='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static boolean updateConsultingSale(String estimateKey, String price, String cgstprice, String sgstprice,
	...
	boolean status = false;
	try {
		double totalAmount=Double.parseDouble(price)+Double.parseDouble(cgstprice)+Double.parseDouble(sgstprice)
...
public static String findConsultationFeeType(String estimateno, String token) {
	...
	try {
		String queryselect = "SELECT fee_type FROM corpseedhrmdmng.consulting_sale c join estimatesalectrl e on "
				+ "c.estimate_key=e.esrefid where e.essaleno='"+estimateno+"' and e.estoken='"+token+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static String findConsultantUaid(String estimateKey, String token) {
	...
	String newsdata = "NA";
	try {
		String queryselect = "SELECT consultant_uaid FROM consulting_sale where estimate_key ='"+estimateKey+"' and token='"+token+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
...
public static String[][] getInvoiceProductList(String invoiceKey){
	...
	try{
		...
		StringBuffer VCQUERY=new StringBuffer("select refkey,service_name from invoice_product where invoice_key='"+invoiceKey+"'");
...
public static String[][] getInvoiceProductPaymentList(String invoiceProductKey){
	...
	try{
		...
		StringBuffer VCQUERY=new StringBuffer("select fee_type,price,hsn,(cgst_percent+sgst_percent+igst_percent) as gst_percent,(cgst_price+sgst_price+igst_price) as gst_price,total_price from invoice_product_items where invoice_product_key='"+invoiceProductKey+"'");
...
public static boolean isEstimateHavePo(String salesno, String token) {
	...
	boolean getinfo =false;
	try {
		String queryselect = "SELECT sid FROM salesestimatepayment where spaymtmode='PO' and sestsaleno='"+salesno+"' and stransactionstatus!='3' and stokenno='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static int getPaymentIdByKey(String refid, String token) {
	...
	int getinfo =0;
	try {
		String queryselect = "SELECT sid FROM salesestimatepayment where spaymtmode='PO' and srefid='"+refid+"' and stokenno='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static String[] fetchPaymentDetails(String refInvoice, String uavalidtokenno) {
	...
	String[] newsdata = new String[4];
	try {
		String queryselect = "SELECT sid,po_validity,stransactionid,sapprovedby FROM salesestimatepayment where sinvoiceno='"+refInvoice+"' and spaymtmode='PO' and stokenno='"+uavalidtokenno+"' limit 1";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rsGCD = ps.executeQuery();
		if(rsGCD!=null&&rsGCD.next()) {
...
public static int getClientKeyByInvoiceNo(String invoiceNo) {
	...
	try {
		String queryselect = "select h.super_user_uaid from hrmclient_reg h "
				+ "INNER JOIN managesalesctrl m on m.msclientrefid=h.cregclientrefid "
				+ "where m.msinvoiceno='"+invoiceNo+"' group by h.super_user_uaid";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
public static int findManageInvoiceId(String invoiceno, String token) {
	...
	int getinfo =0;
	try {
		String queryselect = "SELECT id FROM manage_invoice where type='TAX' and ref_invoice='"+invoiceno+"' and token='"+token+"'";
//		System.out.println(queryselect);
		ps = con.prepareStatement(queryselect);
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
...
//		System.out.println(queryselect);
		...
		rset = ps.executeQuery();
		if (rset != null && rset.next()) {
			if(rset.getDouble(1)<=1)getinfo=false;				
		}
	} catch (Exception e) {
