...
public class GetPayTypePo_CTRL extends HttpServlet {
...
//			System.out.println("show="+show);
			...
			if(estimate!=null&&estimate.length>0) {
				for(int i=0;i<estimate.length;i++) {
					Enquiry_ACT.updateSalesPayType(estimate[i][0], token);
					
//							Enquiry_ACT.getEstimateSalesPayType(estimate[i][0], token);
					String full_pay="";
					String partial_pay="";
					String milestone_pay="checked='checked'";
					String readonly="";
					String prodName=estimate[i][1];
					String consultationReadonly="";
					if(estimate[i][3].equals("2")) {prodName="Consultation Service";consultationReadonly="disabled='disabled'";}
