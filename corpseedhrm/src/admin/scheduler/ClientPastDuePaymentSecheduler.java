...
public class ClientPastDuePaymentSecheduler extends TimerTask {
...
//		System.out.println("Called todays="+today);
		
		String dueSales[][]=TaskMaster_ACT.findPastDueSalesForClient(today);
...
//				System.out.println("clientName="+clientName+"#"+clientName.contains(" "));
