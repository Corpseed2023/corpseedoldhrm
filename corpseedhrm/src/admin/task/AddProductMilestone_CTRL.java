...
public class AddProductMilestone_CTRL extends HttpServlet {	
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String loginuID = (String) session.getAttribute("loginuID");
			...
			TaskMaster_ACT.addProductMilestone(pid,work_type,Unit_Time,Duration,SMSID,EmailId,uavalidtokenno,loginuID,dateTime);		
			TaskMaster_ACT.updateProductTimeline(pid,uavalidtokenno);
	}
