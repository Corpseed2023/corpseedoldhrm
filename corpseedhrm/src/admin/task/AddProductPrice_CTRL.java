...
public class AddProductPrice_CTRL extends HttpServlet {	
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String loginuID = (String) session.getAttribute("loginuID");	
			...
			TaskMaster_ACT.addProductPrice(pid,price_type,Price,Service_Type,Term_Status,Term_Time,GST_Status,Gst_Percent,Gst_Price,Total_Price,uavalidtokenno,loginuID,dateTime);		
