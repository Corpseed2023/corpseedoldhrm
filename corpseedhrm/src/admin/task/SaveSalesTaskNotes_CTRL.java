...
public class SaveSalesTaskNotes_CTRL extends HttpServlet {	
...
//			msproductname,msprojectnumber,msinvoiceno,mscontactrefid,mscompany,msworkpriority,mssoldbyuid,msestimateno,project_close_date
...
//				System.out.println(uaid+"  "+userUid);
			...
			Enquiry_ACT.saveEmail(email,"empty","Note From "+userName+" On "+salesData[0]+"("+salesData[2]+")", message1,2,token);
				...
				TaskMaster_ACT.saveSalesNotification(salesTaskKey,type,uaid,userName,today+" "+Time,token,salesKey,notes,salesData[9]);
