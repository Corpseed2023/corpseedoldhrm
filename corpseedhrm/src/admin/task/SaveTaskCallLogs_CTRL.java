...
public class SaveTaskCallLogs_CTRL extends HttpServlet {	
...
//				getting login user name
				...
				flag=TaskMaster_ACT.setTaskNotification(taskKey,salesKey,salesData[0],salesData[1],salesData[2],"Call Log","phone_icon.png",conName,conMobile,conEmail,userUid,userName,today+" "+Time,subject,notes,addedby,token,"NA","NA","NA","NA","NA");
