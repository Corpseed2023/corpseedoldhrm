...
public class ManageAMCAccount_CTRL extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		RequestDispatcher RD = request.getRequestDispatcher("mclient/amc-account.jsp");
		RD.forward(request, response);
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (request.getParameter("button").equalsIgnoreCase("Search")) {
			...
			SES.setAttribute("mngamcclientname", clientname);
		}else if(request.getParameter("button").equalsIgnoreCase("Reset")){
			SES.removeAttribute("mngamcclientname");
		}
			RequestDispatcher RD = request.getRequestDispatcher("mclient/amc-account.jsp");
			RD.forward(request, response);
	}
