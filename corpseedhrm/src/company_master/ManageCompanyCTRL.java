...
public class ManageCompanyCTRL extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		RequestDispatcher RD = request.getRequestDispatcher("company_master/manage-company.jsp");
		RD.forward(request, response);
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		SES.setAttribute("mcname", name);
		SES.setAttribute("mcfrom", from);
		SES.setAttribute("mcto", to);
		}else if(request.getParameter("button").equalsIgnoreCase("Reset")){
			SES.removeAttribute("mcname");
			SES.removeAttribute("mcfrom");
			SES.removeAttribute("mcto");
		}
		RequestDispatcher RD = request.getRequestDispatcher("company_master/manage-company.jsp");
		RD.forward(request, response);
	}
