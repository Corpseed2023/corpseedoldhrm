...
public class PromoteSalStr_CTRL extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String EmployeeDesignation = request.getParameter("EmployeeDesignation").trim();
			...
			status = SalaryStr_ACT.promoteSalStr(salid, salemid, salctc, salleaves, salgross, salbasic, salda, salhra, salcon,
					salmed, salspecial, salbonus, salta, salded, salpf, salptax, saltds, salnet, saladdedby);
			SalaryStr_ACT.promoteEmployee(salemid,EmployeeDesignation);
			if (status) {
