...
public class TDSManage_CTRL extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		RequestDispatcher RD = request.getRequestDispatcher("salary_master/tds_master/tds-details.jsp");
		RD.forward(request, response);
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (request.getParameter("button").equalsIgnoreCase("Search")) {
			...
			SES.setAttribute("tdsemname", emname);
			SES.setAttribute("tdsmonth", month);
			SES.setAttribute("tdsfrom", from);
			SES.setAttribute("tdsto", to);
		}else if(request.getParameter("button").equalsIgnoreCase("Reset")){
			SES.removeAttribute("tdsemname");
			SES.removeAttribute("tdsmonth");
			SES.removeAttribute("tdsfrom");
			SES.removeAttribute("tdsto");
		}
			RequestDispatcher RD = request.getRequestDispatcher("salary_master/tds_master/tds-details.jsp");
			RD.forward(request, response);
