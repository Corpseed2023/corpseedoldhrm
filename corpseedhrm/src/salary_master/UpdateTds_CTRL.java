...
public class UpdateTds_CTRL extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8540159199998561368L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String tdsid = request.getParameter("tdsid").trim();
			...
			status = SalaryMon_ACT.updateTds(tdsid, tdsemid, tdsamt, tdsmonth, tdspaidfrom, tdspaidto, tdspaidon, tdsremarks);
